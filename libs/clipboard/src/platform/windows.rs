...
pub fn server_clip_file(
    ...
    match msg {
        ...
        ClipboardFile::FileContentsRequest {
            ...
            log::debug!("server_file_contents_request called, conn_id {}, stream_id {}, list_index {}, dw_flags {}, cb_requested {}",
                conn_id, stream_id, list_index, dw_flags, cb_requested);
...
extern "C" fn handle_clipboard_files(
    ...
    if n_files == 0 || file_names.is_null() {
        return 0;
    }
