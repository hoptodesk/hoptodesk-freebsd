...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "لطفاً شماره پورت محلی را وارد کنید"),
        ("Please enter a remote port number", "لطفاً شماره پورت راه دور را وارد کنید"),
        ("Please enter local and remote port numbers", "لطفاً شماره پورت‌های محلی و راه دور را وارد کنید"),
        ("Copy", "کپی"),
        ("Proxy Settings", "تنظیمات پروکسی"),
        ("Add to my Dashboard", "افزودن به داشبورد من"),
        ...
        ("Added to dashboard", "به داشبورد اضافه شد"),
        ("Request declined", "درخواست رد شد"),
        ("Add remote device to my dashboard", "افزودن دستگاه راه دور به داشبورد من"),
        ("Your IP", "IP شما"),
        ("Switch to ID", "تغییر به ID"),
        ("Switch to local IP", "تغییر به IP محلی"),
        ("No local IP available - showing ID", "IP محلی در دسترس نیست - ID نمایش داده می‌شود"),
        ("Copy your local IP to clipboard", "کپی IP محلی به کلیپ‌بورد"),
        ("Your local IP address - share this for direct LAN connections", "آدرس IP محلی شما - برای اتصالات مستقیم LAN آن را به اشتراک بگذارید"),
        ("Accept Dashboard Invite?", "قبول دعوت‌نامه داشبورد؟"),
        ("Request sent, waiting for the remote user to confirm.", "درخواست ارسال شد، در انتظار تأیید کاربر راه دور."),
        ("Requesting invite code...", "درخواست کد دعوت..."),
        ("The invite code is invalid or expired. Please try again later.", "کد دعوت نامعتبر یا منقضی شده است. لطفاً بعداً دوباره امتحان کنید."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "کاربر راه دور پذیرفت اما ثبت‌نام ناموفق بود. ممکن است آفلاین باشد یا نتواند به داشبورد دسترسی پیدا کند."),
        ("A previous request is still pending on the remote.", "یک درخواست قبلی هنوز در دستگاه راه دور در انتظار است."),
        ("No response from the remote, request timed out.", "پاسخی از دستگاه راه دور دریافت نشد، زمان درخواست تمام شد."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "این پلتفرم راه دور هنوز برای ثبت‌نام در داشبورد پشتیبانی نمی‌شود."),
        ("This device is already linked to your dashboard.", "این دستگاه قبلاً به داشبورد شما متصل شده است."),
        ("Replace existing dashboard link?", "جایگزینی پیوند داشبورد موجود؟"),
        ("This computer is currently linked to {} dashboard.", "این رایانه در حال حاضر به داشبورد {} متصل است."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} این رایانه را به پیوستن به داشبورد خود دعوت می‌کند. پیوند موجود حذف خواهد شد."),
        ("{} is inviting this computer to join their dashboard.", "{} این رایانه را به پیوستن به داشبورد خود دعوت می‌کند."),
        ("You can undo this any time in Settings > Dashboard.", "می‌توانید این کار را در هر زمان در تنظیمات > داشبورد لغو کنید."),
            ("Recent sessions will show here.", "جلسات اخیر در اینجا نمایش داده می‌شوند."),
        ("No favorites yet.", "هنوز موردعلاقه‌ای وجود ندارد."),
        ("No devices discovered.", "دستگاهی پیدا نشد."),
        ("Waiting for new connection ...", "... در انتظار اتصال جدید"),
        ("Not Ready", "آماده نیست"),
        ("ID / Relay Server", "ID / سرور Relay"),
        ("Generate New Temporary Password", "ایجاد رمز عبور موقت جدید"),
        ("Confirm Password", "تأیید رمز عبور"),
        ("Two-Factor Authentication Setup", "راه‌اندازی احراز هویت دو مرحله‌ای"),
        ("API URL", "API URL"),
        ("This software is licensed under", "این نرم‌افزار تحت مجوز"),
        ("Source code is available", "کد منبع موجود است در"),
        ("here", "اینجا"),
        ("Invite Code", "کد دعوت"),
        ("Length:", "طول:"),
        ("Link", "پیوند"),
        ...
        ("RANDOM PASSWORD", "رمز عبور تصادفی"),
        ("Attachments:", "پیوست‌ها:"),
        ("Best image quality", "بهترین کیفیت تصویر"),
        ("Connection Manager", "مدیریت اتصال"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "در حال حاضر پیوند شده:"),
        ("Do not close this window while the tunnel is active", "تا زمانی که تونل فعال است این پنجره را نبندید"),
        ("Enter Password", "رمز عبور را وارد کنید"),
        ("Enter a new invite code to re-link:", "برای پیوند مجدد، کد دعوت جدیدی وارد کنید:"),
        ("Establishing connection to remote device", "در حال برقراری اتصال با دستگاه راه دور"),
        ("File Already Exists", "فایل از قبل وجود دارد"),
        ("Input Blocked", "ورودی مسدود شد"),
        ("Invalid code. Please try again.", "کد نامعتبر است. لطفاً دوباره تلاش کنید."),
        ("Keyboard", "صفحه کلید"),
        ("Lock Screen", "قفل صفحه"),
        ("Message", "پیام"),
        ("Please enter the password for the remote device.", "لطفاً رمز عبور دستگاه راه دور را وارد کنید."),
        ("Record Session", "ضبط جلسه"),
        ("Type a message...", "...پیامی بنویسید"),
        ("View Style", "سبک نمایش"),
        ...
        ("Your ticket will be sent to {}", "تیکت شما به {} ارسال خواهد شد"),
        ("your support team", "تیم پشتیبانی شما"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "این دستگاه به داشبوردی متصل نیست. ارسال تیکت ممکن نیست."),
        ("We'll use this address to send you updates about your ticket", "از این آدرس برای ارسال به‌روزرسانی‌های تیکت شما استفاده می‌کنیم"),
        ("You can also email {}", "همچنین می‌توانید به {} ایمیل بزنید"),
        ("You can also call {}", "همچنین می‌توانید با {} تماس بگیرید"),
