...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Lūdzu, ievadiet vietējā porta numuru"),
        ...
        ("Copy", "Kopēt"),
        ("Proxy Settings", "Starpniekservera iestatījumi"),
        ...
        ("Added to dashboard", "Pievienots panelim"),
        ("Request declined", "Pieprasījums noraidīts"),
        ("Add remote device to my dashboard", "Pievienot attālo ierīci manam panelim"),
        ("Your IP", "Jūsu IP"),
        ("Switch to ID", "Pārslēgt uz ID"),
        ("Switch to local IP", "Pārslēgt uz vietējo IP"),
        ("No local IP available - showing ID", "Vietējais IP nav pieejams - tiek rādīts ID"),
        ("Copy your local IP to clipboard", "Kopēt vietējo IP starpliktuvē"),
        ("Your local IP address - share this for direct LAN connections", "Jūsu vietējā IP adrese - kopīgojiet to tiešiem LAN savienojumiem"),
        ("Accept Dashboard Invite?", "Pieņemt paneļa uzaicinājumu?"),
        ("Request sent, waiting for the remote user to confirm.", "Pieprasījums nosūtīts, gaida attālā lietotāja apstiprinājumu."),
        ("Requesting invite code...", "Tiek pieprasīts uzaicinājuma kods..."),
        ("The invite code is invalid or expired. Please try again later.", "Uzaicinājuma kods nav derīgs vai ir beidzies. Lūdzu, mēģiniet vēlāk vēlreiz."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Attālais lietotājs piekrita, bet reģistrācija neizdevās. Viņš var būt bezsaistē vai nevarēt sasniegt paneli."),
        ("A previous request is still pending on the remote.", "Attālajā ierīcē joprojām gaida iepriekšējais pieprasījums."),
        ("No response from the remote, request timed out.", "Nav atbildes no attālās ierīces, pieprasījuma noildze."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Šī attālā platforma vēl netiek atbalstīta paneļa reģistrācijai."),
        ("This device is already linked to your dashboard.", "Šī ierīce jau ir saistīta ar jūsu paneli."),
        ("Replace existing dashboard link?", "Aizstāt esošo paneļa saiti?"),
        ("This computer is currently linked to {} dashboard.", "Šis dators pašlaik ir saistīts ar {} paneli."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Jūs varat to atsaukt jebkurā laikā sadaļā Iestatījumi > Panelis."),
            ("Recent sessions will show here.", "Pēdējās sesijas tiks rādītas šeit."),
        ("No favorites yet.", "Izlasē vēl nav ierakstu."),
        ("No devices discovered.", "Nav atklātu ierīču."),
        ("Waiting for new connection ...", "Gaida jaunu savienojumu ..."),
        ("Not Ready", "Nav gatavs"),
        ("ID / Relay Server", "ID / releja serveris"),
        ("Generate New Temporary Password", "Ģenerēt jaunu pagaidu paroli"),
        ("Confirm Password", "Apstiprināt paroli"),
        ("Two-Factor Authentication Setup", "Divfaktoru autentifikācijas iestatīšana"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Šī programmatūra ir licencēta saskaņā ar"),
        ("Source code is available", "Pirmkods ir pieejams"),
        ("here", "šeit"),
        ("Invite Code", "Uzaicinājuma kods"),
        ("Length:", "Garums:"),
        ("Link", "Saistīt"),
        ("PERMANENT PASSWORD", "PASTĀVĪGĀ PAROLE"),
        ("RANDOM PASSWORD", "NEJAUŠĀ PAROLE"),
        ("Attachments:", "Pielikumi:"),
        ("Best image quality", "Labākā attēla kvalitāte"),
        ("Connection Manager", "Savienojumu pārvaldnieks"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Pašlaik saistīts:"),
        ("Do not close this window while the tunnel is active", "Neaizveriet šo logu, kamēr tunelis ir aktīvs"),
        ("Enter Password", "Ievadiet paroli"),
        ("Enter a new invite code to re-link:", "Ievadiet jaunu uzaicinājuma kodu, lai saistītu atkārtoti:"),
        ("Establishing connection to remote device", "Tiek izveidots savienojums ar attālo ierīci"),
        ("File Already Exists", "Fails jau eksistē"),
        ("Input Blocked", "Ievade bloķēta"),
        ("Invalid code. Please try again.", "Nederīgs kods. Lūdzu, mēģiniet vēlreiz."),
        ("Keyboard", "Tastatūra"),
        ("Lock Screen", "Bloķēt ekrānu"),
        ("Message", "Ziņojums"),
        ("Please enter the password for the remote device.", "Lūdzu, ievadiet attālās ierīces paroli."),
        ("Record Session", "Ierakstīt sesiju"),
        ("Type a message...", "Ierakstiet ziņojumu..."),
        ("View Style", "Skata stils"),
        ("Waiting...", "Gaida..."),
        ("Port Forwarding:", "Portu pāradresācija:"),
        ...
        ("Ticket reopened", "Pieteikums atkārtoti atvērts"),
        ("Your ticket will be sent to {}", "Jūsu pieteikums tiks nosūtīts {}"),
        ("your support team", "jūsu atbalsta komandai"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Šī ierīce nav savienota ar paneli. Pieteikumus nevar iesniegt."),
        ("We'll use this address to send you updates about your ticket", "Šo adresi izmantosim pieteikuma atjauninājumiem"),
        ("You can also email {}", "Varat arī rakstīt uz {}"),
        ("You can also call {}", "Varat arī zvanīt uz {}"),
