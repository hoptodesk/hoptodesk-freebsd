...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "ローカルポート番号を入力してください"),
        ...
        ("Added to dashboard", "ダッシュボードに追加されました"),
        ("Request declined", "リクエストが拒否されました"),
        ("Add remote device to my dashboard", "リモートデバイスをマイダッシュボードに追加"),
        ("Your IP", "あなたのIP"),
        ("Switch to ID", "IDに切り替え"),
        ("Switch to local IP", "ローカルIPに切り替え"),
        ("No local IP available - showing ID", "ローカルIPが利用できません - IDを表示しています"),
        ("Copy your local IP to clipboard", "ローカルIPをクリップボードにコピー"),
        ("Your local IP address - share this for direct LAN connections", "あなたのローカルIPアドレス - 直接LAN接続のために共有してください"),
        ("Accept Dashboard Invite?", "ダッシュボード招待を承諾しますか?"),
        ("Request sent, waiting for the remote user to confirm.", "リクエストを送信しました。リモートユーザーの確認を待っています。"),
        ("Requesting invite code...", "招待コードをリクエスト中..."),
        ("The invite code is invalid or expired. Please try again later.", "招待コードが無効か期限切れです。後でもう一度お試しください。"),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "リモートユーザーは承諾しましたが、登録に失敗しました。オフラインまたはダッシュボードに接続できない可能性があります。"),
        ("A previous request is still pending on the remote.", "リモートでは前のリクエストがまだ保留中です。"),
        ("No response from the remote, request timed out.", "リモートから応答がありません。リクエストがタイムアウトしました。"),
        ("This remote platform isn't supported for dashboard enrollment yet.", "このリモートプラットフォームはまだダッシュボード登録に対応していません。"),
        ("This device is already linked to your dashboard.", "このデバイスは既にダッシュボードにリンクされています。"),
        ("Replace existing dashboard link?", "既存のダッシュボードリンクを置き換えますか?"),
        ("This computer is currently linked to {} dashboard.", "このコンピューターは現在 {} のダッシュボードにリンクされています。"),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} がこのコンピューターを自分のダッシュボードへの参加に招待しています。既存のリンクは削除されます。"),
        ("{} is inviting this computer to join their dashboard.", "{} がこのコンピューターを自分のダッシュボードへの参加に招待しています。"),
        ("You can undo this any time in Settings > Dashboard.", "設定 > ダッシュボードでいつでも取り消すことができます。"),
            ("Recent sessions will show here.", "最近のセッションがここに表示されます。"),
        ("No favorites yet.", "お気に入りはまだありません。"),
        ("No devices discovered.", "発見されたデバイスはありません。"),
        ("Waiting for new connection ...", "新しい接続を待機中 ..."),
        ("Not Ready", "準備できていません"),
        ("ID / Relay Server", "ID / 中継サーバー"),
        ("Generate New Temporary Password", "新しい一時パスワードを生成"),
        ("Confirm Password", "パスワードの確認"),
        ("Two-Factor Authentication Setup", "二要素認証の設定"),
        ("API URL", "API URL"),
        ("This software is licensed under", "このソフトウェアのライセンスは"),
        ("Source code is available", "ソースコードの入手は"),
        ("here", "こちら"),
        ("Invite Code", "招待コード"),
        ("Length:", "長さ："),
        ("Link", "リンク"),
        ...
        ("RANDOM PASSWORD", "ランダムパスワード"),
        ("Attachments:", "添付ファイル："),
        ("Best image quality", "最高画質"),
        ("Connection Manager", "接続マネージャー"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "現在のリンク先："),
        ("Do not close this window while the tunnel is active", "トンネルの使用中はこのウィンドウを閉じないでください"),
        ("Enter Password", "パスワードを入力"),
        ("Enter a new invite code to re-link:", "再リンクするには新しい招待コードを入力してください："),
        ("Establishing connection to remote device", "リモートデバイスへ接続中"),
        ("File Already Exists", "ファイルは既に存在します"),
        ("Input Blocked", "入力がブロックされました"),
        ("Invalid code. Please try again.", "コードが無効です。もう一度お試しください。"),
        ("Keyboard", "キーボード"),
        ("Lock Screen", "画面をロック"),
        ("Message", "メッセージ"),
        ("Please enter the password for the remote device.", "リモートデバイスのパスワードを入力してください。"),
        ("Record Session", "セッションを録画"),
        ...
        ("Ticket reopened", "チケットが再開されました"),
        ("Your ticket will be sent to {}", "チケットは{}に送信されます"),
        ("your support team", "サポートチーム"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "このデバイスはダッシュボードに接続されていません。チケットを送信できません。"),
        ("We'll use this address to send you updates about your ticket", "このアドレスにチケットの更新情報をお送りします"),
        ("You can also email {}", "{}宛にメールすることもできます"),
        ("You can also call {}", "{}に電話することもできます"),
