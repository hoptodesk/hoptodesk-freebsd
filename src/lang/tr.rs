...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Lütfen yerel port numarası girin"),
        ...
        ("Added to dashboard", "Panoya eklendi"),
        ("Request declined", "İstek reddedildi"),
        ("Add remote device to my dashboard", "Uzak cihazı panoma ekle"),
        ("Your IP", "IP'niz"),
        ("Switch to ID", "ID'ye geç"),
        ("Switch to local IP", "Yerel IP'ye geç"),
        ("No local IP available - showing ID", "Yerel IP yok - ID gösteriliyor"),
        ("Copy your local IP to clipboard", "Yerel IP'yi panoya kopyala"),
        ("Your local IP address - share this for direct LAN connections", "Yerel IP adresiniz - doğrudan LAN bağlantıları için paylaşın"),
        ("Accept Dashboard Invite?", "Pano davetini kabul et?"),
        ("Request sent, waiting for the remote user to confirm.", "İstek gönderildi, uzak kullanıcının onayı bekleniyor."),
        ("Requesting invite code...", "Davet kodu isteniyor..."),
        ("The invite code is invalid or expired. Please try again later.", "Davet kodu geçersiz veya süresi dolmuş. Lütfen daha sonra tekrar deneyin."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Uzak kullanıcı kabul etti ancak kayıt başarısız oldu. Çevrimdışı olabilir veya panoya erişemiyor olabilir."),
        ("A previous request is still pending on the remote.", "Uzak cihazda önceki bir istek hâlâ beklemede."),
        ("No response from the remote, request timed out.", "Uzak cihazdan yanıt yok, istek zaman aşımına uğradı."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Bu uzak platform henüz pano kaydı için desteklenmiyor."),
        ("This device is already linked to your dashboard.", "Bu cihaz zaten panonuza bağlı."),
        ("Replace existing dashboard link?", "Mevcut pano bağlantısını değiştir?"),
        ("This computer is currently linked to {} dashboard.", "Bu bilgisayar şu anda {} panosuna bağlı."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} bu bilgisayarı kendi panosuna katılmaya davet ediyor. Mevcut bağlantı kaldırılacak."),
        ("{} is inviting this computer to join their dashboard.", "{} bu bilgisayarı kendi panosuna katılmaya davet ediyor."),
        ("You can undo this any time in Settings > Dashboard.", "Bunu istediğiniz zaman Ayarlar > Pano'dan geri alabilirsiniz."),
            ("Recent sessions will show here.", "Son bağlanılanlar burada görünecek."),
        ("No favorites yet.", "Henüz favori yok."),
        ("No devices discovered.", "Keşfedilen cihaz yok."),
        ("Waiting for new connection ...", "Yeni bağlantı bekleniyor ..."),
        ("Not Ready", "Hazır Değil"),
        ("ID / Relay Server", "ID / Relay Sunucu"),
        ("Generate New Temporary Password", "Yeni Geçici Şifre Oluştur"),
        ("Confirm Password", "Şifreyi Onayla"),
        ("Two-Factor Authentication Setup", "İki Faktörlü Kimlik Doğrulama Kurulumu"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Bu yazılım şu lisans altındadır"),
        ("Source code is available", "Kaynak kodu mevcuttur"),
        ("here", "burada"),
        ("Invite Code", "Davet Kodu"),
        ("Length:", "Uzunluk:"),
        ("Link", "Bağla"),
        ("PERMANENT PASSWORD", "KALICI ŞİFRE"),
        ("RANDOM PASSWORD", "RASTGELE ŞİFRE"),
        ("Attachments:", "Ekler:"),
        ("Best image quality", "En iyi görüntü kalitesi"),
        ("Connection Manager", "Bağlantı Yöneticisi"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Şu anda bağlı:"),
        ("Do not close this window while the tunnel is active", "Tünel aktifken bu pencereyi kapatmayın"),
        ("Enter Password", "Şifre Girin"),
        ("Enter a new invite code to re-link:", "Yeniden bağlamak için yeni bir davet kodu girin:"),
        ("Establishing connection to remote device", "Uzak cihaza bağlantı kuruluyor"),
        ("File Already Exists", "Dosya Zaten Var"),
        ("Input Blocked", "Giriş Engellendi"),
        ("Invalid code. Please try again.", "Geçersiz kod. Lütfen tekrar deneyin."),
        ("Keyboard", "Klavye"),
        ("Lock Screen", "Ekranı Kilitle"),
        ("Message", "Mesaj"),
        ("Please enter the password for the remote device.", "Lütfen uzak cihazın şifresini girin."),
        ("Record Session", "Oturumu Kaydet"),
        ("Type a message...", "Bir mesaj yazın..."),
        ("View Style", "Görünüm Stili"),
        ("Waiting...", "Bekleniyor..."),
        ...
        ("Ticket reopened", "Talep yeniden açıldı"),
        ("Your ticket will be sent to {}", "Talebiniz {} adresine gönderilecek"),
        ("your support team", "destek ekibinize"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Bu cihaz bir panele bağlı değil. Talep gönderilemez."),
        ("We'll use this address to send you updates about your ticket", "Bu adresi talebinizle ilgili güncellemeler için kullanacağız"),
        ("You can also email {}", "Ayrıca {} adresine e-posta gönderebilirsiniz"),
        ("You can also call {}", "Ayrıca {} numarasını arayabilirsiniz"),
