...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "กรุณาใส่หมายเลขพอร์ตภายใน"),
        ("Please enter a remote port number", "กรุณาใส่หมายเลขพอร์ตระยะไกล"),
        ("Please enter local and remote port numbers", "กรุณาใส่หมายเลขพอร์ตภายในและระยะไกล"),
        ("Copy", "คัดลอก"),
        ("Proxy Settings", "การตั้งค่าพร็อกซี"),
        ("Add to my Dashboard", "เพิ่มไปยังแดชบอร์ดของฉัน"),
        ...
        ("Added to dashboard", "เพิ่มไปยังแดชบอร์ดแล้ว"),
        ("Request declined", "ปฏิเสธคำขอ"),
        ("Add remote device to my dashboard", "เพิ่มอุปกรณ์ระยะไกลไปยังแดชบอร์ดของฉัน"),
        ("Your IP", "IP ของคุณ"),
        ("Switch to ID", "สลับไปยัง ID"),
        ("Switch to local IP", "สลับไปยัง IP เครื่อง"),
        ("No local IP available - showing ID", "ไม่มี IP เครื่อง - กำลังแสดง ID"),
        ("Copy your local IP to clipboard", "คัดลอก IP เครื่องไปยังคลิปบอร์ด"),
        ("Your local IP address - share this for direct LAN connections", "ที่อยู่ IP เครื่องของคุณ - แชร์เพื่อเชื่อมต่อ LAN โดยตรง"),
        ("Accept Dashboard Invite?", "ยอมรับคำเชิญแดชบอร์ด?"),
        ("Request sent, waiting for the remote user to confirm.", "ส่งคำขอแล้ว กำลังรอการยืนยันจากผู้ใช้ระยะไกล"),
        ("Requesting invite code...", "กำลังขอรหัสคำเชิญ..."),
        ("The invite code is invalid or expired. Please try again later.", "รหัสคำเชิญไม่ถูกต้องหรือหมดอายุ โปรดลองใหม่ภายหลัง"),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "ผู้ใช้ระยะไกลยอมรับแล้วแต่การลงทะเบียนล้มเหลว อาจออฟไลน์หรือเข้าถึงแดชบอร์ดไม่ได้"),
        ("A previous request is still pending on the remote.", "ยังมีคำขอก่อนหน้าค้างอยู่บนเครื่องระยะไกล"),
        ("No response from the remote, request timed out.", "ไม่มีการตอบสนองจากเครื่องระยะไกล คำขอหมดเวลา"),
        ("This remote platform isn't supported for dashboard enrollment yet.", "แพลตฟอร์มระยะไกลนี้ยังไม่รองรับการลงทะเบียนแดชบอร์ด"),
        ("This device is already linked to your dashboard.", "อุปกรณ์นี้เชื่อมโยงกับแดชบอร์ดของคุณแล้ว"),
        ("Replace existing dashboard link?", "แทนที่การเชื่อมโยงแดชบอร์ดที่มีอยู่?"),
        ("This computer is currently linked to {} dashboard.", "คอมพิวเตอร์เครื่องนี้กำลังเชื่อมโยงกับแดชบอร์ดของ {}"),
        ...
        ("You can undo this any time in Settings > Dashboard.", "คุณสามารถยกเลิกได้ทุกเมื่อในการตั้งค่า > แดชบอร์ด"),
            ("Recent sessions will show here.", "เซสชันล่าสุดจะแสดงที่นี่"),
        ("No favorites yet.", "ยังไม่มีรายการโปรด"),
        ("No devices discovered.", "ไม่พบอุปกรณ์"),
        ("Waiting for new connection ...", "กำลังรอการเชื่อมต่อใหม่ ..."),
        ("Not Ready", "ไม่พร้อม"),
        ("ID / Relay Server", "เซิร์ฟเวอร์ ID / Relay"),
        ("Generate New Temporary Password", "สร้างรหัสผ่านชั่วคราวใหม่"),
        ("Confirm Password", "ยืนยันรหัสผ่าน"),
        ("Two-Factor Authentication Setup", "การตั้งค่าการยืนยันตัวตนสองขั้นตอน"),
        ("API URL", "API URL"),
        ("This software is licensed under", "ซอฟต์แวร์นี้อยู่ภายใต้สัญญาอนุญาต"),
        ("Source code is available", "ซอร์สโค้ดสามารถดูได้"),
        ("here", "ที่นี่"),
        ("Invite Code", "รหัสเชิญ"),
        ("Length:", "ความยาว:"),
        ("Link", "เชื่อมโยง"),
        ("PERMANENT PASSWORD", "รหัสผ่านถาวร"),
        ("RANDOM PASSWORD", "รหัสผ่านแบบสุ่ม"),
        ("Attachments:", "ไฟล์แนบ:"),
        ("Best image quality", "คุณภาพของภาพดีที่สุด"),
        ("Connection Manager", "ตัวจัดการการเชื่อมต่อ"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "เชื่อมโยงอยู่ในขณะนี้:"),
        ("Do not close this window while the tunnel is active", "อย่าปิดหน้าต่างนี้ขณะที่อุโมงค์เชื่อมต่อยังทำงานอยู่"),
        ("Enter Password", "กรอกรหัสผ่าน"),
        ("Enter a new invite code to re-link:", "กรอกรหัสเชิญใหม่เพื่อเชื่อมโยงอีกครั้ง:"),
        ("Establishing connection to remote device", "กำลังสร้างการเชื่อมต่อไปยังอุปกรณ์ปลายทาง"),
        ("File Already Exists", "มีไฟล์นี้อยู่แล้ว"),
        ("Input Blocked", "อินพุทถูกบล็อค"),
        ("Invalid code. Please try again.", "รหัสไม่ถูกต้อง กรุณาลองอีกครั้ง"),
        ("Keyboard", "คีย์บอร์ด"),
        ("Lock Screen", "ล็อคหน้าจอ"),
        ("Message", "ข้อความ"),
        ("Please enter the password for the remote device.", "กรุณากรอกรหัสผ่านของอุปกรณ์ปลายทาง"),
        ("Record Session", "บันทึกเซสชัน"),
        ("Type a message...", "พิมพ์ข้อความ..."),
        ("View Style", "รูปแบบการแสดงผล"),
        ("Waiting...", "กำลังรอ..."),
        ("Port Forwarding:", "การส่งต่อพอร์ท:"),
        ("Reconnecting", "กำลังเชื่อมต่อใหม่"),
        ("Reconnecting...", "กำลังเชื่อมต่อใหม่..."),
        ("Email is required", "จำเป็นต้องระบุอีเมล"),
        ("Please enter a valid email address", "กรุณากรอกที่อยู่อีเมลที่ถูกต้อง"),
        ("Ticket reopened", "เปิดตั๋วอีกครั้งแล้ว"),
        ("Your ticket will be sent to {}", "ตั๋วของคุณจะถูกส่งไปยัง {}"),
        ("your support team", "ทีมสนับสนุนของคุณ"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "อุปกรณ์นี้ไม่ได้เชื่อมต่อกับแดชบอร์ด ไม่สามารถส่งตั๋วได้"),
        ("We'll use this address to send you updates about your ticket", "เราจะใช้ที่อยู่นี้เพื่อส่งข้อมูลอัปเดตเกี่ยวกับตั๋วของคุณ"),
        ("You can also email {}", "คุณยังสามารถส่งอีเมลถึง {}"),
        ("You can also call {}", "คุณยังสามารถโทรหา {}"),
