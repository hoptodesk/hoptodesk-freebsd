...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "يرجى إدخال رقم المنفذ المحلي"),
        ("Please enter a remote port number", "يرجى إدخال رقم المنفذ البعيد"),
        ("Please enter local and remote port numbers", "يرجى إدخال أرقام المنافذ المحلية والبعيدة"),
        ("Copy", "نسخ"),
        ("Proxy Settings", "إعدادات البروكسي"),
        ("Add to my Dashboard", "إضافة إلى لوحة التحكم الخاصة بي"),
        ...
        ("Added to dashboard", "تمت الإضافة إلى لوحة التحكم"),
        ("Request declined", "تم رفض الطلب"),
        ("Add remote device to my dashboard", "إضافة جهاز بعيد إلى لوحة التحكم الخاصة بي"),
        ("Your IP", "عنوان IP الخاص بك"),
        ("Switch to ID", "التبديل إلى المعرف"),
        ("Switch to local IP", "التبديل إلى IP المحلي"),
        ("No local IP available - showing ID", "لا يوجد IP محلي متاح - عرض المعرف"),
        ("Copy your local IP to clipboard", "نسخ IP المحلي إلى الحافظة"),
        ("Your local IP address - share this for direct LAN connections", "عنوان IP المحلي الخاص بك - شارك هذا للاتصالات المباشرة عبر LAN"),
        ("Accept Dashboard Invite?", "قبول دعوة لوحة التحكم؟"),
        ("Request sent, waiting for the remote user to confirm.", "تم إرسال الطلب، في انتظار تأكيد المستخدم البعيد."),
        ("Requesting invite code...", "جارٍ طلب رمز الدعوة..."),
        ("The invite code is invalid or expired. Please try again later.", "رمز الدعوة غير صالح أو منتهي الصلاحية. يرجى المحاولة مرة أخرى لاحقًا."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "قبل المستخدم البعيد ولكن فشل التسجيل. قد يكون غير متصل أو غير قادر على الوصول إلى لوحة التحكم."),
        ("A previous request is still pending on the remote.", "لا يزال هناك طلب سابق معلق على الجهاز البعيد."),
        ("No response from the remote, request timed out.", "لا توجد استجابة من الجهاز البعيد، انتهت مهلة الطلب."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "هذه المنصة البعيدة غير مدعومة بعد لتسجيل لوحة التحكم."),
        ("This device is already linked to your dashboard.", "هذا الجهاز مرتبط بالفعل بلوحة التحكم الخاصة بك."),
        ("Replace existing dashboard link?", "استبدال الارتباط الحالي بلوحة التحكم؟"),
        ("This computer is currently linked to {} dashboard.", "هذا الكمبيوتر مرتبط حاليًا بلوحة تحكم {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} يدعو هذا الكمبيوتر للانضمام إلى لوحة تحكمه بدلاً من ذلك. ستتم إزالة الارتباط الحالي."),
        ("{} is inviting this computer to join their dashboard.", "{} يدعو هذا الكمبيوتر للانضمام إلى لوحة تحكمه."),
        ("You can undo this any time in Settings > Dashboard.", "يمكنك التراجع عن هذا في أي وقت في الإعدادات > لوحة التحكم."),
            ("Recent sessions will show here.", "ستظهر الجلسات الأخيرة هنا."),
        ("No favorites yet.", "لا توجد مفضلات بعد."),
        ("No devices discovered.", "لم يتم اكتشاف أي أجهزة."),
        ("Waiting for new connection ...", "في انتظار اتصال جديد ..."),
        ("Not Ready", "غير جاهز"),
        ("ID / Relay Server", "المعرف / خادم الوسيط"),
        ("Generate New Temporary Password", "إنشاء كلمة مرور مؤقتة جديدة"),
        ("Confirm Password", "تأكيد كلمة المرور"),
        ("Two-Factor Authentication Setup", "إعداد المصادقة الثنائية"),
        ("API URL", "API URL"),
        ("This software is licensed under", "هذا البرنامج مرخص بموجب"),
        ("Source code is available", "الكود المصدري متاح"),
        ("here", "هنا"),
        ("Invite Code", "رمز الدعوة"),
        ("Length:", "الطول:"),
        ("Link", "ربط"),
        ("PERMANENT PASSWORD", "كلمة المرور الدائمة"),
        ("RANDOM PASSWORD", "كلمة المرور العشوائية"),
        ("Attachments:", "المرفقات:"),
        ("Best image quality", "أفضل جودة للصورة"),
        ("Connection Manager", "مدير الاتصالات"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "مرتبط حاليًا:"),
        ("Do not close this window while the tunnel is active", "لا تغلق هذه النافذة أثناء نشاط النفق"),
        ("Enter Password", "أدخل كلمة المرور"),
        ("Enter a new invite code to re-link:", "أدخل رمز دعوة جديدًا لإعادة الربط:"),
        ("Establishing connection to remote device", "جارٍ إنشاء الاتصال بالجهاز البعيد"),
        ("File Already Exists", "الملف موجود بالفعل"),
        ("Input Blocked", "تم حظر الإدخال"),
        ("Invalid code. Please try again.", "رمز غير صالح. يرجى المحاولة مرة أخرى."),
        ("Keyboard", "لوحة المفاتيح"),
        ("Lock Screen", "قفل الشاشة"),
        ("Message", "رسالة"),
        ("Please enter the password for the remote device.", "يرجى إدخال كلمة مرور الجهاز البعيد."),
        ("Record Session", "تسجيل الجلسة"),
        ("Type a message...", "اكتب رسالة..."),
        ("View Style", "شكل العرض"),
        ...
        ("Ticket reopened", "تمت إعادة فتح التذكرة"),
        ("Your ticket will be sent to {}", "سيتم إرسال تذكرتك إلى {}"),
        ("your support team", "فريق الدعم الخاص بك"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "هذا الجهاز غير متصل بلوحة تحكم. لا يمكن إرسال التذاكر."),
        ("We'll use this address to send you updates about your ticket", "سنستخدم هذا العنوان لإرسال تحديثات حول تذكرتك"),
        ("You can also email {}", "يمكنك أيضًا مراسلة {}"),
        ("You can also call {}", "يمكنك أيضًا الاتصال بـ {}"),
