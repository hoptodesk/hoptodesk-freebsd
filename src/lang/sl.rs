...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status_short", "Povezovanje..."),
        ...
        ("not_ready_status_short", "Ni pripravljeno."),
        ...
        ("Unable to connect to the remote partner.", "Ni se bilo mogoče povezati na posredniški strežnik"),
        ("Failed to connect to signal server", "Ni se bilo mogoče povezati preko povezovalnega strežnika"),
        ...
        ("The peer has exited from Privacy Mode.", "Odjemalec se je zaprl"),
        ...
        ("Start Screen Share", "Začni deliti zaslon"),
        ("Stop Screen Share", "Ustavite deljenje zaslona"),
        ...
        ("config_input", "Za nadzor oddaljenega namizja s tipkovnico, rabi HopToDesk pravico »Nadzor vnosa«."),
        ("config_microphone", "Za zajem zvoka, rabi HopToDesk pravico »Snemanje zvoka«."),
        ...
        ("Elevated successfully.", "Povzdig pravic uspešen"),
        ...
        ("empty_recent_tip", "Tukaj bodo prikazane nedavne seje."),
        ("empty_favorite_tip", "Tukaj bodo prikazani najljubši vrstniki."),
        ...
        ("verify_hoptodesk_password_tip", "Preveri geslo za HopToDesk"),
        ...
        ("Privacy Mode started.", "Začel se je način zasebnosti."),
        ("Privacy Mode turned off.", "Način zasebnosti je izključen"),
        ...
        ("enable-2fa-desc-verify", "Vnesite 6-mestno kodo, ki jo ustvari vaša aplikacija za preverjanje pristnosti:"),
        ...
        ("2FA setup successfully.", "2FA je bil uspešno nastavljen."),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno HopToDeska odprto"),
        ...
        ("floating_window_tip", "Pomaga pri HopToDesk storitvi v ozadju"),
        ...
        ("enter-2fa-setup", "Nastavitev dvofaktorske overitve"),
        ...
        ("Untagged", "Neoznačeno"),
        ("Accessible devices", ""),
        ("d3d_render_tip", "Ko je upodabljanje D3D omogočeno, je zaslon oddaljenega upravljanja na nekaterih napravah lahko črn."),
        ("Use D3D rendering", ""),
        ("Printer", ""),
        ...
        ("print-incoming-job-confirm-tip", "Prejeli ste tiskalno opravilo z oddaljenega računalnika. Ga želite izvesti na vaši strani?"),
        ("remote-printing-disallowed-tile-tip", "Oddaljeno tiskanje ni dovoljeno"),
        ("remote-printing-disallowed-text-tip", "Nastavitve dovoljenj nadzorovane strani zavračajo oddaljeno tiskanje."),
        ("dont-show-again-tip", "Ne prikazuj več"),
        ("Take screenshot", ""),
        ("Taking screenshot", ""),
        ...
        ("Auto update", ""),
        ("websocket_tip", "Pri uporabi WebSocket so podprte samo posredniške povezave."),
        ...
        ("Numeric one-time password", "Številčno enkratno geslo"),
        ("Enable IPv6 P2P connection", "Omogoči povezavo P2P IPv6"),
        ("Enable UDP hole punching", "Omogoči prebijanje lukenj UDP"),
        ("View Camera", "Prikaži kamero"),
        ...
        ("Show my cursor", "Pokaži moj kazalec"),
        ("Scale custom", ""),
        ("Custom scale slider", ""),
        ("Decrease", ""),
        ("Increase", ""),
        ...
        ("Choose Network", "Izberi omrežje"),
        ("Enter your custom network settings URL:", "Vnesite URL za nastavitve omrežja po meri:"),
        ("HopToDesk Network (Default)", "Omrežje HopToDesk (Privzeto)"),
        ("Use HopToDesk Network", "Uporabite omrežje HopToDesk"),
        ("Custom Network URL", "URL omrežja po meri"),
        ("Custom Network Settings", "Nastavitve omrežja po meri"),
        ("Custom Network Error", "Napaka pri omrežju po meri"),
        ("The custom network URL provided was not valid, please try again.", "Navedeni URL za omrežje po meri ni veljaven, poskusite znova."),
        ...
        ("Password (Click to Copy)", "Geslo (Kliknite za kopiranje)"),
        ("Unattended Access", "Nenadzorovan dostop"),
        ("An update is available, do you want to update to the new version?", "Na voljo je posodobitev, ali želite posodobiti na novo različico?"),
        ("Invite", "Povabi"),
        ("Invite A Device", "Povabite napravo"),
        ("Input an ID to send a connection invitation for this device:", "Vnesite ID za pošiljanje povabila za povezavo za to napravo:"),
        ("Please enter a valid device ID.", "Vnesite veljaven ID naprave."),
        ("Device ID must contain only numbers (0-9).", "ID naprave mora vsebovati samo številke (0-9)."),
        ("Peer ID", "ID kontakta"),
        ("Device ID to invite", "ID naprave za povabilo"),
        ("Accept invite to connect to this computer?", "Sprejmite povabilo za povezavo s tem računalnikom?"),
        ("Incoming Connections Off.", "Dohodni povezave izključene"),
        ("Allow Incoming Connections", "Dovoli dohodne povezave"),
        ("Enable Incoming Connections", "Omogoči dohodne povezave"),
        ("Chat sessions will show here.", "Pogovori v klepetu bodo prikazani tukaj."),
        ("Connect to a device to start chatting.", "Povežite se z napravo za začetek klepeta."),
        ("No chats yet", "Še ni pogovorov"),
        ("ios_screen_share_tip", "Dotaknite se [Začni deliti zaslon] za začetek oddajanja vašega zaslona. Vaša ID naprave in geslo se bosta prikazala, ko se bo oddajanje začelo."),
        ("This Device", "Ta naprava"),
        ("Remote Control", "Daljinski upravljalnik"),
        ("Copy ID", "Kopiraj ID"),
        ("Menu", "Meni"),
        ("Hostname", "Ime gostitelja"),
        ("Enable Remote Printing", "Omogoči oddaljeno tiskanje"),
        ("Enable unattended access to this device", "Omogoči nenadzorovani dostop do te naprave"),
        ("Custom network settings URL", "URL nastavitev omrežja po meri"),
        ("Update Available", ""),
        ("Don't show this again.", ""),
        ("WOL", ""),
        ("Your ID", "Vaša osebna izkaznica"),
        ("Partner ID", "ID partnerja"),
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "Nastavite trajno geslo za omogočanje dostopa do te naprave kadar koli, tudi ko ni nikogar prisotnega."),
        ("View camera", "Ogled kamere"),
        ("16-character invite code", "16-znakovna koda povabila"),
        ("Add File", "Dodaj datoteko"),
        ("Always use this printer", "Vedno uporabi ta tiskalnik"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "Druga naprava HopToDesk v istem omrežju mora biti povezana za posredovanje signala za prebujanje"),
        ("Appearance", "Videz"),
        ("Are you sure you want to switch sides", "Ali ste prepričani, da želite zamenjati strani"),
        ("Attachment", "Priloga"),
        ("Attachments", "Priloge"),
        ("Brief description of the issue", "Kratek opis težave"),
        ("Can not invite yourself.", "Ne morete povabiti sami sebe."),
        ("Change Display", "Zamenjaj zaslon"),
        ("Change password settings", "Spremeni nastavitve gesla"),
        ("Click to load tickets", "Kliknite za nalaganje zahtevkov"),
        ("Clipboard", "Odložišče"),
        ("Confirm", "Potrdi"),
        ("Connected to", "Povezano z"),
        ("Connection failed", "Povezava ni uspela"),
        ("Copy your device ID to clipboard so others can connect to you", "Kopirajte ID naprave v odložišče, da se lahko drugi povežejo z vami"),
        ("Current Wayland display server is not supported.", "Trenutni prikazovalnik Wayland ni podprt."),
        ("Dashboard", "Nadzorna plošča"),
        ("Describe your issue in detail", "Podrobno opišite svojo težavo"),
        ("Description", "Opis"),
        ("Description is required", "Opis je obvezen"),
        ("Different layout", "Drugačna razporeditev"),
        ("Edit", "Uredi"),
        ("Email", "E-pošta"),
        ("Enable Permissions", "Omogoči dovoljenja"),
        ("Enable recording session", "Omogoči snemanje seje"),
        ("Enable remote restart", "Omogoči oddaljeni ponovni zagon"),
        ("Enter Invite Code", "Vnesite kodo povabila"),
        ("Enter your invite code to link this device to a dashboard.", "Vnesite kodo povabila za povezavo te naprave z nadzorno ploščo."),
        ("Failed to load conversation", "Nalaganje pogovora ni uspelo"),
        ("Failed to load tickets", "Nalaganje zahtevkov ni uspelo"),
        ("Failed to submit ticket", "Oddaja zahtevka ni uspela"),
        ("File Transfer", "Prenos datotek"),
        ("File size", "Velikost datoteke"),
        ("High", "Visoka"),
        ("Initializing", "Inicializacija"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "Neveljavna koda povabila. Biti mora 16 znakov (črke in številke)."),
        ("Keyboard mode", "Način tipkovnice"),
        ("Keyboard/Mouse", "Tipkovnica/Miška"),
        ("LAN Discovery", "Odkrivanje v LAN"),
        ("Length", "Dolžina"),
        ("Linked", "Povezano"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Povezovanje z nadzorno ploščo... Ta naprava se bo kmalu prikazala na nadzorni plošči."),
        ("Loading...", "Nalaganje..."),
        ("Login screen using Wayland is not supported.", "Prijavni zaslon z uporabo Wayland ni podprt."),
        ("Low", "Nizka"),
        ("My Tickets", "Moji zahtevki"),
        ("New Ticket", "Nov zahtevek"),
        ("New reply received", "Prejet nov odgovor"),
        ("No", "Ne"),
        ("No messages", "Ni sporočil"),
        ("No printers found on this computer.", "Na tem računalniku ni bilo najdenih tiskalnikov."),
        ("No tickets found", "Ni najdenih zahtevkov"),
        ("OS Username", "Uporabniško ime OS"),
        ("Open a file transfer session to send or receive files", "Odprite sejo za prenos datotek za pošiljanje ali prejemanje datotek"),
        ("Open support tickets", "Odpri zahtevke za podporo"),
        ("Password Settings", "Nastavitve gesla"),
        ("Password settings", "Nastavitve gesla"),
        ("Permanent Password", "Trajno geslo"),
        ("Priority", "Prioriteta"),
        ("Privacy Mode", "Način zasebnosti"),
        ("Privacy Policy", "Politika zasebnosti"),
        ("Random Password", "Naključno geslo"),
        ("Remote Access", "Oddaljeni dostop"),
        ("Remote Print", "Oddaljeno tiskanje"),
        ("Remote Print Job", "Oddaljena tiskalna naloga"),
        ("Remote Printing", "Oddaljeno tiskanje"),
        ("Remote Restart", "Oddaljeni ponovni zagon"),
        ("Requirements:", "Zahteve:"),
        ("Restart remote device", "Ponovno zaženi oddaljeno napravo"),
        ("Same layout", "Enaka razporeditev"),
        ("Save", "Shrani"),
        ("Screenshot", "Posnetek zaslona"),
        ("Screenshot saved to clipboard", "Posnetek zaslona shranjen v odložišče"),
        ("Select printer for remote print job", "Izberite tiskalnik za oddaljeno tiskalno nalogo"),
        ("Send a connection invitation to another device by entering its ID", "Pošljite povabilo za povezavo drugi napravi z vnosom njenega ID-ja"),
        ("Set", "Nastavi"),
        ("Start a remote desktop session with the partner device", "Začnite sejo oddaljenega namizja s partnersko napravo"),
        ("Subject", "Zadeva"),
        ("Subject is required", "Zadeva je obvezna"),
        ("Submit Ticket", "Oddaj zahtevek"),
        ("Success", "Uspeh"),
        ("Support", "Podpora"),
        ("Switch Display", "Zamenjaj zaslon"),
        ("Switch sides", "Zamenjaj strani"),
        ("The network adapter must have WoL enabled in OS settings", "Omrežni adapter mora imeti omogočen WoL v nastavitvah OS"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "Signal za prebujanje pošlje druga povezana naprava HopToDesk v istem lokalnem omrežju. Sprožite ga lahko iz imenika v kateremkoli odjemalcu HopToDesk ali z nadzorne plošče, če je naprava registrirana."),
        ("This device is linked to a dashboard.", "Ta naprava je povezana z nadzorno ploščo."),
        ("This device must be connected via Ethernet (not WiFi)", "Ta naprava mora biti povezana prek Etherneta (ne WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Zahtevek uspešno oddan!"),
        ("Tickets", "Zahtevki"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "Zahtevke je mogoče ustvariti le, če je ta naprava povezana z uporabnikom nadzorne plošče."),
        ("To change, enter a new invite code:", "Za spremembo vnesite novo kodo povabila:"),
        ("Tunnel", "Tunel"),
        ("Two-Factor Authentication", "Dvostopenjska avtentikacija"),
        ("Type your reply...", "Vpišite svoj odgovor..."),
        ("Urgent", "Nujno"),
        ("View Security Code", "Prikaži varnostno kodo"),
        ("Waiting for RDP client", "Čakanje na odjemalca RDP"),
        ("Wake On LAN", "Wake On LAN"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "Wake On LAN vam omogoča oddaljeni vklop te naprave iz drugega odjemalca HopToDesk ali z nadzorne plošče."),
        ("Yes", "Da"),
        ("You", "Vi"),
        ("You can find this code in your dashboard invite link.", "To kodo najdete v povezavi povabila na nadzorni plošči."),
        ("You have a new reply on one of your tickets", "Imate nov odgovor na enega od vaših zahtevkov"),
        ("Your email address", "Vaš e-poštni naslov"),
        ("Your unique device ID - share this with others so they can connect to you", "Vaš edinstveni ID naprave - delite ga z drugimi, da se lahko povežejo z vami"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "presega omejitev 5MB. Prosimo, izberite manjšo datoteko."),
        ("via", "prek"),

        ("Device", "Naprava"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "WoL mora biti omogočen v nastavitvah BIOS/UEFI naprave"),
        ("Are you sure you want to delete", "Ali ste prepričani, da želite izbrisati"),
        ("Please enter a local port number", "Vnesite številko lokalnih vrat"),
        ("Please enter a remote port number", "Vnesite številko oddaljenih vrat"),
        ("Please enter local and remote port numbers", "Vnesite številke lokalnih in oddaljenih vrat"),
        ("Copy", "Kopiraj"),
        ("Proxy Settings", "Nastavitve proxyja"),
        ("Add to my Dashboard", "Dodaj na mojo nadzorno ploščo"),
        ...
        ("Added to dashboard", "Dodano na nadzorno ploščo"),
        ("Request declined", "Zahteva zavrnjena"),
        ("Add remote device to my dashboard", "Dodaj oddaljeno napravo na mojo nadzorno ploščo"),
        ("Your IP", "Vaš IP"),
        ("Switch to ID", "Preklopi na ID"),
        ("Switch to local IP", "Preklopi na lokalni IP"),
        ("No local IP available - showing ID", "Lokalni IP ni na voljo - prikazuje se ID"),
        ("Copy your local IP to clipboard", "Kopiraj lokalni IP v odložišče"),
        ("Your local IP address - share this for direct LAN connections", "Vaš lokalni IP naslov - delite ga za neposredne LAN povezave"),
        ("Accept Dashboard Invite?", "Sprejmi povabilo na nadzorno ploščo?"),
        ("Request sent, waiting for the remote user to confirm.", "Zahteva poslana, čaka se na potrditev oddaljenega uporabnika."),
        ("Requesting invite code...", "Zahtevanje kode povabila..."),
        ("The invite code is invalid or expired. Please try again later.", "Koda povabila je neveljavna ali je potekla. Poskusite znova kasneje."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Oddaljeni uporabnik je sprejel, vendar je registracija spodletela. Morda je nepovezan ali ne more doseči nadzorne plošče."),
        ("A previous request is still pending on the remote.", "Na oddaljeni napravi še vedno čaka prejšnja zahteva."),
        ("No response from the remote, request timed out.", "Brez odgovora oddaljene naprave, čas zahteve je potekel."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ta oddaljena platforma še ni podprta za registracijo na nadzorno ploščo."),
        ("This device is already linked to your dashboard.", "Ta naprava je že povezana z vašo nadzorno ploščo."),
        ("Replace existing dashboard link?", "Zamenjati obstoječo povezavo z nadzorno ploščo?"),
        ("This computer is currently linked to {} dashboard.", "Ta računalnik je trenutno povezan z nadzorno ploščo {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} vabi ta računalnik, da se pridruži njegovi nadzorni plošči namesto tega. Obstoječa povezava bo odstranjena."),
        ("{} is inviting this computer to join their dashboard.", "{} vabi ta računalnik, da se pridruži njegovi nadzorni plošči."),
        ("You can undo this any time in Settings > Dashboard.", "To lahko kadar koli razveljavite v Nastavitve > Nadzorna plošča."),
            ("Recent sessions will show here.", "Tukaj bodo prikazane nedavne seje."),
        ("No favorites yet.", "Ni še priljubljenih."),
        ("No devices discovered.", "Ni odkritih naprav."),
        ("Waiting for new connection ...", "Čakanje na novo povezavo ..."),
        ("Not Ready", "Ni pripravljeno"),
        ("ID / Relay Server", "ID / posredniški strežnik"),
        ("Generate New Temporary Password", "Ustvari novo začasno geslo"),
        ("Confirm Password", "Potrdi geslo"),
        ("Two-Factor Authentication Setup", "Nastavitev dvostopenjske avtentikacije"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Ta programska oprema je licencirana pod"),
        ("Source code is available", "Izvorna koda je na voljo"),
        ("here", "tukaj"),
        ...
        ("RANDOM PASSWORD", "NAKLJUČNO GESLO"),
        ("Attachments:", "Priloge:"),
        ("Best image quality", "Najboljša kakovost slike"),
        ("Connection Manager", "Upravitelj povezav"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Trenutno povezano:"),
        ("Do not close this window while the tunnel is active", "Ne zapirajte tega okna, dokler je tunel aktiven"),
        ("Enter Password", "Vnesi geslo"),
        ("Enter a new invite code to re-link:", "Vnesi novo kodo povabila za ponovno povezavo:"),
        ("Establishing connection to remote device", "Vzpostavljanje povezave z oddaljeno napravo"),
        ("File Already Exists", "Datoteka že obstaja"),
        ("Input Blocked", "Vnos blokiran"),
        ("Invalid code. Please try again.", "Neveljavna koda. Poskusi znova."),
        ("Keyboard", "Tipkovnica"),
        ("Lock Screen", "Zakleni zaslon"),
        ("Message", "Sporočilo"),
        ("Please enter the password for the remote device.", "Vnesi geslo oddaljene naprave."),
        ("Record Session", "Snemaj sejo"),
        ("Type a message...", "Napiši sporočilo..."),
        ("View Style", "Slog pogleda"),
        ("Waiting...", "Čakanje..."),
        ("Port Forwarding:", "Posredovanje vrat:"),
        ("Reconnecting", "Ponovno povezovanje"),
        ("Reconnecting...", "Ponovno povezovanje..."),
        ("Email is required", "E-pošta je obvezna"),
        ("Please enter a valid email address", "Vnesite veljaven e-poštni naslov"),
        ("Ticket reopened", "Zahtevek je ponovno odprt"),
        ("Your ticket will be sent to {}", "Vaš zahtevek bo poslan {}"),
        ("your support team", "vaši podporni ekipi"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Ta naprava ni povezana z nadzorno ploščo. Zahtevkov ni mogoče poslati."),
        ("We'll use this address to send you updates about your ticket", "Ta naslov bomo uporabili za posodobitve vašega zahtevka"),
        ("You can also email {}", "Lahko pišete tudi na {}"),
        ("You can also call {}", "Lahko pokličete tudi {}"),
