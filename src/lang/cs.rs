...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Zadejte číslo místního portu"),
        ("Please enter a remote port number", "Zadejte číslo vzdáleného portu"),
        ("Please enter local and remote port numbers", "Zadejte čísla místního a vzdáleného portu"),
        ("Copy", "Kopírovat"),
        ("Proxy Settings", "Nastavení proxy"),
        ("Add to my Dashboard", "Přidat na můj panel"),
        ...
        ("Added to dashboard", "Přidáno na panel"),
        ("Request declined", "Žádost zamítnuta"),
        ("Add remote device to my dashboard", "Přidat vzdálené zařízení na můj panel"),
        ("Your IP", "Vaše IP"),
        ("Switch to ID", "Přepnout na ID"),
        ("Switch to local IP", "Přepnout na místní IP"),
        ("No local IP available - showing ID", "Není dostupná žádná místní IP - zobrazuje se ID"),
        ("Copy your local IP to clipboard", "Kopírovat místní IP do schránky"),
        ("Your local IP address - share this for direct LAN connections", "Vaše místní IP adresa - sdílejte ji pro přímá LAN spojení"),
        ("Accept Dashboard Invite?", "Přijmout pozvánku na panel?"),
        ("Request sent, waiting for the remote user to confirm.", "Žádost odeslána, čeká se na potvrzení vzdáleného uživatele."),
        ("Requesting invite code...", "Vyžaduje se kód pozvánky..."),
        ("The invite code is invalid or expired. Please try again later.", "Kód pozvánky je neplatný nebo vypršel. Zkuste to prosím znovu později."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Vzdálený uživatel souhlasil, ale registrace selhala. Možná je offline nebo nemá přístup k panelu."),
        ("A previous request is still pending on the remote.", "Na vzdáleném zařízení stále čeká předchozí žádost."),
        ("No response from the remote, request timed out.", "Žádná odpověď ze vzdáleného zařízení, časový limit žádosti vypršel."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Tato vzdálená platforma zatím není podporována pro registraci na panel."),
        ("This device is already linked to your dashboard.", "Toto zařízení je již propojeno s vaším panelem."),
        ("Replace existing dashboard link?", "Nahradit existující propojení s panelem?"),
        ("This computer is currently linked to {} dashboard.", "Tento počítač je momentálně propojen s panelem {}."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Toto můžete kdykoli zrušit v Nastavení > Panel."),
            ("Recent sessions will show here.", "Zde se zobrazí nedávné relace."),
        ("No favorites yet.", "Zatím žádné oblíbené položky."),
        ("No devices discovered.", "Nebyla nalezena žádná zařízení."),
        ("Waiting for new connection ...", "Čekání na nové připojení ..."),
        ("Not Ready", "Nepřipraveno"),
        ("ID / Relay Server", "ID / předávací server"),
        ("Generate New Temporary Password", "Vygenerovat nové dočasné heslo"),
        ("Confirm Password", "Potvrďte heslo"),
        ("Two-Factor Authentication Setup", "Nastavení dvoufaktorového ověření"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Tento software je licencován pod licencí"),
        ("Source code is available", "Zdrojový kód je k dispozici"),
        ("here", "zde"),
        ("Invite Code", "Zvací kód"),
        ("Length:", "Délka:"),
        ("Link", "Propojit"),
        ("PERMANENT PASSWORD", "TRVALÉ HESLO"),
        ("RANDOM PASSWORD", "NÁHODNÉ HESLO"),
        ("Attachments:", "Přílohy:"),
        ("Best image quality", "Nejlepší kvalita obrazu"),
        ("Connection Manager", "Správce připojení"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Aktuálně propojeno:"),
        ("Do not close this window while the tunnel is active", "Nezavírejte toto okno, dokud je tunel aktivní"),
        ("Enter Password", "Zadejte heslo"),
        ("Enter a new invite code to re-link:", "Zadejte nový zvací kód pro opětovné propojení:"),
        ("Establishing connection to remote device", "Navazování spojení se vzdáleným zařízením"),
        ("File Already Exists", "Soubor již existuje"),
        ("Input Blocked", "Vstup blokován"),
        ("Invalid code. Please try again.", "Neplatný kód. Zkuste to prosím znovu."),
        ("Keyboard", "Klávesnice"),
        ("Lock Screen", "Zamknout obrazovku"),
        ("Message", "Zpráva"),
        ("Please enter the password for the remote device.", "Zadejte prosím heslo vzdáleného zařízení."),
        ("Record Session", "Nahrávat relaci"),
        ("Type a message...", "Napište zprávu..."),
        ("View Style", "Styl zobrazení"),
        ("Waiting...", "Čeká se..."),
        ...
        ("Ticket reopened", "Tiket byl znovu otevřen"),
        ("Your ticket will be sent to {}", "Váš tiket bude odeslán {}"),
        ("your support team", "vašemu týmu podpory"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Toto zařízení není připojeno k žádnému dashboardu. Tikety nelze odeslat."),
        ("We'll use this address to send you updates about your ticket", "Na tuto adresu budeme zasílat aktualizace k vašemu tiketu"),
        ("You can also email {}", "Můžete také napsat na {}"),
        ("You can also call {}", "Můžete také zavolat na {}"),
