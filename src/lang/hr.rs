...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Unable to connect to the remote partner.", "Nije moguće povezati se s udaljenim partnerom."),
        ...
        ("install_tip", "Preporučuje se instalacija."),
        ...
        ("Rename", "Preimenuj"),
        ("Space", "Prazno"),
        ("Create Desktop Shortcut", "Stvorite prečac na radnoj površini"),
        ...
        ("Failed", "Neuspješno"),
        ("Succeeded", "Uspešno"),
        ("Someone turned on privacy mode, exiting.", "Netko je uključio način privatnosti, izlaz."),
        ("Unsupported", "Nepodržano"),
        ("Peer denied", "Klijent zabranjen"),
        ("Please install plugins", "Molimo instalirajte dodatke"),
        ("The peer has exited from Privacy Mode.", "Klijent je izašao"),
        ...
        ("Restart Remote Device", "Ponovno pokrenite udaljeni uređaj"),
        ("Are you sure you want to restart", "Jeste li sigurni da želite ponovno pokretanje"),
        ("Restarting Remote Device", "Ponovno pokretanje udaljenog uređaja"),
        ...
        ("Start Screen Share", "Započni dijeljenje zaslona"),
        ("Stop Screen Share", "Zaustavi dijeljenje zaslona"),
        ...
        ("Elevated successfully.", "Uspješno podizanje"),
        ...
        ("empty_recent_tip", "Ovdje će se prikazati nedavne sesije."),
        ("empty_favorite_tip", "Ovdje će se prikazati omiljeni vršnjaci."),
        ("empty_lan_tip", "Ovdje će se prikazati otkriveni vršnjaci."),
        ("empty_address_book_tip", "U vašem adresaru trenutno nema navedenih kolega."),
        ("eg: admin", "napr. admin"),
        ...
        ("verify_hoptodesk_password_tip", "Provjera lozinke za HopToDesk"),
        ...
        ("enable-2fa-desc-verify", "Unesite 6-znamenkasti kod generiran vašom aplikacijom za autentifikaciju:" ),
        ...
        ("2FA setup successfully.", "2FA uspješno postavljen."),
        ...
        ("allow-only-conn-window-open-tip", "Dopusti povezivanje samo ako je HopToDesk prozor otvoren" ),
        ("no_need_privacy_mode_no_physical_displays_tip", "Nema fizičkih zaslona, nema potrebe za načinom privatnosti." ),
        ("Follow remote cursor", ""),
        ("Follow remote window focus", ""),
        ("default_proxy_tip", "Zadani protokol i port su SOCKS5 i 1080" ),
        ("no_audio_input_device_tip", "Nije pronađen uređaj za audio ulaz." ),
        ("Incoming", ""),
        ("Outgoing", ""),
        ("Clear Wayland screen selection", ""),
        ("android_new_voice_call_tip", "Primljen je novi zahtjev za glasovni poziv. Ako prihvatite, zvuk će se prebaciti na glasovnu komunikaciju." ),
        ("texture_render_tip", "Koristite teksturno renderiranje za glađe slike. Možete pokušati onemogućiti ovu opciju ako imate probleme s renderiranjem." ),
        ("Use texture rendering", ""),
        ("Floating window", ""),
        ("floating_window_tip", "Pomaže u održavanju HopToDesk usluge." ),
        ("Keep screen on", ""),
        ("Never", ""),
        ("During controlled", ""),
        ...
        ("Power", ""),
        ("Telegram bot", ""),
        ("enable-bot-tip", "Ako omogućite ovu značajku, možete primati 2FA kod od svog bota. Također može služiti kao obavijest o povezivanju." ),
        ("enable-bot-desc", "1, Otvorite razgovor s @BotFather.\n2, Pošaljite naredbu \"/newbot\". Nakon dovršetka ovog koraka primit ćete token.\n3, Započnite razgovor s novostvorenim botom. Pošaljite poruku koja počinje kosom crtom (\"/\") poput \"/hello\" za aktivaciju.\n" ),
        ("cancel-2fa-confirm-tip", "Jeste li sigurni da želite otkazati 2FA?" ),
        ("enter-2fa-setup", "Postavljanje dvofaktorske autentifikacije" ),
        ("cancel-bot-confirm-tip", "Jeste li sigurni da želite otkazati Telegram bota?" ),
        ("About HopToDesk", ""),
        ("Send clipboard keystrokes", ""),
        ("network_error_tip", "Provjerite mrežnu vezu, a zatim kliknite pokušaj ponovo." ),
        ("Unlock with PIN", ""),
        ...
        ("Resume", ""),
        ("Invalid file name", ""),
        ("one-way-file-transfer-tip", "Jednosmjerni prijenos datoteka je omogućen na kontroliranoj strani." ),
        ...
        ("Untagged", ""),
        ("Accessible devices", ""),
        ("d3d_render_tip", "Kada je D3D renderiranje omogućeno, zaslon za daljinsko upravljanje može biti crn na nekim računalima." ),
        ("Use D3D rendering", ""),
        ("Printer", ""),
        ("printer-os-requirement-tip", "Funkcija odlaznog ispisa zahtijeva Windows 10 ili noviji." ),
        ("printer-requires-installed-{}-client-tip", "Za korištenje daljinskog ispisa, {} mora biti instaliran na ovom uređaju." ),
        ...
        ("auto-print-tip", "Automatski ispiši koristeći odabrani pisač." ),
        ("print-incoming-job-confirm-tip", "Primili ste zadatak ispisa s udaljenog računala. Želite li ga izvršiti na svojoj strani?" ),
        ("remote-printing-disallowed-tile-tip", "Daljinski ispis nije dopušten" ),
        ("remote-printing-disallowed-text-tip", "Postavke dozvola kontrolirane strane odbijaju daljinski ispis." ),
        ("dont-show-again-tip", "Ne prikazuj ponovno" ),
        ("Take screenshot", ""),
        ("Taking screenshot", ""),
        ...
        ("Auto update", ""),
        ("websocket_tip", "Kada se koristi WebSocket, podržane su samo relej veze." ),
        ("Use WebSocket", ""),
        ("Trackpad speed", ""),
        ...
        ("Use HopToDesk Network", "Koristite HopToDesk Mrežu"),
        ("Custom Network URL", "Prilagođeni URL mreže"),
        ...
        ("An update is available, do you want to update to the new version?", "Dostupno je ažuriranje, želite li ažurirati na novu verziju?"),
        ("Invite", "Pozovi"),
        ("Invite A Device", "Pozovite uređaj"),
        ("Input an ID to send a connection invitation for this device:", "Unesite ID da biste poslali pozivnicu za povezivanje za ovaj uređaj:"),
        ("Please enter a valid device ID.", "Molimo unesite važeći ID uređaja."),
        ("Device ID must contain only numbers (0-9).", "ID uređaja mora sadržavati samo brojeve (0-9)."),
        ("Peer ID", "ID kontakta"),
        ("Device ID to invite", "ID uređaja za poziv"),
        ("Accept invite to connect to this computer?", "Prihvatite poziv za povezivanje s ovim računalom?"),
        ("Incoming Connections Off.", "Dolazne veze isključene"),
        ("Allow Incoming Connections", "Dopusti dolazne veze"),
        ("Enable Incoming Connections", "Omogući dolazne veze"),
        ("Chat sessions will show here.", "Sjednice za chat će se prikazati ovdje."),
        ("Connect to a device to start chatting.", "Povežite se s uređajem da biste započeli razgovor."),
        ("No chats yet", "Još nema chatova"),
        ("ios_screen_share_tip", "Dodirnite [Pokreni dijeljenje zaslona] da biste započeli emitiranje zaslona. Vaš ID uređaja i zaporka pojavit će se nakon početka emitiranja."),
        ("This Device", "Ovaj uređaj"),
        ("Remote Control", "Daljinski upravljač"),
        ("Copy ID", "Kopiraj ID"),
        ("Menu", "Izbornik"),
        ("Hostname", "Naziv hosta"),
        ("Enable Remote Printing", "Omogući daljinsko ispisivanje"),
        ("Enable unattended access to this device", "Omogući nenadzirani pristup ovom uređaju"),
        ...
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "Postavite trajni zaporku za omogućavanje pristupa ovom uređaju u bilo koje vrijeme, čak i kada nitko nije prisutan."),
        ("View camera", "Pregledaj kameru"),
        ("16-character invite code", "16-znakovni pozivni kôd"),
        ("Add File", "Dodaj datoteku"),
        ("Always use this printer", "Uvijek koristi ovaj pisač"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "Drugi HopToDesk uređaj na istoj mreži mora biti na mreži za prosljeđivanje signala buđenja"),
        ("Appearance", "Izgled"),
        ("Are you sure you want to switch sides", "Jeste li sigurni da želite zamijeniti strane"),
        ("Attachment", "Privitak"),
        ("Attachments", "Privici"),
        ("Brief description of the issue", "Kratki opis problema"),
        ("Can not invite yourself.", "Ne možete pozvati sami sebe."),
        ("Change Display", "Promijeni zaslon"),
        ("Change password settings", "Promijeni postavke lozinke"),
        ("Click to load tickets", "Kliknite za učitavanje zahtjeva"),
        ("Clipboard", "Međuspremnik"),
        ("Confirm", "Potvrdi"),
        ("Connected to", "Povezano s"),
        ("Connection failed", "Povezivanje nije uspjelo"),
        ("Copy your device ID to clipboard so others can connect to you", "Kopirajte ID uređaja u međuspremnik kako bi se drugi mogli povezati s vama"),
        ("Current Wayland display server is not supported.", "Trenutni Wayland poslužitelj zaslona nije podržan."),
        ("Dashboard", "Upravljačka ploča"),
        ("Describe your issue in detail", "Detaljno opišite svoj problem"),
        ("Description", "Opis"),
        ("Description is required", "Opis je obavezan"),
        ("Different layout", "Drugačiji raspored"),
        ("Edit", "Uredi"),
        ("Email", "E-pošta"),
        ("Enable Permissions", "Omogući dozvole"),
        ("Enable recording session", "Omogući snimanje sesije"),
        ("Enable remote restart", "Omogući udaljeno ponovno pokretanje"),
        ("Enter Invite Code", "Unesite pozivni kôd"),
        ("Enter your invite code to link this device to a dashboard.", "Unesite pozivni kôd za povezivanje ovog uređaja s upravljačkom pločom."),
        ("Failed to load conversation", "Učitavanje razgovora nije uspjelo"),
        ("Failed to load tickets", "Učitavanje zahtjeva nije uspjelo"),
        ("Failed to submit ticket", "Slanje zahtjeva nije uspjelo"),
        ("File Transfer", "Prijenos datoteka"),
        ("File size", "Veličina datoteke"),
        ("High", "Visok"),
        ("Initializing", "Inicijalizacija"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "Nevažeći pozivni kôd. Mora imati 16 znakova (slova i brojevi)."),
        ("Keyboard mode", "Način rada tipkovnice"),
        ("Keyboard/Mouse", "Tipkovnica/Miš"),
        ("LAN Discovery", "LAN otkrivanje"),
        ("Length", "Duljina"),
        ("Linked", "Povezano"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Povezivanje s upravljačkom pločom... Ovaj uređaj će se uskoro pojaviti na upravljačkoj ploči."),
        ("Loading...", "Učitavanje..."),
        ("Login screen using Wayland is not supported.", "Zaslon za prijavu pomoću Waylanda nije podržan."),
        ("Low", "Nizak"),
        ("My Tickets", "Moji zahtjevi"),
        ("New Ticket", "Novi zahtjev"),
        ("New reply received", "Primljen novi odgovor"),
        ("No", "Ne"),
        ("No messages", "Nema poruka"),
        ("No printers found on this computer.", "Na ovom računalu nisu pronađeni pisači."),
        ("No tickets found", "Nisu pronađeni zahtjevi"),
        ("OS Username", "Korisničko ime OS-a"),
        ("Open a file transfer session to send or receive files", "Otvorite sesiju prijenosa datoteka za slanje ili primanje datoteka"),
        ("Open support tickets", "Otvori zahtjeve za podršku"),
        ("Password Settings", "Postavke lozinke"),
        ("Password settings", "Postavke lozinke"),
        ("Permanent Password", "Trajna lozinka"),
        ("Priority", "Prioritet"),
        ("Privacy Mode", "Način privatnosti"),
        ("Privacy Policy", "Politika privatnosti"),
        ("Random Password", "Nasumična lozinka"),
        ("Remote Access", "Udaljeni pristup"),
        ("Remote Print", "Udaljeni ispis"),
        ("Remote Print Job", "Udaljeni zadatak ispisa"),
        ("Remote Printing", "Udaljeni ispis"),
        ("Remote Restart", "Udaljeno ponovno pokretanje"),
        ("Requirements:", "Zahtjevi:"),
        ("Restart remote device", "Ponovno pokreni udaljeni uređaj"),
        ("Same layout", "Isti raspored"),
        ("Save", "Spremi"),
        ("Screenshot", "Snimka zaslona"),
        ("Screenshot saved to clipboard", "Snimka zaslona spremljena u međuspremnik"),
        ("Select printer for remote print job", "Odaberite pisač za udaljeni zadatak ispisa"),
        ("Send a connection invitation to another device by entering its ID", "Pošaljite poziv za povezivanje drugom uređaju unosom njegovog ID-a"),
        ("Set", "Postavi"),
        ("Start a remote desktop session with the partner device", "Pokrenite sesiju udaljene radne površine s partnerskim uređajem"),
        ("Subject", "Predmet"),
        ("Subject is required", "Predmet je obavezan"),
        ("Submit Ticket", "Pošalji zahtjev"),
        ("Success", "Uspjeh"),
        ("Support", "Podrška"),
        ("Switch Display", "Promijeni zaslon"),
        ("Switch sides", "Zamijeni strane"),
        ("The network adapter must have WoL enabled in OS settings", "Mrežni adapter mora imati omogućen WoL u postavkama OS-a"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "Signal buđenja šalje drugi online HopToDesk uređaj na istoj lokalnoj mreži. Možete ga pokrenuti iz adresara u bilo kojem HopToDesk klijentu ili s upravljačke ploče ako je uređaj registriran."),
        ("This device is linked to a dashboard.", "Ovaj uređaj je povezan s upravljačkom pločom."),
        ("This device must be connected via Ethernet (not WiFi)", "Ovaj uređaj mora biti povezan putem Etherneta (ne WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Zahtjev uspješno poslan!"),
        ("Tickets", "Zahtjevi"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "Zahtjevi se mogu kreirati samo ako je ovaj uređaj povezan s korisnikom upravljačke ploče."),
        ("To change, enter a new invite code:", "Za promjenu unesite novi pozivni kôd:"),
        ("Tunnel", "Tunel"),
        ("Two-Factor Authentication", "Dvofaktorska autentifikacija"),
        ("Type your reply...", "Upišite svoj odgovor..."),
        ("Urgent", "Hitno"),
        ("View Security Code", "Prikaži sigurnosni kôd"),
        ("Waiting for RDP client", "Čekanje na RDP klijent"),
        ("Wake On LAN", "Wake On LAN"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "Wake On LAN vam omogućuje udaljeno uključivanje ovog uređaja iz drugog HopToDesk klijenta ili upravljačke ploče."),
        ("Yes", "Da"),
        ("You", "Vi"),
        ("You can find this code in your dashboard invite link.", "Ovaj kôd možete pronaći u pozivnoj poveznici upravljačke ploče."),
        ("You have a new reply on one of your tickets", "Imate novi odgovor na jedan od vaših zahtjeva"),
        ("Your email address", "Vaša adresa e-pošte"),
        ("Your unique device ID - share this with others so they can connect to you", "Vaš jedinstveni ID uređaja - podijelite ga s drugima kako bi se mogli povezati s vama"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "premašuje ograničenje od 5MB. Molimo odaberite manju datoteku."),
        ("via", "putem"),

        ("Device", "Uređaj"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "WoL mora biti omogućen u BIOS/UEFI postavkama uređaja"),
        ("Are you sure you want to delete", "Jeste li sigurni da želite izbrisati"),
        ("Please enter a local port number", "Unesite broj lokalnog porta"),
        ...
        ("Added to dashboard", "Dodano na nadzornu ploču"),
        ("Request declined", "Zahtjev odbijen"),
        ("Add remote device to my dashboard", "Dodaj udaljeni uređaj na moju nadzornu ploču"),
        ("Your IP", "Vaš IP"),
        ("Switch to ID", "Prebaci na ID"),
        ("Switch to local IP", "Prebaci na lokalnu IP"),
        ("No local IP available - showing ID", "Lokalna IP nije dostupna - prikazuje se ID"),
        ("Copy your local IP to clipboard", "Kopiraj lokalnu IP u međuspremnik"),
        ("Your local IP address - share this for direct LAN connections", "Vaša lokalna IP adresa - podijelite je za izravne LAN veze"),
        ("Accept Dashboard Invite?", "Prihvati pozivnicu za nadzornu ploču?"),
        ("Request sent, waiting for the remote user to confirm.", "Zahtjev poslan, čeka se potvrda udaljenog korisnika."),
        ("Requesting invite code...", "Zahtijevanje koda pozivnice..."),
        ("The invite code is invalid or expired. Please try again later.", "Kod pozivnice je nevažeći ili je istekao. Pokušajte ponovno kasnije."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Udaljeni korisnik je prihvatio, ali registracija nije uspjela. Možda je izvan mreže ili ne može doći do nadzorne ploče."),
        ("A previous request is still pending on the remote.", "Na udaljenom uređaju još uvijek čeka prethodni zahtjev."),
        ("No response from the remote, request timed out.", "Nema odgovora s udaljenog uređaja, isteklo je vrijeme zahtjeva."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ova udaljena platforma još nije podržana za registraciju na nadzornu ploču."),
        ("This device is already linked to your dashboard.", "Ovaj uređaj je već povezan s vašom nadzornom pločom."),
        ("Replace existing dashboard link?", "Zamijeniti postojeću vezu s nadzornom pločom?"),
        ("This computer is currently linked to {} dashboard.", "Ovo računalo je trenutno povezano s nadzornom pločom {}."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Ovo možete poništiti bilo kada u Postavke > Nadzorna ploča."),
            ("Recent sessions will show here.", "Nedavne sesije bit će prikazane ovdje."),
        ("No favorites yet.", "Još nema favorita."),
        ("No devices discovered.", "Nije otkriven nijedan uređaj."),
        ("Waiting for new connection ...", "Čekanje nove veze ..."),
        ("Not Ready", "Nije spremno"),
        ("ID / Relay Server", "ID / Posredni poslužitelj"),
        ("Generate New Temporary Password", "Generiraj novu privremenu lozinku"),
        ("Confirm Password", "Potvrdi lozinku"),
        ("Two-Factor Authentication Setup", "Postavljanje dvofaktorske autentifikacije"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Ovaj softver licenciran je pod licencom"),
        ("Source code is available", "Izvorni kôd dostupan je"),
        ("here", "ovdje"),
        ("Invite Code", "Pozivni kôd"),
        ("Length:", "Duljina:"),
        ("Link", "Poveži"),
        ("PERMANENT PASSWORD", "TRAJNA LOZINKA"),
        ("RANDOM PASSWORD", "SLUČAJNA LOZINKA"),
        ("Attachments:", "Privici:"),
        ("Best image quality", "Najbolja kvaliteta slike"),
        ("Connection Manager", "Upravitelj veza"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Trenutno povezano:"),
        ("Do not close this window while the tunnel is active", "Ne zatvarajte ovaj prozor dok je tunel aktivan"),
        ("Enter Password", "Unesite lozinku"),
        ("Enter a new invite code to re-link:", "Unesite novi pozivni kôd za ponovno povezivanje:"),
        ("Establishing connection to remote device", "Uspostavljanje veze s udaljenim uređajem"),
        ("File Already Exists", "Datoteka već postoji"),
        ("Input Blocked", "Unos blokiran"),
        ("Invalid code. Please try again.", "Nevažeći kôd. Pokušajte ponovno."),
        ("Keyboard", "Tipkovnica"),
        ("Lock Screen", "Zaključaj zaslon"),
        ("Message", "Poruka"),
        ("Please enter the password for the remote device.", "Molimo unesite lozinku udaljenog uređaja."),
        ("Record Session", "Snimi sesiju"),
        ("Type a message...", "Upišite poruku..."),
        ("View Style", "Stil prikaza"),
        ("Waiting...", "Čekanje..."),
        ...
        ("Ticket reopened", "Zahtjev je ponovno otvoren"),
        ("Your ticket will be sent to {}", "Vaš zahtjev bit će poslan {}"),
        ("your support team", "vašem timu za podršku"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Ovaj uređaj nije povezan s nadzornom pločom. Zahtjevi se ne mogu slati."),
        ("We'll use this address to send you updates about your ticket", "Ovu adresu koristit ćemo za ažuriranja vašeg zahtjeva"),
        ("You can also email {}", "Možete pisati i na {}"),
        ("You can also call {}", "Možete nazvati i {}"),
