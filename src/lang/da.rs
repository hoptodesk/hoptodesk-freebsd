...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "Du kan fortryde dette når som helst i Indstillinger > Dashboard."),
            ("Recent sessions will show here.", "Seneste sessioner vises her."),
        ("No favorites yet.", "Ingen favoritter endnu."),
        ("No devices discovered.", "Ingen enheder fundet."),
        ("Waiting for new connection ...", "Venter på ny forbindelse ..."),
        ("Not Ready", "Ikke klar"),
        ("ID / Relay Server", "ID / Relay Server"),
        ("Generate New Temporary Password", "Generér ny midlertidig adgangskode"),
        ("Confirm Password", "Bekræft adgangskode"),
        ("Two-Factor Authentication Setup", "Opsætning af tofaktorautentificering"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Denne software er licenseret under"),
        ("Source code is available", "Kildekoden er tilgængelig"),
        ("here", "her"),
        ...
        ("RANDOM PASSWORD", "TILFÆLDIG ADGANGSKODE"),
        ("Attachments:", "Vedhæftninger:"),
        ("Best image quality", "Bedste billedkvalitet"),
        ("Connection Manager", "Forbindelseshåndtering"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Aktuelt tilknyttet:"),
        ("Do not close this window while the tunnel is active", "Luk ikke dette vindue, mens tunnelen er aktiv"),
        ("Enter Password", "Indtast adgangskode"),
        ("Enter a new invite code to re-link:", "Indtast en ny invitationskode for at tilknytte igen:"),
        ("Establishing connection to remote device", "Opretter forbindelse til fjernenheden"),
        ("File Already Exists", "Filen findes allerede"),
        ("Input Blocked", "Input blokeret"),
        ("Invalid code. Please try again.", "Ugyldig kode. Prøv venligst igen."),
        ("Keyboard", "Tastatur"),
        ("Lock Screen", "Lås skærm"),
        ("Message", "Besked"),
        ("Please enter the password for the remote device.", "Indtast venligst adgangskoden til fjernenheden."),
        ("Record Session", "Optag session"),
        ("Type a message...", "Skriv en besked..."),
        ("View Style", "Visningsstil"),
        ("Waiting...", "Venter..."),
        ("Port Forwarding:", "Viderestilling af porte:"),
        ...
        ("Ticket reopened", "Sagen er genåbnet"),
        ("Your ticket will be sent to {}", "Din sag sendes til {}"),
        ("your support team", "dit supportteam"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Denne enhed er ikke forbundet til et dashboard. Sager kan ikke indsendes."),
        ("We'll use this address to send you updates about your ticket", "Vi bruger denne adresse til opdateringer om din sag"),
        ("You can also email {}", "Du kan også skrive til {}"),
        ("You can also call {}", "Du kan også ringe på {}"),
