...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "Saate selle igal ajal tagasi võtta Seaded > Armatuurlaud."),
            ("Recent sessions will show here.", "Viimased sessioonid kuvatakse siin."),
        ("No favorites yet.", "Lemmikuid pole veel."),
        ("No devices discovered.", "Ühtegi seadet ei leitud."),
        ("Waiting for new connection ...", "Uue ühenduse ootamine ..."),
        ("Not Ready", "Pole valmis"),
        ("ID / Relay Server", "ID / releeserver"),
        ("Generate New Temporary Password", "Genereeri uus ajutine parool"),
        ("Confirm Password", "Kinnita parool"),
        ("Two-Factor Authentication Setup", "Kaheastmelise autentimise seadistamine"),
        ("API URL", "API URL"),
        ("This software is licensed under", "See tarkvara on litsentsitud litsentsiga"),
        ("Source code is available", "Lähtekood on saadaval"),
        ("here", "siin"),
        ("Invite Code", "Kutsekood"),
        ("Length:", "Pikkus:"),
        ("Link", "Seo"),
        ("PERMANENT PASSWORD", "PÜSIPAROOL"),
        ("RANDOM PASSWORD", "JUHUSLIK PAROOL"),
        ("Attachments:", "Manused:"),
        ("Best image quality", "Parim pildikvaliteet"),
        ("Connection Manager", "Ühenduste haldur"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Praegu seotud:"),
        ("Do not close this window while the tunnel is active", "Ärge sulgege seda akent, kuni tunnel on aktiivne"),
        ("Enter Password", "Sisestage parool"),
        ("Enter a new invite code to re-link:", "Uuesti sidumiseks sisestage uus kutsekood:"),
        ("Establishing connection to remote device", "Ühenduse loomine kaugseadmega"),
        ("File Already Exists", "Fail on juba olemas"),
        ("Input Blocked", "Sisend blokeeritud"),
        ("Invalid code. Please try again.", "Vale kood. Palun proovige uuesti."),
        ("Keyboard", "Klaviatuur"),
        ("Lock Screen", "Lukusta ekraan"),
        ("Message", "Sõnum"),
        ("Please enter the password for the remote device.", "Palun sisestage kaugseadme parool."),
        ("Record Session", "Salvesta sessioon"),
        ("Type a message...", "Kirjutage sõnum..."),
        ("View Style", "Kuvastiil"),
        ("Waiting...", "Ootamine..."),
        ("Port Forwarding:", "Pordi suunamine:"),
        ...
        ("Ticket reopened", "Pilet avati uuesti"),
        ("Your ticket will be sent to {}", "Teie pilet saadetakse {}"),
        ("your support team", "teie kasutajatoele"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "See seade pole ühendatud ühegi töölauaga. Pileteid ei saa esitada."),
        ("We'll use this address to send you updates about your ticket", "Kasutame seda aadressi teie pileti uuenduste saatmiseks"),
        ("You can also email {}", "Võite kirjutada ka aadressile {}"),
        ("You can also call {}", "Võite helistada ka numbrile {}"),
