...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Будь ласка, введіть номер локального порту"),
        ("Please enter a remote port number", "Будь ласка, введіть номер віддаленого порту"),
        ("Please enter local and remote port numbers", "Будь ласка, введіть номери локального та віддаленого портів"),
        ("Copy", "Копіювати"),
        ("Proxy Settings", "Налаштування проксі"),
        ("Add to my Dashboard", "Додати до моєї панелі"),
        ...
        ("Added to dashboard", "Додано до панелі"),
        ("Request declined", "Запит відхилено"),
        ("Add remote device to my dashboard", "Додати віддалений пристрій до моєї панелі"),
        ("Your IP", "Ваша IP"),
        ("Switch to ID", "Перейти до ID"),
        ("Switch to local IP", "Перейти до локальної IP"),
        ("No local IP available - showing ID", "Локальна IP недоступна — показано ID"),
        ("Copy your local IP to clipboard", "Скопіювати локальну IP у буфер обміну"),
        ("Your local IP address - share this for direct LAN connections", "Ваша локальна IP-адреса — поділіться нею для прямих LAN-з'єднань"),
        ("Accept Dashboard Invite?", "Прийняти запрошення до панелі?"),
        ("Request sent, waiting for the remote user to confirm.", "Запит надіслано, очікується підтвердження віддаленого користувача."),
        ("Requesting invite code...", "Запит коду запрошення..."),
        ("The invite code is invalid or expired. Please try again later.", "Код запрошення недійсний або застарів. Спробуйте пізніше."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Віддалений користувач погодився, але реєстрація не вдалася. Можливо, він не в мережі або не може дістатися до панелі."),
        ("A previous request is still pending on the remote.", "На віддаленому пристрої досі очікується попередній запит."),
        ("No response from the remote, request timed out.", "Немає відповіді від віддаленого пристрою, час очікування минув."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ця віддалена платформа поки що не підтримується для реєстрації в панелі."),
        ("This device is already linked to your dashboard.", "Цей пристрій уже прив'язано до вашої панелі."),
        ("Replace existing dashboard link?", "Замінити наявне прив'язування панелі?"),
        ("This computer is currently linked to {} dashboard.", "Цей комп'ютер зараз прив'язаний до панелі {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} запрошує цей комп'ютер приєднатися до своєї панелі. Наявне прив'язування буде видалено."),
        ("{} is inviting this computer to join their dashboard.", "{} запрошує цей комп'ютер приєднатися до своєї панелі."),
        ("You can undo this any time in Settings > Dashboard.", "Ви можете скасувати це будь-коли в Налаштування > Панель."),
            ("Recent sessions will show here.", "Тут будуть показані нещодавні сеанси."),
        ("No favorites yet.", "У вибраному поки порожньо."),
        ("No devices discovered.", "Пристрої не знайдено."),
        ("Waiting for new connection ...", "Очікування нового підключення ..."),
        ("Not Ready", "Не готовий"),
        ("ID / Relay Server", "ID-сервер / сервер ретрансляції"),
        ("Generate New Temporary Password", "Згенерувати новий тимчасовий пароль"),
        ("Confirm Password", "Підтвердьте пароль"),
        ("Two-Factor Authentication Setup", "Налаштування двофакторної автентифікації"),
        ("API URL", "URL API"),
        ("This software is licensed under", "Це програмне забезпечення поширюється за ліцензією"),
        ("Source code is available", "Вихідний код доступний"),
        ("here", "тут"),
        ...
        ("RANDOM PASSWORD", "ВИПАДКОВИЙ ПАРОЛЬ"),
        ("Attachments:", "Вкладення:"),
        ("Best image quality", "Найкраща якість зображення"),
        ("Connection Manager", "Менеджер підключень"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Зараз прив'язано:"),
        ("Do not close this window while the tunnel is active", "Не закривайте це вікно, поки тунель активний"),
        ("Enter Password", "Введіть пароль"),
        ("Enter a new invite code to re-link:", "Введіть новий код запрошення для повторної прив'язки:"),
        ("Establishing connection to remote device", "Встановлення підключення до віддаленого пристрою"),
        ("File Already Exists", "Файл вже існує"),
        ("Input Blocked", "Введення заблоковано"),
        ("Invalid code. Please try again.", "Невірний код. Спробуйте ще раз."),
        ("Keyboard", "Клавіатура"),
        ("Lock Screen", "Заблокувати екран"),
        ("Message", "Повідомлення"),
        ("Please enter the password for the remote device.", "Введіть пароль віддаленого пристрою."),
        ("Record Session", "Записати сеанс"),
        ("Type a message...", "Введіть повідомлення..."),
        ("View Style", "Стиль перегляду"),
        ("Waiting...", "Очікування..."),
        ("Port Forwarding:", "Переадресація портів:"),
        ...
        ("Ticket reopened", "Заявку знову відкрито"),
        ("Your ticket will be sent to {}", "Вашу заявку буде надіслано {}"),
        ("your support team", "вашій службі підтримки"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Цей пристрій не підключено до панелі керування. Надсилання заявок неможливе."),
        ("We'll use this address to send you updates about your ticket", "Ми використовуватимемо цю адресу для оновлень щодо вашої заявки"),
        ("You can also email {}", "Ви також можете написати на {}"),
        ("You can also call {}", "Ви також можете зателефонувати за номером {}"),
