...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Conectando à rede do HopToDesk..."),
        ...
        ("Error", "Erro"),
        ("Connection lost", "Reiniciado pelo par"),
        ...
        ("Unable to connect to the remote partner.", "Não é possível conectar ao parceiro remoto."),
        ("Failed to connect to signal server", "Falha ao conectar ao servidor de rendezvous"),
        ...
        ("config_acc", "Para controlar seu computador remotamente, você precisa conceder ao HopToDesk permissões de \"Acessibilidade\"."),
        ("config_screen", "Para acessar seu computador remotamente, você precisa conceder ao HopToDesk permissões de \"Gravar a Tela\"/"),
        ...
        ("Disable Wayland", "Desligar Wayland"),
        ("Warning", "Aviso"),
        ...
        ("The remote partner has closed the session.", "Fechada manualmente pelo par."),
        ...
        ("android_input_permission_tip1", "Para que um dispositivo remoto controle seu dispositivo Android via mouse ou toque, você precisa permitir que o HopToDesk use o serviço \"Acessibilidade\"."),
        ("android_input_permission_tip2", "Por favor vá para a próxima página de configuração do sistema, encontre e entre [Serviços Instalados], HABILITE o serviço [HopToDesk Input]."),
        ...
        ("Failed", "Falhou"),
        ("Succeeded", "Sucesso"),
        ("Someone turned on privacy mode, exiting.", "Alguém ativou o modo de privacidade, por favor desconecte"),
        ("Unsupported", "Não suportado"),
        ("Peer denied", "Parceiro negou"),
        ("Please install plugins", "Por favor instale plugins"),
        ("The peer has exited from Privacy Mode.", "Parceiro saiu"),
        ("Failed to turn off", "Falha ao desligar"),
        ("Turned off", "Desligado"),
        ("Language", "Linguagem"),
        ("Keep HopToDesk background service", "Manter o serviço do HopToDesk executando em segundo plano"),
        ...
        ("Please wait for confirmation of UAC...", "Por favor aguarde pela confirmação do UAC"),
        ...
        ("Start Screen Share", "Iniciar Compartilhamento de Tela"),
        ("Stop Screen Share", "Parar Compartilhamento de Tela"),
        ...
        ("Show HopToDesk", "Exibir HopToDesk"),
        ...
        ("config_input", "Para controlar a área de trabalho remota com teclado, você precisa conceder a permissão \"Monitoramento de entrada\" do HopToDesk."),
        ("config_microphone", "Para falar remotamente, você precisa conceder a permissão \"Gravar áudio\" do HopToDesk."),
        ...
        ("still_click_uac_tip", "Ainda requer que o usuário remoto clique em OK na janela UAC da execução do HopToDesk."),
        ("Request Elevation", "Pedir Elevação"),
        ("wait_accept_uac_tip", "Aguarde até que o usuário remoto aceite a caixa de diálogo do UAC."),
        ("Elevated successfully.", "Elevado com sucesso"),
        ("uppercase", "maiúsculo"),
        ("lowercase", "minúsculo"),
        ("digit", "dígito"),
        ...
        ("verify_hoptodesk_password_tip", "Verifique a senha do HopToDesk"),
        ...
        ("selinux_tip", "O SELinux está ativado em seu dispositivo, o que pode impedir que o HopToDesk funcione corretamente como dispositivo controlado."),
        ...
        ("screenshot-action-tip", "Ação da captura de tela"),
        ("Save as", "Salvar como"),
        ("Copy to clipboard", "Copiar para a área de transferência"),
        ("Enable remote printer", "Ativar impressora remota"),
        ("Downloading {}", "Baixando {}"),
        ("{} Update", "Atualização de {}"),
        ("{}-to-update-tip", "Atualize para a versão {}"),
        ("Auto update", "Atualização automática"),
        ("websocket_tip", "Usar WebSocket para atravessar NAT e firewalls"),
        ...
        ("allow-insecure-tls-fallback-tip", "Por padrão, o HopToDesk verifica o certificado do servidor para protocolos que usam TLS.\nCom esta opção habilitada, o HopToDesk ignorará a verificação e prosseguirá em caso de falha."),
        ("Disable UDP", "Desabilitar UDP"),
        ("disable-udp-tip", "Controla se deve usar somente TCP.\nCom esta opção habilitada, o HopToDesk não usará mais UDP 21116, TCP 21116 será usado no lugar."),
        ...
        ("Use HopToDesk Network", "Use a Rede HopToDesk"),
        ...
        ("An update is available, do you want to update to the new version?", "Uma atualização está disponível, você deseja atualizar para a nova versão?"),
        ("Invite", "Convidar"),
        ...
        ("Accept invite to connect to this computer?", "Aceitar convite para conectar a este computador?"),
        ("Incoming Connections Off.", "Conexões de entrada desativadas"),
        ("Allow Incoming Connections", "Permitir Conexões de Entrada"),
        ("Enable Incoming Connections", "Habilitar conexões de entrada"),
        ("Chat sessions will show here.", "As sessões de chat serão exibidas aqui."),
        ("Connect to a device to start chatting.", "Conecte-se a um dispositivo para começar a conversar."),
        ("No chats yet", "Ainda não há chats"),
        ("ios_screen_share_tip", "Toque em [Iniciar Compartilhamento de Tela] para começar a transmitir sua tela. Seu ID de dispositivo e senha aparecerão assim que a transmissão começar."),
        ...
        ("Enable unattended access to this device", "Habilitar acesso não supervisionado a este dispositivo"),
        ("Custom network settings URL", "URL de configurações de rede personalizadas"),
        ("Update Available", ""),
        ("Don't show this again.", ""),
        ("WOL", ""),
        ("Your ID", "Sua identificação"),
        ("Partner ID", "ID do Parceiro"),
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "Defina uma senha permanente para permitir o acesso a este dispositivo a qualquer momento, mesmo quando ninguém estiver presente."),
        ("View camera", "Ver câmera"),
        ("16-character invite code", "Código de convite de 16 caracteres"),
        ("Add File", "Adicionar arquivo"),
        ("Always use this printer", "Sempre usar esta impressora"),
        ...
        ("Are you sure you want to switch sides", "Tem certeza de que deseja trocar os lados"),
        ("Attachment", "Anexo"),
        ("Attachments", "Anexos"),
        ("Brief description of the issue", "Breve descrição do problema"),
        ("Can not invite yourself.", "Não é possível convidar a si mesmo."),
        ("Change Display", "Alterar tela"),
        ("Change password settings", "Alterar configurações de senha"),
        ("Click to load tickets", "Clique para carregar os chamados"),
        ("Clipboard", "Área de transferência"),
        ("Confirm", "Confirmar"),
        ("Connected to", "Conectado a"),
        ("Connection failed", "Falha na conexão"),
        ("Copy your device ID to clipboard so others can connect to you", "Copie o ID do seu dispositivo para a área de transferência para que outros possam se conectar a você"),
        ("Current Wayland display server is not supported.", "O servidor de exibição Wayland atual não é suportado."),
        ("Dashboard", "Painel"),
        ("Describe your issue in detail", "Descreva seu problema em detalhes"),
        ("Description", "Descrição"),
        ("Description is required", "A descrição é obrigatória"),
        ("Different layout", "Layout diferente"),
        ("Edit", "Editar"),
        ("Email", "E-mail"),
        ("Enable Permissions", "Habilitar permissões"),
        ("Enable recording session", "Habilitar gravação de sessão"),
        ("Enable remote restart", "Habilitar reinício remoto"),
        ("Enter Invite Code", "Inserir código de convite"),
        ("Enter your invite code to link this device to a dashboard.", "Insira seu código de convite para vincular este dispositivo a um painel."),
        ("Failed to load conversation", "Falha ao carregar conversa"),
        ("Failed to load tickets", "Falha ao carregar chamados"),
        ("Failed to submit ticket", "Falha ao enviar chamado"),
        ...
        ("Keyboard/Mouse", "Teclado/Mouse"),
        ("LAN Discovery", "Descoberta de LAN"),
        ("Length", "Comprimento"),
        ("Linked", "Vinculado"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Vinculando ao painel... Este dispositivo aparecerá no painel em breve."),
        ("Loading...", "Carregando..."),
        ("Login screen using Wayland is not supported.", "A tela de login usando Wayland não é suportada."),
        ("Low", "Baixa"),
        ...
        ("OS Username", "Nome de usuário do SO"),
        ("Open a file transfer session to send or receive files", "Abra uma sessão de transferência de arquivos para enviar ou receber arquivos"),
        ("Open support tickets", "Abrir chamados de suporte"),
        ("Password Settings", "Configurações de senha"),
        ("Password settings", "Configurações de senha"),
        ("Permanent Password", "Senha permanente"),
        ("Priority", "Prioridade"),
        ...
        ("Restart remote device", "Reiniciar dispositivo remoto"),
        ("Same layout", "Mesmo layout"),
        ("Save", "Salvar"),
        ("Screenshot", "Captura de tela"),
        ("Screenshot saved to clipboard", "Captura de tela salva na área de transferência"),
        ("Select printer for remote print job", "Selecionar impressora para trabalho de impressão remota"),
        ("Send a connection invitation to another device by entering its ID", "Envie um convite de conexão para outro dispositivo inserindo seu ID"),
        ("Set", "Definir"),
        ("Start a remote desktop session with the partner device", "Iniciar uma sessão de área de trabalho remota com o dispositivo parceiro"),
        ("Subject", "Assunto"),
        ("Subject is required", "O assunto é obrigatório"),
        ("Submit Ticket", "Enviar chamado"),
        ("Success", "Sucesso"),
        ("Support", "Suporte"),
        ("Switch Display", "Alternar tela"),
        ("Switch sides", "Trocar lados"),
        ("The network adapter must have WoL enabled in OS settings", "O adaptador de rede deve ter WoL habilitado nas configurações do SO"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "O sinal de ativação é enviado por outro dispositivo HopToDesk online na mesma rede local. Você pode acioná-lo a partir da agenda em qualquer cliente HopToDesk ou pelo painel, se registrado."),
        ("This device is linked to a dashboard.", "Este dispositivo está vinculado a um painel."),
        ("This device must be connected via Ethernet (not WiFi)", "Este dispositivo deve estar conectado via Ethernet (não WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Chamado enviado com sucesso!"),
        ("Tickets", "Chamados"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "Chamados só podem ser criados se este dispositivo estiver vinculado a um usuário do painel."),
        ("To change, enter a new invite code:", "Para alterar, insira um novo código de convite:"),
        ("Tunnel", "Túnel"),
        ("Two-Factor Authentication", "Autenticação de dois fatores"),
        ("Type your reply...", "Digite sua resposta..."),
        ("Urgent", "Urgente"),
        ("View Security Code", "Ver código de segurança"),
        ("Waiting for RDP client", "Aguardando cliente RDP"),
        ...
        ("Yes", "Sim"),
        ("You", "Você"),
        ("You can find this code in your dashboard invite link.", "Você pode encontrar este código no link de convite do seu painel."),
        ("You have a new reply on one of your tickets", "Você tem uma nova resposta em um dos seus chamados"),
        ("Your email address", "Seu endereço de e-mail"),
        ("Your unique device ID - share this with others so they can connect to you", "Seu ID de dispositivo exclusivo - compartilhe com outros para que possam se conectar a você"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "excede o limite de 5MB. Por favor, escolha um arquivo menor."),
        ("via", "via"),
        ...
        ("Add to my Dashboard", "Adicionar ao meu Painel"),
        ...
        ("Add remote device to my dashboard", "Adicionar dispositivo remoto ao meu painel"),
        ("Your IP", "Seu IP"),
        ("Switch to ID", "Alternar para ID"),
        ("Switch to local IP", "Alternar para IP local"),
        ("No local IP available - showing ID", "Sem IP local disponível - mostrando ID"),
        ("Copy your local IP to clipboard", "Copiar seu IP local para a área de transferência"),
        ("Your local IP address - share this for direct LAN connections", "Seu endereço IP local - compartilhe-o para conexões LAN diretas"),
        ("Accept Dashboard Invite?", "Aceitar convite do Painel?"),
        ("Request sent, waiting for the remote user to confirm.", "Solicitação enviada, aguardando confirmação do usuário remoto."),
        ("Requesting invite code...", "Solicitando código de convite..."),
        ("The invite code is invalid or expired. Please try again later.", "O código de convite é inválido ou expirou. Tente novamente mais tarde."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "O usuário remoto aceitou mas o registro falhou. Ele pode estar offline ou sem acesso ao painel."),
        ("A previous request is still pending on the remote.", "Uma solicitação anterior ainda está pendente no dispositivo remoto."),
        ("No response from the remote, request timed out.", "Sem resposta do dispositivo remoto, a solicitação expirou."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Esta plataforma remota ainda não é compatível com o registro no painel."),
        ("This device is already linked to your dashboard.", "Este dispositivo já está vinculado ao seu painel."),
        ("Replace existing dashboard link?", "Substituir o vínculo existente do painel?"),
        ("This computer is currently linked to {} dashboard.", "Este computador está atualmente vinculado ao painel de {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} está convidando este computador a entrar no painel dele. O vínculo existente será removido."),
        ("{} is inviting this computer to join their dashboard.", "{} está convidando este computador a entrar no painel dele."),
        ("You can undo this any time in Settings > Dashboard.", "Você pode desfazer isso a qualquer momento em Configurações > Painel."),
            ("Recent sessions will show here.", "As sessões recentes aparecerão aqui."),
        ("No favorites yet.", "Nenhum favorito ainda."),
        ("No devices discovered.", "Nenhum dispositivo descoberto."),
        ("Waiting for new connection ...", "Aguardando nova conexão ..."),
        ("Not Ready", "Não está pronto"),
        ("ID / Relay Server", "Servidor de ID / Relay"),
        ("Generate New Temporary Password", "Gerar nova senha temporária"),
        ("Confirm Password", "Confirmar senha"),
        ("Two-Factor Authentication Setup", "Configuração da autenticação de dois fatores"),
        ("API URL", "URL da API"),
        ("This software is licensed under", "Este software está licenciado sob"),
        ("Source code is available", "O código-fonte está disponível"),
        ("here", "aqui"),
        ...
        ("RANDOM PASSWORD", "SENHA ALEATÓRIA"),
        ("Attachments:", "Anexos:"),
        ("Best image quality", "Melhor qualidade de imagem"),
        ("Connection Manager", "Gerenciador de conexões"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Atualmente vinculado:"),
        ("Do not close this window while the tunnel is active", "Não feche esta janela enquanto o túnel estiver ativo"),
        ("Enter Password", "Informe a senha"),
        ("Enter a new invite code to re-link:", "Informe um novo código de convite para vincular novamente:"),
        ("Establishing connection to remote device", "Estabelecendo conexão com o dispositivo remoto"),
        ("File Already Exists", "O arquivo já existe"),
        ("Input Blocked", "Entrada bloqueada"),
        ("Invalid code. Please try again.", "Código inválido. Tente novamente."),
        ("Keyboard", "Teclado"),
        ("Lock Screen", "Bloquear tela"),
        ("Message", "Mensagem"),
        ("Please enter the password for the remote device.", "Informe a senha do dispositivo remoto."),
        ...
        ("Your ticket will be sent to {}", "Seu ticket será enviado para {}"),
        ("your support team", "sua equipe de suporte"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Este dispositivo não está conectado a um painel. Não é possível enviar tickets."),
        ("We'll use this address to send you updates about your ticket", "Usaremos este endereço para atualizações sobre seu ticket"),
        ("You can also email {}", "Você também pode escrever para {}"),
        ("You can also call {}", "Você também pode ligar para {}"),
