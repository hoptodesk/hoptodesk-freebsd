...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Masukkan nomor port lokal"),
        ("Please enter a remote port number", "Masukkan nomor port jarak jauh"),
        ("Please enter local and remote port numbers", "Masukkan nomor port lokal dan jarak jauh"),
        ("Copy", "Salin"),
        ("Proxy Settings", "Pengaturan Proxy"),
        ("Add to my Dashboard", "Tambahkan ke Dashboard saya"),
        ...
        ("Added to dashboard", "Ditambahkan ke dashboard"),
        ("Request declined", "Permintaan ditolak"),
        ("Add remote device to my dashboard", "Tambahkan perangkat jarak jauh ke dashboard saya"),
        ("Your IP", "IP Anda"),
        ("Switch to ID", "Beralih ke ID"),
        ("Switch to local IP", "Beralih ke IP lokal"),
        ("No local IP available - showing ID", "Tidak ada IP lokal tersedia - menampilkan ID"),
        ("Copy your local IP to clipboard", "Salin IP lokal ke clipboard"),
        ("Your local IP address - share this for direct LAN connections", "Alamat IP lokal Anda - bagikan untuk koneksi LAN langsung"),
        ("Accept Dashboard Invite?", "Terima undangan Dashboard?"),
        ("Request sent, waiting for the remote user to confirm.", "Permintaan dikirim, menunggu konfirmasi pengguna jarak jauh."),
        ("Requesting invite code...", "Meminta kode undangan..."),
        ("The invite code is invalid or expired. Please try again later.", "Kode undangan tidak valid atau kedaluwarsa. Silakan coba lagi nanti."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Pengguna jarak jauh menerima tetapi pendaftaran gagal. Mereka mungkin offline atau tidak dapat mengakses dashboard."),
        ("A previous request is still pending on the remote.", "Permintaan sebelumnya masih tertunda di perangkat jarak jauh."),
        ("No response from the remote, request timed out.", "Tidak ada respons dari perangkat jarak jauh, permintaan kedaluwarsa."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Platform jarak jauh ini belum didukung untuk pendaftaran dashboard."),
        ("This device is already linked to your dashboard.", "Perangkat ini sudah tertaut ke dashboard Anda."),
        ("Replace existing dashboard link?", "Ganti tautan dashboard yang ada?"),
        ("This computer is currently linked to {} dashboard.", "Komputer ini saat ini tertaut ke dashboard {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} mengundang komputer ini untuk bergabung dengan dashboardnya. Tautan yang ada akan dihapus."),
        ("{} is inviting this computer to join their dashboard.", "{} mengundang komputer ini untuk bergabung dengan dashboardnya."),
        ("You can undo this any time in Settings > Dashboard.", "Anda dapat membatalkan ini kapan saja di Pengaturan > Dashboard."),
            ("Recent sessions will show here.", "Sesi terkini akan ditampilkan di sini."),
        ("No favorites yet.", "Belum ada favorit."),
        ("No devices discovered.", "Tidak ada perangkat yang ditemukan."),
        ("Waiting for new connection ...", "Menunggu koneksi baru ..."),
        ("Not Ready", "Belum Siap"),
        ("ID / Relay Server", "ID / Relay Server"),
        ("Generate New Temporary Password", "Buat Kata Sandi Sementara Baru"),
        ("Confirm Password", "Konfirmasi Kata Sandi"),
        ("Two-Factor Authentication Setup", "Penyiapan Autentikasi Dua Faktor"),
        ("API URL", "URL API"),
        ("This software is licensed under", "Perangkat lunak ini dilisensikan di bawah"),
        ("Source code is available", "Kode sumber tersedia"),
        ("here", "di sini"),
        ...
        ("RANDOM PASSWORD", "KATA SANDI ACAK"),
        ("Attachments:", "Lampiran:"),
        ("Best image quality", "Kualitas gambar terbaik"),
        ("Connection Manager", "Manajer Koneksi"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Saat ini terhubung:"),
        ("Do not close this window while the tunnel is active", "Jangan tutup jendela ini saat tunnel masih aktif"),
        ("Enter Password", "Masukkan Kata Sandi"),
        ("Enter a new invite code to re-link:", "Masukkan kode undangan baru untuk menghubungkan ulang:"),
        ("Establishing connection to remote device", "Membangun koneksi ke perangkat jarak jauh"),
        ("File Already Exists", "File Sudah Ada"),
        ("Input Blocked", "Input Diblokir"),
        ("Invalid code. Please try again.", "Kode tidak valid. Silahkan coba lagi."),
        ("Keyboard", "Papan Ketik"),
        ("Lock Screen", "Kunci Layar"),
        ("Message", "Pesan"),
        ("Please enter the password for the remote device.", "Silahkan masukkan kata sandi perangkat jarak jauh."),
        ("Record Session", "Rekam Sesi"),
        ("Type a message...", "Ketik pesan..."),
        ("View Style", "Gaya Tampilan"),
        ("Waiting...", "Menunggu..."),
        ...
        ("Your ticket will be sent to {}", "Tiket Anda akan dikirim ke {}"),
        ("your support team", "tim dukungan Anda"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Perangkat ini tidak terhubung ke dasbor. Tiket tidak dapat dikirim."),
        ("We'll use this address to send you updates about your ticket", "Kami akan menggunakan alamat ini untuk pembaruan tiket Anda"),
        ("You can also email {}", "Anda juga dapat mengirim email ke {}"),
        ("You can also call {}", "Anda juga dapat menelepon {}"),
