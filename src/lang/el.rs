...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Εισαγάγετε έναν αριθμό τοπικής θύρας"),
        ...
        ("Copy", "Αντιγραφή"),
        ("Proxy Settings", "Ρυθμίσεις Proxy"),
        ...
        ("Added to dashboard", "Προστέθηκε στον πίνακα"),
        ("Request declined", "Το αίτημα απορρίφθηκε"),
        ("Add remote device to my dashboard", "Προσθήκη απομακρυσμένης συσκευής στον πίνακά μου"),
        ("Your IP", "Η IP σας"),
        ("Switch to ID", "Μετάβαση σε ID"),
        ("Switch to local IP", "Μετάβαση σε τοπική IP"),
        ("No local IP available - showing ID", "Δεν υπάρχει διαθέσιμη τοπική IP - εμφάνιση ID"),
        ("Copy your local IP to clipboard", "Αντιγραφή τοπικής IP στο πρόχειρο"),
        ("Your local IP address - share this for direct LAN connections", "Η τοπική σας διεύθυνση IP - μοιραστείτε την για άμεσες συνδέσεις LAN"),
        ("Accept Dashboard Invite?", "Αποδοχή πρόσκλησης πίνακα;"),
        ("Request sent, waiting for the remote user to confirm.", "Το αίτημα στάλθηκε, αναμονή για επιβεβαίωση από τον απομακρυσμένο χρήστη."),
        ("Requesting invite code...", "Αίτηση κωδικού πρόσκλησης..."),
        ("The invite code is invalid or expired. Please try again later.", "Ο κωδικός πρόσκλησης είναι μη έγκυρος ή έχει λήξει. Παρακαλώ δοκιμάστε ξανά αργότερα."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Ο απομακρυσμένος χρήστης αποδέχτηκε αλλά η εγγραφή απέτυχε. Μπορεί να είναι εκτός σύνδεσης ή να μην μπορεί να φτάσει στον πίνακα."),
        ("A previous request is still pending on the remote.", "Στην απομακρυσμένη συσκευή εκκρεμεί ακόμα προηγούμενο αίτημα."),
        ("No response from the remote, request timed out.", "Δεν υπάρχει απάντηση από την απομακρυσμένη συσκευή, λήξη χρόνου αιτήματος."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Αυτή η απομακρυσμένη πλατφόρμα δεν υποστηρίζεται ακόμα για εγγραφή στον πίνακα."),
        ("This device is already linked to your dashboard.", "Αυτή η συσκευή είναι ήδη συνδεδεμένη με τον πίνακά σας."),
        ("Replace existing dashboard link?", "Αντικατάσταση υπάρχουσας σύνδεσης πίνακα;"),
        ("This computer is currently linked to {} dashboard.", "Αυτός ο υπολογιστής είναι αυτή τη στιγμή συνδεδεμένος με τον πίνακα του {}."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Μπορείτε να το αναιρέσετε ανά πάσα στιγμή στις Ρυθμίσεις > Πίνακας."),
            ("Recent sessions will show here.", "Οι πρόσφατες συνεδρίες θα εμφανίζονται εδώ."),
        ("No favorites yet.", "Δεν υπάρχουν αγαπημένα ακόμη."),
        ("No devices discovered.", "Δεν εντοπίστηκαν συσκευές."),
        ("Waiting for new connection ...", "Αναμονή για νέα σύνδεση ..."),
        ("Not Ready", "Μη έτοιμο"),
        ("ID / Relay Server", "ID / Διακομιστής αναμετάδοσης"),
        ("Generate New Temporary Password", "Δημιουργία νέου προσωρινού κωδικού πρόσβασης"),
        ("Confirm Password", "Επιβεβαίωση κωδικού πρόσβασης"),
        ("Two-Factor Authentication Setup", "Ρύθμιση ελέγχου ταυτότητας δύο παραγόντων"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Αυτό το λογισμικό διατίθεται υπό την άδεια"),
        ("Source code is available", "Ο πηγαίος κώδικας είναι διαθέσιμος"),
        ("here", "εδώ"),
        ("Invite Code", "Κωδικός πρόσκλησης"),
        ("Length:", "Μήκος:"),
        ("Link", "Σύνδεση"),
        ("PERMANENT PASSWORD", "ΜΟΝΙΜΟΣ ΚΩΔΙΚΟΣ ΠΡΟΣΒΑΣΗΣ"),
        ("RANDOM PASSWORD", "ΤΥΧΑΙΟΣ ΚΩΔΙΚΟΣ ΠΡΟΣΒΑΣΗΣ"),
        ("Attachments:", "Συνημμένα:"),
        ("Best image quality", "Βέλτιστη ποιότητα εικόνας"),
        ("Connection Manager", "Διαχείριση συνδέσεων"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Συνδεδεμένο αυτήν τη στιγμή:"),
        ("Do not close this window while the tunnel is active", "Μην κλείνετε αυτό το παράθυρο όσο το τούνελ είναι ενεργό"),
        ("Enter Password", "Εισαγωγή κωδικού πρόσβασης"),
        ("Enter a new invite code to re-link:", "Εισαγάγετε νέο κωδικό πρόσκλησης για επανασύνδεση:"),
        ("Establishing connection to remote device", "Δημιουργία σύνδεσης με την απομακρυσμένη συσκευή"),
        ("File Already Exists", "Το αρχείο υπάρχει ήδη"),
        ("Input Blocked", "Αποκλεισμός εισόδου"),
        ("Invalid code. Please try again.", "Μη έγκυρος κωδικός. Δοκιμάστε ξανά."),
        ("Keyboard", "Πληκτρολόγιο"),
        ("Lock Screen", "Κλείδωμα οθόνης"),
        ("Message", "Μήνυμα"),
        ("Please enter the password for the remote device.", "Παρακαλώ εισαγάγετε τον κωδικό πρόσβασης της απομακρυσμένης συσκευής."),
        ("Record Session", "Εγγραφή συνεδρίας"),
        ("Type a message...", "Πληκτρολογήστε ένα μήνυμα..."),
        ("View Style", "Τρόπος εμφάνισης"),
        ("Waiting...", "Αναμονή..."),
        ("Port Forwarding:", "Προώθηση θύρας:"),
        ...
        ("Ticket reopened", "Το αίτημα άνοιξε ξανά"),
        ("Your ticket will be sent to {}", "Το αίτημά σας θα σταλεί στο {}"),
        ("your support team", "την ομάδα υποστήριξής σας"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Αυτή η συσκευή δεν είναι συνδεδεμένη με πίνακα. Δεν είναι δυνατή η υποβολή αιτημάτων."),
        ("We'll use this address to send you updates about your ticket", "Θα χρησιμοποιήσουμε αυτή τη διεύθυνση για ενημερώσεις σχετικά με το αίτημά σας"),
        ("You can also email {}", "Μπορείτε επίσης να στείλετε email στο {}"),
        ("You can also call {}", "Μπορείτε επίσης να καλέσετε το {}"),
