...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Yhdistetään HopToDesk verkkoon..."),
        ("connecting_status_short", "Yhdistetään..."),
        ...
        ("not_ready_status_short", "Ei valmis."),
        ...
        ("Error", "Virhe"),
        ("Connection lost", "Yhteys katkaistu vastapuolen toimesta"),
        ...
        ("install_tip", "Parhaan suorituskyvyn saavuttamiseksi suorita täysi asennus."),
        ("Click to upgrade", "Päivitä napsauttamalla"),
        ("Click to download", ""),
        ("Click to update", ""),
        ("Configure", "Määritä"),
        ("config_acc", "Etätyöpöydän hallintaa varten sinun on annettava HopToDeskille ”Esteettömyys”-oikeudet."),
        ("config_screen", "Etätyöpöydän käyttöä varten sinun on annettava HopToDeskille ”Näytön tallennus” oikeudet."),
        ...
        ("The remote partner has closed the session.", "Suljettu vastapuolen toimesta"),
        ...
        ("File Connection", "Tiedostoyhteys"),
        ("Screen Connection", "Näyttöyhteys"),
        ...
        ("android_input_permission_tip1", "Siirry Androidin asetuksiin ja ota HopToDeskille käyttöön 'Syötteen ohjaus' oikeus."),
        ("android_input_permission_tip2", "Jos et löydä asetusta, etsi 'Esteettömyys' ja salli HopToDesk ohjelman käyttö."),
        ("android_new_connection_tip", "Uusi yhteyspyyntö vastaanotettu."),
        ("android_service_will_start_tip", "HopToDesk palvelu käynnistyy taustalla."),
        ("android_stop_service_tip", "Pysäytä taustapalvelu tarvittaessa HopToDeskin asetuksista."),
        ("android_version_audio_tip", "Äänensiirto vaatii Android 10:n tai uudemman."),
        ("android_start_service_tip", "HopToDesk palvelu käynnistetään..."),
        ...
        ("Language", "Kieli"),
        ("Keep HopToDesk background service", "Pidä HopToDeskin taustapalvelu käynnissä"),
        ("Ignore Battery Optimizations", "Ohita akun optimoinnit"),
        ("android_open_battery_optimizations_tip", "Poista HopToDeskin akkuoptimointi, jotta yhteys pysyy vakaana taustalla."),
        ...
        ("Show HopToDesk", "Näytä HopToDesk"),
        ...
        ("Elevated successfully.", "Oikeuksien korotus onnistui"),
        ...
        ("verify_hoptodesk_password_tip", "Vahvista HopToDesk salasanasi kirjautumista varten"),
        ...
        ("Privacy Mode started.", "Siirry yksityisyystilaan"),
        ("Privacy Mode turned off.", "Poistu yksityisyystilasta"),
        ...
        ("enable-2fa-desc-verify", "Syötä todennussovelluksesi luoma 6-numeroinen koodi:"),
        ...
        ("enter-2fa-setup", "Kaksivaiheisen todennuksen asennus"),
        ("cancel-bot-confirm-tip", "Haluatko varmasti poistaa Telegram-botin käytöstä?"),
        ("About HopToDesk", "Tietoa HopToDeskistä"),
        ...
        ("Enable Wake On LAN", "Ota Wake-on-LAN käyttöön"),
        ("Enable 2FA", "Ota kaksivaiheinen tunnistautuminen käyttöön"),
        ("You will need to confirm the 2FA on the secondary device with you when trying to connect to this desktop.", "Sinun on vahvistettava kaksivaiheinen tunnistautuminen toisella laitteella, kun yrität yhdistää tähän tietokoneeseen."),
        ("Choose Network", "Valitse verkko"),
        ("Enter your custom network settings URL:", "Syötä mukautettujen verkkoasetusten URL-osoite:"),
        ("HopToDesk Network (Default)", "HopToDesk-verkko (oletus)"),
        ("Use HopToDesk Network", ""),
        ("Custom Network URL", ""),
        ("Custom Network Settings", "Mukautetut verkkoasetukset"),
        ("Custom Network Error", "Mukautetun verkon virhe"),
        ("The custom network URL provided was not valid, please try again.", "Annettu mukautetun verkon URL-osoite ei ole kelvollinen, yritä uudelleen."),
        ("Your Security Code", "Turvakoodisi"),
        ("Security Code", ""),
        ("Full Screen", ""),
        ("ID (Click to Copy)", "Tunnus (napsauta kopioidaksesi)"),
        ("Password (Click to Copy)", "Salasana (napsauta kopioidaksesi)"),
        ("Unattended Access", "Valvomaton käyttö"),
        ("An update is available, do you want to update to the new version?", "Päivitys on saatavilla, haluatko päivittää uuteen versioon?"),
        ("Invite", "Kutsu"),
        ("Invite A Device", "Kutsu laite"),
        ("Input an ID to send a connection invitation for this device:", "Syötä tunnus lähettääksesi yhteyskutsun tälle laitteelle:"),
        ("Please enter a valid device ID.", "Syötä kelvollinen laitetunnus."),
        ("Device ID must contain only numbers (0-9).", "Laitetunnus saa sisältää vain numeroita (0–9)."),
        ("Peer ID", "Vertaisen tunnus"),
        ("Device ID to invite", "Kutsuttavan laitteen tunnus"),
        ("Accept invite to connect to this computer?", "Hyväksytäänkö kutsu yhdistää tähän tietokoneeseen?"),
        ...
        ("No chats yet", ""),
        ("ios_screen_share_tip", "Napauta [Aloita näytön jakaminen] aloittaaksesi näytön lähetyksen. Laitteesi tunniste ja salasana näkyvät lähetyksen alkaessa."),
        ("This Device", ""),
        ("Remote Control", ""),
        ("Copy ID", ""),
        ("Menu", ""),
        ...
        ("View camera", "Näytä kamera"),
        ("16-character invite code", "16 merkin kutsukoodi"),
        ("Add File", "Lisää tiedosto"),
        ("Always use this printer", "Käytä aina tätä tulostinta"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "Toisen HopToDesk-laitteen samassa verkossa on oltava online välittääkseen herätyssignaalin"),
        ("Appearance", "Ulkoasu"),
        ("Are you sure you want to switch sides", "Haluatko varmasti vaihtaa puolta"),
        ("Attachment", "Liite"),
        ("Attachments", "Liitteet"),
        ("Brief description of the issue", "Lyhyt kuvaus ongelmasta"),
        ("Can not invite yourself.", "Et voi kutsua itseäsi."),
        ("Change Display", "Vaihda näyttö"),
        ("Change password settings", "Muuta salasana-asetuksia"),
        ("Click to load tickets", "Napsauta ladataksesi tiketit"),
        ("Clipboard", "Leikepöytä"),
        ("Confirm", "Vahvista"),
        ("Connected to", "Yhdistetty kohteeseen"),
        ("Connection failed", "Yhteys epäonnistui"),
        ("Copy your device ID to clipboard so others can connect to you", "Kopioi laitetunnuksesi leikepöydälle, jotta muut voivat yhdistää sinuun"),
        ("Current Wayland display server is not supported.", "Nykyistä Wayland-näyttöpalvelinta ei tueta."),
        ("Dashboard", "Hallintapaneeli"),
        ("Describe your issue in detail", "Kuvaile ongelmasi yksityiskohtaisesti"),
        ("Description", "Kuvaus"),
        ("Description is required", "Kuvaus on pakollinen"),
        ("Different layout", "Eri asettelu"),
        ("Edit", "Muokkaa"),
        ("Email", "Sähköposti"),
        ("Enable Permissions", "Ota käyttöoikeudet käyttöön"),
        ("Enable recording session", "Ota istunnon tallennus käyttöön"),
        ("Enable remote restart", "Ota etäuudelleenkäynnistys käyttöön"),
        ("Enter Invite Code", "Syötä kutsukoodi"),
        ("Enter your invite code to link this device to a dashboard.", "Syötä kutsukoodisi yhdistääksesi tämän laitteen hallintapaneeliin."),
        ("Failed to load conversation", "Keskustelun lataus epäonnistui"),
        ("Failed to load tickets", "Tikettien lataus epäonnistui"),
        ("Failed to submit ticket", "Tiketin lähettäminen epäonnistui"),
        ("File Transfer", "Tiedostonsiirto"),
        ("File size", "Tiedostokoko"),
        ("High", "Korkea"),
        ("Initializing", "Alustetaan"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "Virheellinen kutsukoodi. Täytyy olla 16 merkkiä (kirjaimia ja numeroita)."),
        ("Keyboard mode", "Näppäimistötila"),
        ("Keyboard/Mouse", "Näppäimistö/Hiiri"),
        ("LAN Discovery", "LAN-haku"),
        ("Length", "Pituus"),
        ("Linked", "Yhdistetty"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Yhdistetään hallintapaneeliin... Tämä laite näkyy hallintapaneelissa pian."),
        ("Loading...", "Ladataan..."),
        ("Login screen using Wayland is not supported.", "Kirjautumisnäyttöä Waylandilla ei tueta."),
        ("Low", "Matala"),
        ("My Tickets", "Omat tiketit"),
        ("New Ticket", "Uusi tiketti"),
        ("New reply received", "Uusi vastaus vastaanotettu"),
        ("No", "Ei"),
        ("No messages", "Ei viestejä"),
        ("No printers found on this computer.", "Tulostimia ei löytynyt tältä tietokoneelta."),
        ("No tickets found", "Tikettejä ei löytynyt"),
        ("OS Username", "Käyttöjärjestelmän käyttäjänimi"),
        ("Open a file transfer session to send or receive files", "Avaa tiedostonsiirtoistunto lähettääksesi tai vastaanottaaksesi tiedostoja"),
        ("Open support tickets", "Avaa tukitiketit"),
        ("Password Settings", "Salasana-asetukset"),
        ("Password settings", "Salasana-asetukset"),
        ("Permanent Password", "Pysyvä salasana"),
        ("Priority", "Prioriteetti"),
        ("Privacy Mode", "Yksityisyystila"),
        ("Privacy Policy", "Tietosuojakäytäntö"),
        ("Random Password", "Satunnainen salasana"),
        ("Remote Access", "Etäkäyttö"),
        ("Remote Print", "Etätulostus"),
        ("Remote Print Job", "Etätulostustyö"),
        ("Remote Printing", "Etätulostus"),
        ("Remote Restart", "Etäuudelleenkäynnistys"),
        ("Requirements:", "Vaatimukset:"),
        ("Restart remote device", "Käynnistä etälaite uudelleen"),
        ("Same layout", "Sama asettelu"),
        ("Save", "Tallenna"),
        ("Screenshot", "Kuvakaappaus"),
        ("Screenshot saved to clipboard", "Kuvakaappaus tallennettu leikepöydälle"),
        ("Select printer for remote print job", "Valitse tulostin etätulostustyölle"),
        ("Send a connection invitation to another device by entering its ID", "Lähetä yhteyskutsu toiselle laitteelle syöttämällä sen tunniste"),
        ("Set", "Aseta"),
        ("Start a remote desktop session with the partner device", "Aloita etätyöpöytäistunto kumppanilaitteen kanssa"),
        ("Subject", "Aihe"),
        ("Subject is required", "Aihe on pakollinen"),
        ("Submit Ticket", "Lähetä tiketti"),
        ("Success", "Onnistui"),
        ("Support", "Tuki"),
        ("Switch Display", "Vaihda näyttö"),
        ("Switch sides", "Vaihda puolta"),
        ("The network adapter must have WoL enabled in OS settings", "Verkkosovittimella on oltava WoL käytössä käyttöjärjestelmän asetuksissa"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "Herätyssignaalin lähettää toinen online-tilassa oleva HopToDesk-laite samassa lähiverkossa. Voit laukaista sen minkä tahansa HopToDesk-asiakkaan osoitekirjasta tai hallintapaneelista, jos laite on rekisteröity."),
        ("This device is linked to a dashboard.", "Tämä laite on yhdistetty hallintapaneeliin."),
        ("This device must be connected via Ethernet (not WiFi)", "Tämä laite on yhdistettävä Ethernetin kautta (ei WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Tiketti lähetetty onnistuneesti!"),
        ("Tickets", "Tiketit"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "Tikettejä voidaan luoda vain, jos tämä laite on yhdistetty hallintapaneelin käyttäjään."),
        ("To change, enter a new invite code:", "Muuttaaksesi, syötä uusi kutsukoodi:"),
        ("Tunnel", "Tunneli"),
        ("Two-Factor Authentication", "Kaksivaiheinen todennus"),
        ("Type your reply...", "Kirjoita vastauksesi..."),
        ("Urgent", "Kiireellinen"),
        ("View Security Code", "Näytä turvakoodi"),
        ("Waiting for RDP client", "Odotetaan RDP-asiakasta"),
        ("Wake On LAN", "Wake On LAN"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "Wake On LAN mahdollistaa tämän laitteen käynnistämisen etänä toisesta HopToDesk-asiakkaasta tai hallintapaneelista."),
        ("Yes", "Kyllä"),
        ("You", "Sinä"),
        ("You can find this code in your dashboard invite link.", "Löydät tämän koodin hallintapaneelin kutsulinkistäsi."),
        ("You have a new reply on one of your tickets", "Sinulla on uusi vastaus yhdessä tiketissäsi"),
        ("Your email address", "Sähköpostiosoitteesi"),
        ("Your unique device ID - share this with others so they can connect to you", "Ainutlaatuinen laitetunnuksesi - jaa tämä muille, jotta he voivat yhdistää sinuun"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "ylittää 5MB rajan. Valitse pienempi tiedosto."),
        ("via", "kautta"),


		
        ("Device", "Laite"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "WoL on otettava käyttöön laitteen BIOS/UEFI-asetuksissa"),
        ("Are you sure you want to delete", "Haluatko varmasti poistaa"),
        ("Please enter a local port number", "Anna paikallinen porttinumero"),
        ("Please enter a remote port number", "Anna etäporttinumero"),
        ("Please enter local and remote port numbers", "Anna paikalliset ja etäporttinumerot"),
        ("Copy", "Kopioi"),
        ("Proxy Settings", "Välityspalvelimen asetukset"),
        ("Add to my Dashboard", "Lisää koontinäyttööni"),
        ...
        ("Added to dashboard", "Lisätty koontinäyttöön"),
        ("Request declined", "Pyyntö hylätty"),
        ("Add remote device to my dashboard", "Lisää etälaite koontinäyttööni"),
        ("Your IP", "IP-osoitteesi"),
        ("Switch to ID", "Vaihda ID:hen"),
        ("Switch to local IP", "Vaihda paikalliseen IP:hen"),
        ("No local IP available - showing ID", "Paikallista IP:tä ei saatavilla - näytetään ID"),
        ("Copy your local IP to clipboard", "Kopioi paikallinen IP leikepöydälle"),
        ("Your local IP address - share this for direct LAN connections", "Paikallinen IP-osoitteesi - jaa se suoria LAN-yhteyksiä varten"),
        ("Accept Dashboard Invite?", "Hyväksy koontinäyttökutsu?"),
        ("Request sent, waiting for the remote user to confirm.", "Pyyntö lähetetty, odotetaan etäkäyttäjän vahvistusta."),
        ("Requesting invite code...", "Pyydetään kutsukoodia..."),
        ("The invite code is invalid or expired. Please try again later.", "Kutsukoodi on virheellinen tai vanhentunut. Yritä myöhemmin uudelleen."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Etäkäyttäjä hyväksyi, mutta rekisteröinti epäonnistui. Hän voi olla offline-tilassa tai ei pysty tavoittamaan koontinäyttöä."),
        ("A previous request is still pending on the remote.", "Etälaitteessa on edelleen aiempi pyyntö odottamassa."),
        ("No response from the remote, request timed out.", "Ei vastausta etälaitteelta, pyyntö aikakatkaistiin."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Tätä etäalustaa ei vielä tueta koontinäytön rekisteröintiin."),
        ("This device is already linked to your dashboard.", "Tämä laite on jo linkitetty koontinäyttöösi."),
        ("Replace existing dashboard link?", "Korvataanko olemassa oleva koontinäyttölinkitys?"),
        ("This computer is currently linked to {} dashboard.", "Tämä tietokone on tällä hetkellä linkitetty {}:n koontinäyttöön."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Voit perua tämän milloin tahansa kohdassa Asetukset > Koontinäyttö."),
            ("Recent sessions will show here.", "Viimeisimmät istunnot näkyvät tässä."),
        ("No favorites yet.", "Ei vielä suosikkeja."),
        ("No devices discovered.", "Laitteita ei löytynyt."),
        ("Waiting for new connection ...", "Odotetaan uutta yhteyttä ..."),
        ("Not Ready", "Ei valmis"),
        ("ID / Relay Server", "ID / Välityspalvelin"),
        ("Generate New Temporary Password", "Luo uusi väliaikainen salasana"),
        ("Confirm Password", "Vahvista salasana"),
        ("Two-Factor Authentication Setup", "Kaksivaiheisen todennuksen määritys"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Tämä ohjelmisto on lisensoitu lisenssillä"),
        ...
        ("RANDOM PASSWORD", "SATUNNAINEN SALASANA"),
        ("Attachments:", "Liitteet:"),
        ("Best image quality", "Paras kuvanlaatu"),
        ("Connection Manager", "Yhteyksien hallinta"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Tällä hetkellä linkitetty:"),
        ("Do not close this window while the tunnel is active", "Älä sulje tätä ikkunaa, kun tunneli on aktiivinen"),
        ("Enter Password", "Syötä salasana"),
        ("Enter a new invite code to re-link:", "Syötä uusi kutsukoodi linkittääksesi uudelleen:"),
        ("Establishing connection to remote device", "Muodostetaan yhteyttä etälaitteeseen"),
        ("File Already Exists", "Tiedosto on jo olemassa"),
        ("Input Blocked", "Syöttö estetty"),
        ("Invalid code. Please try again.", "Virheellinen koodi. Yritä uudelleen."),
        ("Keyboard", "Näppäimistö"),
        ("Lock Screen", "Lukitse näyttö"),
        ("Message", "Viesti"),
        ("Please enter the password for the remote device.", "Syötä etälaitteen salasana."),
        ("Record Session", "Nauhoita istunto"),
        ("Type a message...", "Kirjoita viesti..."),
        ("View Style", "Näkymätyyli"),
        ("Waiting...", "Odotetaan..."),
        ("Port Forwarding:", "Portin edelleenohjaus:"),
        ("Reconnecting", "Yhdistetään uudelleen"),
        ("Reconnecting...", "Yhdistetään uudelleen..."),
        ("Email is required", "Sähköposti vaaditaan"),
        ("Please enter a valid email address", "Anna kelvollinen sähköpostiosoite"),
        ("Ticket reopened", "Tiketti avattiin uudelleen"),
        ("Your ticket will be sent to {}", "Tikettisi lähetetään: {}"),
        ("your support team", "tukitiimillesi"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Tätä laitetta ei ole yhdistetty hallintapaneeliin. Tikettejä ei voi lähettää."),
        ("We'll use this address to send you updates about your ticket", "Käytämme tätä osoitetta tikettisi päivityksiin"),
        ("You can also email {}", "Voit myös lähettää sähköpostia: {}"),
        ("You can also call {}", "Voit myös soittaa: {}"),
