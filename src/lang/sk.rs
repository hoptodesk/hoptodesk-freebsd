...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Zadajte číslo miestneho portu"),
        ("Please enter a remote port number", "Zadajte číslo vzdialeného portu"),
        ("Please enter local and remote port numbers", "Zadajte čísla miestneho a vzdialeného portu"),
        ("Copy", "Kopírovať"),
        ("Proxy Settings", "Nastavenia proxy"),
        ("Add to my Dashboard", "Pridať na môj panel"),
        ...
        ("Added to dashboard", "Pridané na panel"),
        ("Request declined", "Žiadosť zamietnutá"),
        ("Add remote device to my dashboard", "Pridať vzdialené zariadenie na môj panel"),
        ("Your IP", "Vaša IP"),
        ("Switch to ID", "Prepnúť na ID"),
        ("Switch to local IP", "Prepnúť na lokálnu IP"),
        ("No local IP available - showing ID", "Nie je dostupná žiadna lokálna IP - zobrazuje sa ID"),
        ("Copy your local IP to clipboard", "Kopírovať lokálnu IP do schránky"),
        ("Your local IP address - share this for direct LAN connections", "Vaša lokálna IP adresa - zdieľajte ju pre priame LAN pripojenia"),
        ("Accept Dashboard Invite?", "Prijať pozvánku na panel?"),
        ("Request sent, waiting for the remote user to confirm.", "Žiadosť odoslaná, čaká sa na potvrdenie vzdialeného používateľa."),
        ("Requesting invite code...", "Vyžaduje sa kód pozvánky..."),
        ("The invite code is invalid or expired. Please try again later.", "Kód pozvánky je neplatný alebo vypršal. Skúste to prosím znova neskôr."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Vzdialený používateľ súhlasil, ale registrácia zlyhala. Možno je offline alebo nemá prístup k panelu."),
        ("A previous request is still pending on the remote.", "Na vzdialenom zariadení stále čaká predchádzajúca žiadosť."),
        ("No response from the remote, request timed out.", "Žiadna odpoveď zo vzdialeného zariadenia, časový limit žiadosti vypršal."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Táto vzdialená platforma zatiaľ nie je podporovaná pre registráciu na panel."),
        ("This device is already linked to your dashboard.", "Toto zariadenie je už prepojené s vaším panelom."),
        ("Replace existing dashboard link?", "Nahradiť existujúce prepojenie s panelom?"),
        ("This computer is currently linked to {} dashboard.", "Tento počítač je momentálne prepojený s panelom {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} pozýva tento počítač, aby sa pripojil k jeho panelu namiesto toho. Existujúce prepojenie bude odstránené."),
        ("{} is inviting this computer to join their dashboard.", "{} pozýva tento počítač, aby sa pripojil k jeho panelu."),
        ("You can undo this any time in Settings > Dashboard.", "Toto môžete kedykoľvek zrušiť v Nastavenia > Panel."),
            ("Recent sessions will show here.", "Tu sa zobrazia nedávne pripojenia."),
        ("No favorites yet.", "Zatiaľ žiadne obľúbené."),
        ("No devices discovered.", "Nenašli sa žiadne zariadenia."),
        ("Waiting for new connection ...", "Čaká sa na nové pripojenie ..."),
        ("Not Ready", "Nepripravený"),
        ("ID / Relay Server", "ID / prepojovací server"),
        ("Generate New Temporary Password", "Vygenerovať nové dočasné heslo"),
        ("Confirm Password", "Potvrďte heslo"),
        ("Two-Factor Authentication Setup", "Nastavenie dvojfaktorovej autentifikácie"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Tento softvér je licencovaný pod"),
        ("Source code is available", "Zdrojový kód je dostupný"),
        ("here", "tu"),
        ...
        ("RANDOM PASSWORD", "NÁHODNÉ HESLO"),
        ("Attachments:", "Prílohy:"),
        ("Best image quality", "Najlepšia kvalita obrazu"),
        ("Connection Manager", "Správca pripojení"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Aktuálne prepojené:"),
        ("Do not close this window while the tunnel is active", "Nezatvárajte toto okno, kým je tunel aktívny"),
        ("Enter Password", "Zadajte heslo"),
        ("Enter a new invite code to re-link:", "Zadajte nový kód pozvánky na opätovné prepojenie:"),
        ("Establishing connection to remote device", "Nadväzuje sa pripojenie k vzdialenému zariadeniu"),
        ("File Already Exists", "Súbor už existuje"),
        ("Input Blocked", "Vstup zablokovaný"),
        ("Invalid code. Please try again.", "Neplatný kód. Skúste to znova."),
        ("Keyboard", "Klávesnica"),
        ("Lock Screen", "Uzamknúť obrazovku"),
        ("Message", "Správa"),
        ("Please enter the password for the remote device.", "Zadajte heslo vzdialeného zariadenia."),
        ("Record Session", "Nahrávať pripojenie"),
        ("Type a message...", "Napíšte správu..."),
        ("View Style", "Štýl zobrazenia"),
        ("Waiting...", "Čaká sa..."),
        ...
        ("Ticket reopened", "Tiket bol znovu otvorený"),
        ("Your ticket will be sent to {}", "Váš tiket bude odoslaný {}"),
        ("your support team", "vášmu tímu podpory"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Toto zariadenie nie je pripojené k žiadnemu dashboardu. Tikety nie je možné odoslať."),
        ("We'll use this address to send you updates about your ticket", "Na túto adresu budeme posielať aktualizácie k vášmu tiketu"),
        ("You can also email {}", "Môžete tiež napísať na {}"),
        ("You can also call {}", "Môžete tiež zavolať na {}"),
