...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Įveskite vietinio prievado numerį"),
        ("Please enter a remote port number", "Įveskite nuotolinio prievado numerį"),
        ("Please enter local and remote port numbers", "Įveskite vietinio ir nuotolinio prievadų numerius"),
        ("Copy", "Kopijuoti"),
        ("Proxy Settings", "Tarpinio serverio nustatymai"),
        ("Add to my Dashboard", "Pridėti į mano skydelį"),
        ...
        ("Added to dashboard", "Pridėta į skydelį"),
        ("Request declined", "Užklausa atmesta"),
        ("Add remote device to my dashboard", "Pridėti nuotolinį įrenginį į mano skydelį"),
        ("Your IP", "Jūsų IP"),
        ("Switch to ID", "Perjungti į ID"),
        ("Switch to local IP", "Perjungti į vietinį IP"),
        ("No local IP available - showing ID", "Vietinio IP nėra - rodomas ID"),
        ("Copy your local IP to clipboard", "Kopijuoti vietinį IP į iškarpinę"),
        ("Your local IP address - share this for direct LAN connections", "Jūsų vietinis IP adresas - dalykitės juo tiesioginiams LAN ryšiams"),
        ("Accept Dashboard Invite?", "Priimti skydelio kvietimą?"),
        ("Request sent, waiting for the remote user to confirm.", "Užklausa išsiųsta, laukiama nuotolinio vartotojo patvirtinimo."),
        ("Requesting invite code...", "Prašoma kvietimo kodo..."),
        ("The invite code is invalid or expired. Please try again later.", "Kvietimo kodas negaliojantis arba pasibaigęs. Bandykite vėliau."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Nuotolinis vartotojas sutiko, bet registracija nepavyko. Jis gali būti neprisijungęs arba negali pasiekti skydelio."),
        ("A previous request is still pending on the remote.", "Nuotoliniame įrenginyje vis dar laukiama ankstesnės užklausos."),
        ("No response from the remote, request timed out.", "Nėra atsakymo iš nuotolinio įrenginio, užklausos laikas baigėsi."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ši nuotolinė platforma dar nepalaikoma skydelio registracijai."),
        ("This device is already linked to your dashboard.", "Šis įrenginys jau susietas su jūsų skydeliu."),
        ("Replace existing dashboard link?", "Pakeisti esamą skydelio sąsają?"),
        ("This computer is currently linked to {} dashboard.", "Šis kompiuteris šiuo metu susietas su {} skydeliu."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Galite tai atšaukti bet kuriuo metu skiltyje Nustatymai > Skydelis."),
            ("Recent sessions will show here.", "Naujausi seansai bus rodomi čia."),
        ("No favorites yet.", "Parankinių kol kas nėra."),
        ("No devices discovered.", "Neaptikta jokių įrenginių."),
        ("Waiting for new connection ...", "Laukiama naujo ryšio ..."),
        ("Not Ready", "Nepasiruošęs"),
        ("ID / Relay Server", "ID / perdavimo serveris"),
        ("Generate New Temporary Password", "Generuoti naują laikiną slaptažodį"),
        ("Confirm Password", "Patvirtinti slaptažodį"),
        ("Two-Factor Authentication Setup", "Dviejų veiksnių autentifikavimo sąranka"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Ši programinė įranga licencijuota pagal"),
        ("Source code is available", "Išeities kodas pasiekiamas"),
        ("here", "čia"),
        ("Invite Code", "Kvietimo kodas"),
        ("Length:", "Ilgis:"),
        ("Link", "Susieti"),
        ("PERMANENT PASSWORD", "NUOLATINIS SLAPTAŽODIS"),
        ("RANDOM PASSWORD", "ATSITIKTINIS SLAPTAŽODIS"),
        ("Attachments:", "Priedai:"),
        ("Best image quality", "Geriausia vaizdo kokybė"),
        ("Connection Manager", "Ryšių tvarkytuvė"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Šiuo metu susieta:"),
        ("Do not close this window while the tunnel is active", "Neuždarykite šio lango, kol tunelis aktyvus"),
        ("Enter Password", "Įveskite slaptažodį"),
        ("Enter a new invite code to re-link:", "Įveskite naują kvietimo kodą, kad susietumėte iš naujo:"),
        ("Establishing connection to remote device", "Užmezgamas ryšys su nuotoliniu įrenginiu"),
        ("File Already Exists", "Failas jau egzistuoja"),
        ("Input Blocked", "Įvestis užblokuota"),
        ("Invalid code. Please try again.", "Neteisingas kodas. Bandykite dar kartą."),
        ("Keyboard", "Klaviatūra"),
        ("Lock Screen", "Užrakinti ekraną"),
        ("Message", "Žinutė"),
        ("Please enter the password for the remote device.", "Įveskite nuotolinio įrenginio slaptažodį."),
        ("Record Session", "Įrašyti seansą"),
        ("Type a message...", "Įveskite žinutę..."),
        ("View Style", "Rodymo stilius"),
        ("Waiting...", "Laukiama..."),
        ("Port Forwarding:", "Prievadų peradresavimas:"),
        ...
        ("Ticket reopened", "Užklausa atidaryta iš naujo"),
        ("Your ticket will be sent to {}", "Jūsų užklausa bus išsiųsta {}"),
        ("your support team", "jūsų pagalbos komandai"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Šis įrenginys neprijungtas prie valdymo skydelio. Užklausų siųsti negalima."),
        ("We'll use this address to send you updates about your ticket", "Šiuo adresu siųsime jūsų užklausos atnaujinimus"),
        ("You can also email {}", "Taip pat galite rašyti {}"),
        ("You can also call {}", "Taip pat galite skambinti {}"),
