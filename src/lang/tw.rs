...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Ready", "就緒"),
        ("Established", "已建立"),
        ("connecting_status", "正在連接至 HopToDesk 網路..."),
        ("connecting_status_short", "正在連接至..."),
        ("Enable Service", "啟用服務"),
        ("Start Service", "開始服務"),
        ("Service is running", "服務正在執行"),
        ("Service is not running", "服務尚未執行"),
        ("not_ready_status", "尚未就緒，請檢查您的網路連線。"),
        ("not_ready_status_short", "尚未就緒"),
        ...
        ("Key mismatch", "金鑰不符"),
        ("Timeout", "逾時"),
        ("Unable to connect to the remote partner.", "無法連線到遠端夥伴。"),
        ("Failed to connect to signal server", "無法透過 rendezvous 伺服器連線"),
        ("Failed to make direct connection to remote desktop", "無法直接連線到遠端桌面"),
        ("Set Password", "設定密碼"),
        ("OS Password", "作業系統密碼"),
        ("install_tip", "為獲得最佳性能，請完成完整安裝。"),
        ("Click to upgrade", "點選以升級"),
        ("Click to download", "點選以下載"),
        ("Click to update", "點選以更新"),
        ("Configure", "設定"),
        ("config_acc", "為了遠端控制您的桌面，您需要授予 HopToDesk「協助工具」權限。"),
        ("config_screen", "為了遠端存取您的桌面，您需要授予 HopToDesk「螢幕錄製」權限。"),
        ("Installing ...", "正在安裝..."),
        ("Install", "安裝"),
        ("Installation", "安裝"),
        ...
        ("Username", "使用者名稱"),
        ("Invalid port", "連接埠無效"),
        ("The remote partner has closed the session.", "對方關閉了工作階段"),
        ...
        ("android_input_permission_tip1", "為了讓遠端裝置能夠透過滑鼠或觸控控制您的 Android 裝置，您需要允許 HopToDesk 使用「輔助功能」服務。"),
        ("android_input_permission_tip2", "請前往下一個系統設定頁面，找到並進入「已安裝的服務」，開啟「HopToDesk Input」服務。"),
        ...
        ("Failed", "失敗"),
        ("Succeeded", "成功"),
        ("Someone turned on privacy mode, exiting.", "其他用戶開啟隱私模式，退出"),
        ("Unsupported", "不支援"),
        ("Peer denied", "對方拒絕"),
        ("Please install plugins", "請安裝外掛程式"),
        ("The peer has exited from Privacy Mode.", "對方退出"),
        ("Failed to turn off", "關閉失敗"),
        ("Turned off", "已關閉"),
        ("Language", "語言"),
        ("Keep HopToDesk background service", "保持HopToDesk後台服務"),
        ("Ignore Battery Optimizations", "忽略電池最佳化"),
        ("android_open_battery_optimizations_tip", "如果您想要停用此功能，請前往下一個 HopToDesk 應用程式設定頁面，找到並進入「電池」，取消勾選「不受限制」"),
        ("Start on Boot", "開機時啟動"),
        ...
        ("Restarting Remote Device", "重新啟動遠端設備"),
        ...
        ("Start Screen Share", "開始共享螢幕"),
        ("Stop Screen Share", "停止分享畫面"),
        ...
        ("config_input", "為了能夠透過鍵盤控制遠端桌面，請給予 HopToDesk \"輸入監控\" 權限。"),
        ("config_microphone", "為了支援透過麥克風進行音訊傳輸，請給予 HopToDesk \"錄音\"權限。"),
        ...
        ("verify_hoptodesk_password_tip", "驗證 HopToDesk 密碼"),
        ...
        ("selinux_tip", "SELinux 處於啟用狀態，HopToDesk 可能無法作為被控端正常運作。"),
        ("Change view", "更改檢視方式"),
        ("Big tiles", "大磁磚"),
        ("Small tiles", "小磁磚"),
        ("List", "列表"),
        ...
        ("Privacy Mode started.", "進入隱私模式"),
        ("Privacy Mode turned off.", "退出隱私模式"),
        ...
        ("allow-only-conn-window-open-tip", "只在 HopToDesk 視窗開啟時允許連接"),
        ...
        ("floating_window_tip", "有助於保持 HopToDesk 後台服務"),
        ...
        ("enter-2fa-setup", "雙重身份驗證設定"),
        ("cancel-bot-confirm-tip", "確定要取消 Telegram 機器人嗎？"),
        ("About HopToDesk", "關於 HopToDesk"),
        ...
        ("allow-insecure-tls-fallback-tip", "預設情況下，對於使用 TLS 的協定，HopToDesk 會驗證伺服器的憑證。\n啟用此選項後，在驗證失敗時，HopToDesk 將轉為跳過驗證步驟並繼續連接。"),
        ("Disable UDP", "停用 UDP"),
        ("disable-udp-tip", "控制是否僅使用 TCP。\n啟用此選項後，HopToDesk 將不再使用 UDP 21116，而是使用 TCP 21116。"),
        ("input note here", "輸入備註"),
        ("note-at-conn-end-tip", "在連接結束時請求備註"),
        ("Enable Wake On LAN", "在LAN上啟用Wake"),
        ("Enable 2FA", "啟用2FA"),
        ("You will need to confirm the 2FA on the secondary device with you when trying to connect to this desktop.", "嘗試連接到此桌面時，您需要在輔助設備上確認 2FA。"),
        ("Choose Network", "選擇網絡"),
        ("Enter your custom network settings URL:", "輸入您的自定義網絡設置 URL："),
        ("HopToDesk Network (Default)", "HopToDesk 網絡（默認）"),
        ("Use HopToDesk Network", "使用 HopToDesk 網路"),
        ("Custom Network URL", "自訂網路 URL"),
        ("Custom Network Settings", "自定義網絡設置"),
        ("Custom Network Error", "自定義網絡錯誤"),
        ("The custom network URL provided was not valid, please try again.", "提供的自定義網絡 URL 無效，請重試。"),
        ("Your Security Code", "您的安全碼"),
        ("Security Code", "安全代碼"),
        ("Full Screen", "全螢幕"),
        ("ID (Click to Copy)", "ID（點擊複製）"),
        ("Password (Click to Copy)", "密碼（點擊複製）"),
        ("Unattended Access", "無人值守訪問"),
        ("An update is available, do you want to update to the new version?", "有可用的更新，您想更新到新版本嗎？"),
        ("Invite", "邀請"),
        ("Invite A Device", "邀請裝置"),
        ("Input an ID to send a connection invitation for this device:", "輸入一個ID以發送此設備的連接邀請："),
        ("Please enter a valid device ID.", "請輸入有效的設備ID。"),
        ("Device ID must contain only numbers (0-9).", "裝置ID必須只包含數字（0-9）。"),
        ("Peer ID", "聯繫人ID"),
        ("Device ID to invite", "邀請的裝置ID"),
        ("Accept invite to connect to this computer?", "接受邀請連接到這台電腦？"),
        ("Incoming Connections Off.", "傳入連線關閉"),
        ("Allow Incoming Connections", "允許入站連接"),
        ("Enable Incoming Connections", "啟用傳入連線"),
        ("Chat sessions will show here.", "聊天記錄將在此處顯示。"),
        ("Connect to a device to start chatting.", "連接到裝置即可開始聊天。"),
        ("No chats yet", "尚未有聊天"),
        ("ios_screen_share_tip", "點選 [開始分享螢幕] 以開始廣播您的螢幕。廣播開始後，您的裝置 ID 和密碼將會出現。"),
        ("This Device", "此裝置"),
        ("Remote Control", "遙控器"),
        ("Copy ID", "複製 ID"),
        ("Menu", "選單"),
        ("Hostname", "主機名稱"),
        ("Enable Remote Printing", "啟用遠端列印"),
        ("Enable unattended access to this device", "啟用此裝置上的無人值守存取"),
        ("Custom network settings URL", "自訂網路設定 URL"),
        ("Update Available", ""),
        ("Don't show this again.", ""),
        ("WOL", ""),
        ("Your ID", "您的身分證"),
        ("Partner ID", "合作夥伴 ID"),
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "設定永久密碼，以便隨時訪問此設備，即使沒有人存在。"),
        ("View camera", "查看攝影機"),
        ("16-character invite code", "16位邀請碼"),
        ("Add File", "新增檔案"),
        ("Always use this printer", "始終使用此印表機"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "同一網路上的另一台HopToDesk裝置必須在線才能轉發喚醒訊號"),
        ("Appearance", "外觀"),
        ("Are you sure you want to switch sides", "確定要切換雙方嗎"),
        ("Attachment", "附件"),
        ("Attachments", "附件"),
        ("Brief description of the issue", "問題簡述"),
        ("Can not invite yourself.", "不能邀請自己。"),
        ("Change Display", "變更顯示器"),
        ("Change password settings", "變更密碼設定"),
        ("Click to load tickets", "點擊載入工單"),
        ("Clipboard", "剪貼簿"),
        ("Confirm", "確認"),
        ("Connected to", "已連線至"),
        ("Connection failed", "連線失敗"),
        ("Copy your device ID to clipboard so others can connect to you", "將裝置ID複製到剪貼簿，以便他人連線至您"),
        ("Current Wayland display server is not supported.", "目前的Wayland顯示伺服器不受支援。"),
        ("Dashboard", "儀表板"),
        ("Describe your issue in detail", "請詳細描述您的問題"),
        ("Description", "描述"),
        ("Description is required", "描述為必填項"),
        ("Different layout", "不同佈局"),
        ("Edit", "編輯"),
        ("Email", "電子郵件"),
        ("Enable Permissions", "啟用權限"),
        ("Enable recording session", "啟用工作階段錄製"),
        ("Enable remote restart", "啟用遠端重新啟動"),
        ("Enter Invite Code", "輸入邀請碼"),
        ("Enter your invite code to link this device to a dashboard.", "輸入邀請碼將此裝置連結至儀表板。"),
        ("Failed to load conversation", "載入對話失敗"),
        ("Failed to load tickets", "載入工單失敗"),
        ("Failed to submit ticket", "提交工單失敗"),
        ("File Transfer", "檔案傳輸"),
        ("File size", "檔案大小"),
        ("High", "高"),
        ("Initializing", "正在初始化"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "邀請碼無效。必須為16個字元（字母和數字）。"),
        ("Keyboard mode", "鍵盤模式"),
        ("Keyboard/Mouse", "鍵盤/滑鼠"),
        ("LAN Discovery", "區域網路探索"),
        ("Length", "長度"),
        ("Linked", "已連結"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "正在連結至儀表板...此裝置將很快出現在儀表板中。"),
        ("Loading...", "載入中..."),
        ("Login screen using Wayland is not supported.", "不支援使用Wayland的登入畫面。"),
        ("Low", "低"),
        ("My Tickets", "我的工單"),
        ("New Ticket", "新建工單"),
        ("New reply received", "收到新回覆"),
        ("No", "否"),
        ("No messages", "沒有訊息"),
        ("No printers found on this computer.", "在此電腦上未找到印表機。"),
        ("No tickets found", "未找到工單"),
        ("OS Username", "作業系統使用者名稱"),
        ("Open a file transfer session to send or receive files", "開啟檔案傳輸工作階段以傳送或接收檔案"),
        ("Open support tickets", "開啟支援工單"),
        ...
        ("Privacy Mode", "隱私模式"),
        ("Privacy Policy", "隱私政策"),
        ("Random Password", "隨機密碼"),
        ("Remote Access", "遠端存取"),
        ("Remote Print", "遠端列印"),
        ("Remote Print Job", "遠端列印工作"),
        ("Remote Printing", "遠端列印"),
        ...
        ("Save", "儲存"),
        ("Screenshot", "螢幕截圖"),
        ("Screenshot saved to clipboard", "螢幕截圖已儲存至剪貼簿"),
        ("Select printer for remote print job", "選擇遠端列印工作的印表機"),
        ("Send a connection invitation to another device by entering its ID", "輸入ID向另一台裝置傳送連線邀請"),
        ("Set", "設定"),
        ("Start a remote desktop session with the partner device", "與夥伴裝置啟動遠端桌面工作階段"),
        ("Subject", "主旨"),
        ("Subject is required", "主旨為必填項"),
        ("Submit Ticket", "提交工單"),
        ("Success", "成功"),
        ("Support", "支援"),
        ("Switch Display", "切換顯示器"),
        ("Switch sides", "切換雙方"),
        ("The network adapter must have WoL enabled in OS settings", "網路介面卡必須在作業系統設定中啟用WoL"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "喚醒訊號由同一區域網路上的另一台線上HopToDesk裝置傳送。您可以從任何HopToDesk用戶端的通訊錄中觸發，或在已註冊的情況下從儀表板觸發。"),
        ("This device is linked to a dashboard.", "此裝置已連結至儀表板。"),
        ("This device must be connected via Ethernet (not WiFi)", "此裝置必須透過乙太網路連線（非WiFi）"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "工單提交成功！"),
        ("Tickets", "工單"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "僅當此裝置連結至儀表板使用者時才能建立工單。"),
        ("To change, enter a new invite code:", "如需變更，請輸入新的邀請碼："),
        ("Tunnel", "通道"),
        ("Two-Factor Authentication", "雙重驗證"),
        ("Type your reply...", "輸入回覆..."),
        ("Urgent", "緊急"),
        ("View Security Code", "檢視安全碼"),
        ("Waiting for RDP client", "等待RDP用戶端"),
        ("Wake On LAN", "網路喚醒"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "網路喚醒允許您從另一台HopToDesk用戶端或儀表板遠端開啟此裝置。"),
        ("Yes", "是"),
        ("You", "您"),
        ("You can find this code in your dashboard invite link.", "您可以在儀表板邀請連結中找到此代碼。"),
        ("You have a new reply on one of your tickets", "您的一個工單收到了新回覆"),
        ("Your email address", "您的電子郵件地址"),
        ("Your unique device ID - share this with others so they can connect to you", "您的唯一裝置ID - 分享給他人以便他們連線至您"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "超過5MB限制。請選擇較小的檔案。"),
        ("via", "透過"),

        ("Device", "裝置"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "必須在裝置的 BIOS/UEFI 設定中啟用 WoL"),
        ("Are you sure you want to delete", "您確定要刪除嗎"),
        ("Please enter a local port number", "請輸入本機連接埠號碼"),
        ...
        ("Added to dashboard", "已新增到儀表板"),
        ("Request declined", "請求被拒絕"),
        ("Add remote device to my dashboard", "將遠端裝置新增到我的儀表板"),
        ("Your IP", "您的 IP"),
        ("Switch to ID", "切換到 ID"),
        ("Switch to local IP", "切換到本機 IP"),
        ("No local IP available - showing ID", "無可用本機 IP - 顯示 ID"),
        ("Copy your local IP to clipboard", "複製本機 IP 到剪貼簿"),
        ("Your local IP address - share this for direct LAN connections", "您的本機 IP 位址 - 分享此位址以進行直接 LAN 連線"),
        ("Accept Dashboard Invite?", "接受儀表板邀請?"),
        ("Request sent, waiting for the remote user to confirm.", "請求已發送,等待遠端使用者確認。"),
        ("Requesting invite code...", "正在請求邀請碼..."),
        ("The invite code is invalid or expired. Please try again later.", "邀請碼無效或已過期。請稍後再試。"),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "遠端使用者已接受,但註冊失敗。他們可能離線或無法連線到儀表板。"),
        ("A previous request is still pending on the remote.", "遠端裝置上仍有一個先前的請求待處理。"),
        ("No response from the remote, request timed out.", "遠端裝置無回應,請求逾時。"),
        ("This remote platform isn't supported for dashboard enrollment yet.", "此遠端平台尚不支援儀表板註冊。"),
        ("This device is already linked to your dashboard.", "此裝置已與您的儀表板關聯。"),
        ("Replace existing dashboard link?", "替換現有的儀表板關聯?"),
        ("This computer is currently linked to {} dashboard.", "此電腦目前已與 {} 的儀表板關聯。"),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} 邀請此電腦加入其儀表板。現有關聯將被移除。"),
        ("{} is inviting this computer to join their dashboard.", "{} 邀請此電腦加入其儀表板。"),
        ("You can undo this any time in Settings > Dashboard.", "您可以隨時在 設定 > 儀表板 中撤銷此操作。"),
            ("Recent sessions will show here.", "近期的工作階段將顯示於此。"),
        ("No favorites yet.", "尚無我的最愛。"),
        ("No devices discovered.", "未探索到任何裝置。"),
        ("Waiting for new connection ...", "正在等候新連線 ..."),
        ("Not Ready", "尚未就緒"),
        ("ID / Relay Server", "ID / 中繼伺服器"),
        ("Generate New Temporary Password", "產生新的臨時密碼"),
        ("Confirm Password", "確認密碼"),
        ("Two-Factor Authentication Setup", "雙重驗證設定"),
        ("API URL", "API URL"),
        ("This software is licensed under", "本軟體的授權條款為"),
        ("Source code is available", "原始碼位於"),
        ("here", "此處"),
        ("Invite Code", "邀請碼"),
        ("Length:", "長度："),
        ("Link", "連結"),
        ("PERMANENT PASSWORD", "永久密碼"),
        ("RANDOM PASSWORD", "隨機密碼"),
        ("Attachments:", "附件："),
        ("Best image quality", "最佳畫面品質"),
        ("Connection Manager", "連線管理員"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "目前連結："),
        ("Do not close this window while the tunnel is active", "通道使用中時請勿關閉此視窗"),
        ("Enter Password", "輸入密碼"),
        ("Enter a new invite code to re-link:", "輸入新的邀請碼以重新連結："),
        ("Establishing connection to remote device", "正在建立與遠端裝置的連線"),
        ("File Already Exists", "檔案已存在"),
        ("Input Blocked", "輸入已封鎖"),
        ("Invalid code. Please try again.", "代碼無效。請再試一次。"),
        ("Keyboard", "鍵盤"),
        ("Lock Screen", "鎖定螢幕"),
        ("Message", "訊息"),
        ("Please enter the password for the remote device.", "請輸入遠端裝置的密碼。"),
        ("Record Session", "錄製工作階段"),
        ("Type a message...", "輸入訊息..."),
        ("View Style", "檢視樣式"),
        ("Waiting...", "正在等候 ..."),
        ...
        ("Ticket reopened", "工單已重新開啟"),
        ("Your ticket will be sent to {}", "您的工單將傳送至{}"),
        ("your support team", "您的支援團隊"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "此裝置未連接到儀表板。無法提交工單。"),
        ("We'll use this address to send you updates about your ticket", "我們將使用此地址向您傳送工單更新"),
        ("You can also email {}", "您也可以寄送郵件至{}"),
        ("You can also call {}", "您也可以致電{}"),
