...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "Sie können dies jederzeit unter Einstellungen > Dashboard rückgängig machen."),
            ("Recent sessions will show here.", "Letzte Sitzungen werden hier angezeigt."),
        ("No favorites yet.", "Noch keine Favoriten."),
        ("No devices discovered.", "Keine Geräte gefunden."),
        ("Waiting for new connection ...", "Warten auf neue Verbindung ..."),
        ("Not Ready", "Nicht bereit"),
        ("ID / Relay Server", "ID / Relay-Server"),
        ("Generate New Temporary Password", "Neues temporäres Passwort generieren"),
        ("Confirm Password", "Passwort bestätigen"),
        ("Two-Factor Authentication Setup", "Einrichtung der Zwei-Faktor-Authentifizierung"),
        ("API URL", "API-URL"),
        ("This software is licensed under", "Diese Software ist lizenziert unter"),
        ("Source code is available", "Den Quellcode finden Sie"),
        ("here", "hier"),
        ...
        ("RANDOM PASSWORD", "ZUFALLSPASSWORT"),
        ("Attachments:", "Anhänge:"),
        ("Best image quality", "Beste Bildqualität"),
        ("Connection Manager", "Verbindungsmanager"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Aktuell verknüpft:"),
        ("Do not close this window while the tunnel is active", "Schließen Sie dieses Fenster nicht, solange der Tunnel aktiv ist"),
        ("Enter Password", "Passwort eingeben"),
        ("Enter a new invite code to re-link:", "Geben Sie einen neuen Einladungscode ein, um neu zu verknüpfen:"),
        ("Establishing connection to remote device", "Verbindung zum entfernten Gerät wird hergestellt"),
        ("File Already Exists", "Datei existiert bereits"),
        ("Input Blocked", "Eingabe blockiert"),
        ("Invalid code. Please try again.", "Ungültiger Code. Bitte versuchen Sie es erneut."),
        ("Keyboard", "Tastatur"),
        ("Lock Screen", "Bildschirm sperren"),
        ("Message", "Nachricht"),
        ("Please enter the password for the remote device.", "Bitte geben Sie das Passwort für das entfernte Gerät ein."),
        ("Record Session", "Sitzung aufzeichnen"),
        ("Type a message...", "Nachricht eingeben..."),
        ("View Style", "Ansichtsstil"),
        ("Waiting...", "Warten..."),
        ...
        ("Ticket reopened", "Ticket wurde wieder geöffnet"),
        ("Your ticket will be sent to {}", "Ihr Ticket wird an {} gesendet"),
        ("your support team", "Ihr Support-Team"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Dieses Gerät ist mit keinem Dashboard verbunden. Tickets können nicht gesendet werden."),
        ("We'll use this address to send you updates about your ticket", "Wir verwenden diese Adresse für Updates zu Ihrem Ticket"),
        ("You can also email {}", "Sie können auch an {} schreiben"),
        ("You can also call {}", "Sie können auch {} anrufen"),
