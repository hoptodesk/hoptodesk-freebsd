...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Veuillez entrer un numéro de port local"),
        ("Please enter a remote port number", "Veuillez entrer un numéro de port distant"),
        ("Please enter local and remote port numbers", "Veuillez entrer les numéros de port local et distant"),
        ("Copy", "Copier"),
        ...
        ("Added to dashboard", "Ajouté au tableau de bord"),
        ("Request declined", "Demande refusée"),
        ("Add remote device to my dashboard", "Ajouter l'appareil distant à mon tableau de bord"),
        ("Your IP", "Votre IP"),
        ("Switch to ID", "Basculer vers l'ID"),
        ("Switch to local IP", "Basculer vers l'IP locale"),
        ("No local IP available - showing ID", "Aucune IP locale disponible - affichage de l'ID"),
        ("Copy your local IP to clipboard", "Copier votre IP locale dans le presse-papiers"),
        ("Your local IP address - share this for direct LAN connections", "Votre adresse IP locale - partagez-la pour les connexions LAN directes"),
        ("Accept Dashboard Invite?", "Accepter l'invitation au tableau de bord ?"),
        ("Request sent, waiting for the remote user to confirm.", "Demande envoyée, en attente de confirmation de l'utilisateur distant."),
        ("Requesting invite code...", "Demande du code d'invitation..."),
        ("The invite code is invalid or expired. Please try again later.", "Le code d'invitation est invalide ou expiré. Veuillez réessayer plus tard."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "L'utilisateur distant a accepté mais l'inscription a échoué. Il est peut-être hors ligne ou ne peut pas joindre le tableau de bord."),
        ("A previous request is still pending on the remote.", "Une demande précédente est toujours en attente sur l'appareil distant."),
        ("No response from the remote, request timed out.", "Aucune réponse de l'appareil distant, la demande a expiré."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Cette plateforme distante n'est pas encore prise en charge pour l'inscription au tableau de bord."),
        ("This device is already linked to your dashboard.", "Cet appareil est déjà lié à votre tableau de bord."),
        ("Replace existing dashboard link?", "Remplacer le lien existant du tableau de bord ?"),
        ("This computer is currently linked to {} dashboard.", "Cet ordinateur est actuellement lié au tableau de bord de {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} invite cet ordinateur à rejoindre son tableau de bord à la place. Le lien existant sera supprimé."),
        ("{} is inviting this computer to join their dashboard.", "{} invite cet ordinateur à rejoindre son tableau de bord."),
        ("You can undo this any time in Settings > Dashboard.", "Vous pouvez annuler cela à tout moment dans Paramètres > Tableau de bord."),
            ("Recent sessions will show here.", "Les sessions récentes s'afficheront ici."),
        ("No favorites yet.", "Aucun favori pour le moment."),
        ("No devices discovered.", "Aucun appareil découvert."),
        ("Waiting for new connection ...", "En attente d'une nouvelle connexion ..."),
        ("Not Ready", "Pas prêt"),
        ("ID / Relay Server", "ID / Serveur Relais"),
        ("Generate New Temporary Password", "Générer un nouveau mot de passe temporaire"),
        ("Confirm Password", "Confirmer le mot de passe"),
        ("Two-Factor Authentication Setup", "Configuration de l'authentification à deux facteurs"),
        ("API URL", "URL de l'API"),
        ("This software is licensed under", "Ce logiciel est sous licence"),
        ...
        ("RANDOM PASSWORD", "MOT DE PASSE ALÉATOIRE"),
        ("Attachments:", "Pièces jointes:"),
        ("Best image quality", "Meilleure qualité d'image"),
        ("Connection Manager", "Gestionnaire de connexions"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Actuellement lié:"),
        ("Do not close this window while the tunnel is active", "Ne fermez pas cette fenêtre tant que le tunnel est actif"),
        ("Enter Password", "Entrer le mot de passe"),
        ("Enter a new invite code to re-link:", "Entrez un nouveau code d'invitation pour relier à nouveau:"),
        ("Establishing connection to remote device", "Établissement de la connexion à l'appareil distant"),
        ("File Already Exists", "Le fichier existe déjà"),
        ("Input Blocked", "Saisie bloquée"),
        ("Invalid code. Please try again.", "Code invalide. Veuillez réessayer."),
        ("Keyboard", "Clavier"),
        ("Lock Screen", "Verrouiller l'écran"),
        ("Message", "Message"),
        ("Please enter the password for the remote device.", "Veuillez saisir le mot de passe de l'appareil distant."),
        ("Record Session", "Enregistrer la session"),
        ("Type a message...", "Tapez un message..."),
        ("View Style", "Style d'affichage"),
        ("Waiting...", "En attente..."),
        ...
        ("Your ticket will be sent to {}", "Votre ticket sera envoyé à {}"),
        ("your support team", "votre équipe de support"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Cet appareil n'est connecté à aucun tableau de bord. Impossible d'envoyer des tickets."),
        ("We'll use this address to send you updates about your ticket", "Nous utiliserons cette adresse pour les mises à jour de votre ticket"),
        ("You can also email {}", "Vous pouvez aussi écrire à {}"),
        ("You can also call {}", "Vous pouvez aussi appeler le {}"),
