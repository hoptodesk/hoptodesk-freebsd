...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Introduïu un número de port local"),
        ("Please enter a remote port number", "Introduïu un número de port remot"),
        ("Please enter local and remote port numbers", "Introduïu els números de port local i remot"),
        ("Copy", "Copiar"),
        ("Proxy Settings", "Configuració del proxy"),
        ("Add to my Dashboard", "Afegeix al meu tauler"),
        ...
        ("Added to dashboard", "Afegit al tauler"),
        ("Request declined", "Sol·licitud rebutjada"),
        ("Add remote device to my dashboard", "Afegeix el dispositiu remot al meu tauler"),
        ("Your IP", "La teva IP"),
        ("Switch to ID", "Canvia a ID"),
        ("Switch to local IP", "Canvia a IP local"),
        ("No local IP available - showing ID", "Cap IP local disponible - mostrant ID"),
        ("Copy your local IP to clipboard", "Copia la IP local al porta-retalls"),
        ("Your local IP address - share this for direct LAN connections", "La teva adreça IP local - comparteix-la per a connexions LAN directes"),
        ("Accept Dashboard Invite?", "Accepta la invitació al tauler?"),
        ("Request sent, waiting for the remote user to confirm.", "Sol·licitud enviada, esperant la confirmació de l'usuari remot."),
        ("Requesting invite code...", "Sol·licitant codi d'invitació..."),
        ("The invite code is invalid or expired. Please try again later.", "El codi d'invitació no és vàlid o ha caducat. Torna-ho a provar més tard."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "L'usuari remot ha acceptat però el registre ha fallat. Pot estar desconnectat o no poder accedir al tauler."),
        ("A previous request is still pending on the remote.", "Encara hi ha una sol·licitud anterior pendent al dispositiu remot."),
        ("No response from the remote, request timed out.", "Sense resposta del dispositiu remot, la sol·licitud ha caducat."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Aquesta plataforma remota encara no és compatible amb el registre al tauler."),
        ("This device is already linked to your dashboard.", "Aquest dispositiu ja està vinculat al teu tauler."),
        ("Replace existing dashboard link?", "Vols substituir el vincle de tauler existent?"),
        ("This computer is currently linked to {} dashboard.", "Aquest ordinador està vinculat actualment al tauler de {}."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Pots desfer-ho en qualsevol moment a Configuració > Tauler."),
            ("Recent sessions will show here.", "Les sessions recents es mostraran aquí."),
        ("No favorites yet.", "Encara no hi ha preferits."),
        ("No devices discovered.", "No s'ha descobert cap dispositiu."),
        ("Waiting for new connection ...", "Esperant una nova connexió ..."),
        ("Not Ready", "No preparat"),
        ("ID / Relay Server", "Servidor ID / Relay"),
        ("Generate New Temporary Password", "Generar una nova contrasenya temporal"),
        ("Confirm Password", "Confirmeu la contrasenya"),
        ("Two-Factor Authentication Setup", "Configuració de l'autenticació de dos factors"),
        ("API URL", "URL de l'API"),
        ("This software is licensed under", "Aquest programari està llicenciat sota"),
        ("Source code is available", "El codi font està disponible"),
        ("here", "aquí"),
        ...
        ("RANDOM PASSWORD", "CONTRASENYA ALEATÒRIA"),
        ("Attachments:", "Fitxers adjunts:"),
        ("Best image quality", "Millor qualitat d'imatge"),
        ("Connection Manager", "Gestor de connexions"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Actualment vinculat:"),
        ("Do not close this window while the tunnel is active", "No tanqueu aquesta finestra mentre el túnel estigui actiu"),
        ("Enter Password", "Introduïu la contrasenya"),
        ("Enter a new invite code to re-link:", "Introduïu un nou codi d'invitació per tornar a vincular:"),
        ("Establishing connection to remote device", "Establint connexió amb el dispositiu remot"),
        ("File Already Exists", "El fitxer ja existeix"),
        ("Input Blocked", "Entrada bloquejada"),
        ("Invalid code. Please try again.", "Codi no vàlid. Torneu-ho a provar."),
        ("Keyboard", "Teclat"),
        ("Lock Screen", "Bloquejar la pantalla"),
        ("Message", "Missatge"),
        ("Please enter the password for the remote device.", "Introduïu la contrasenya del dispositiu remot."),
        ("Record Session", "Gravar la sessió"),
        ("Type a message...", "Escriviu un missatge..."),
        ("View Style", "Estil de visualització"),
        ("Waiting...", "Esperant..."),
        ("Port Forwarding:", "Redirecció de ports:"),
        ("Reconnecting", "Reconnectant"),
        ("Reconnecting...", "Reconnectant..."),
        ("Email is required", "El correu electrònic és obligatori"),
        ("Please enter a valid email address", "Introduïu una adreça electrònica vàlida"),
        ("Ticket reopened", "Tiquet reobert"),
        ("Your ticket will be sent to {}", "El vostre tiquet s'enviarà a {}"),
        ("your support team", "el vostre equip de suport"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Aquest dispositiu no està connectat a cap tauler. No es poden enviar tiquets."),
        ("We'll use this address to send you updates about your ticket", "Farem servir aquesta adreça per enviar-vos actualitzacions del tiquet"),
        ("You can also email {}", "També podeu escriure a {}"),
        ("You can also call {}", "També podeu trucar al {}"),
