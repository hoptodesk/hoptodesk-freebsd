...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "Пожалуйста, введите номер локального порта"),
        ("Please enter a remote port number", "Пожалуйста, введите номер удалённого порта"),
        ("Please enter local and remote port numbers", "Пожалуйста, введите номера локального и удалённого портов"),
        ("Copy", "Копировать"),
        ("Proxy Settings", "Настройки прокси"),
        ("Add to my Dashboard", "Добавить в мою панель"),
        ...
        ("Added to dashboard", "Добавлено в панель"),
        ("Request declined", "Запрос отклонён"),
        ("Add remote device to my dashboard", "Добавить удалённое устройство в мою панель"),
        ("Your IP", "Ваш IP"),
        ("Switch to ID", "Переключиться на ID"),
        ("Switch to local IP", "Переключиться на локальный IP"),
        ("No local IP available - showing ID", "Локальный IP недоступен — показан ID"),
        ("Copy your local IP to clipboard", "Скопировать локальный IP в буфер обмена"),
        ("Your local IP address - share this for direct LAN connections", "Ваш локальный IP-адрес — поделитесь им для прямых LAN-подключений"),
        ("Accept Dashboard Invite?", "Принять приглашение в панель?"),
        ("Request sent, waiting for the remote user to confirm.", "Запрос отправлен, ожидается подтверждение удалённого пользователя."),
        ("Requesting invite code...", "Запрос кода приглашения..."),
        ("The invite code is invalid or expired. Please try again later.", "Код приглашения недействителен или истёк. Пожалуйста, попробуйте позже."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Удалённый пользователь принял запрос, но регистрация не удалась. Возможно, он не в сети или не может подключиться к панели."),
        ("A previous request is still pending on the remote.", "На удалённом устройстве всё ещё ожидается предыдущий запрос."),
        ("No response from the remote, request timed out.", "Нет ответа от удалённого устройства, время ожидания истекло."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Эта удалённая платформа пока не поддерживается для регистрации в панели."),
        ("This device is already linked to your dashboard.", "Это устройство уже привязано к вашей панели."),
        ("Replace existing dashboard link?", "Заменить существующую привязку панели?"),
        ("This computer is currently linked to {} dashboard.", "Этот компьютер сейчас привязан к панели {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} приглашает этот компьютер присоединиться к своей панели. Существующая привязка будет удалена."),
        ("{} is inviting this computer to join their dashboard.", "{} приглашает этот компьютер присоединиться к своей панели."),
        ("You can undo this any time in Settings > Dashboard.", "Вы можете отменить это в любое время в Настройки > Панель."),
            ("Recent sessions will show here.", "Здесь будут показаны последние сеансы."),
        ("No favorites yet.", "В избранном пока пусто."),
        ("No devices discovered.", "Устройства не найдены."),
        ("Waiting for new connection ...", "Ожидание нового подключения ..."),
        ("Not Ready", "Не готов"),
        ("ID / Relay Server", "Сервер ID / ретранслятор"),
        ("Generate New Temporary Password", "Создать новый временный пароль"),
        ("Confirm Password", "Подтвердите пароль"),
        ("Two-Factor Authentication Setup", "Настройка двухфакторной аутентификации"),
        ("API URL", "URL API"),
        ("This software is licensed under", "Это программное обеспечение распространяется по лицензии"),
        ...
        ("RANDOM PASSWORD", "СЛУЧАЙНЫЙ ПАРОЛЬ"),
        ("Attachments:", "Вложения:"),
        ("Best image quality", "Максимальное качество изображения"),
        ("Connection Manager", "Менеджер подключений"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Сейчас привязано:"),
        ("Do not close this window while the tunnel is active", "Не закрывайте это окно, пока туннель активен"),
        ("Enter Password", "Введите пароль"),
        ("Enter a new invite code to re-link:", "Введите новый код приглашения для повторной привязки:"),
        ("Establishing connection to remote device", "Установка подключения к удалённому устройству"),
        ("File Already Exists", "Файл уже существует"),
        ("Input Blocked", "Ввод заблокирован"),
        ("Invalid code. Please try again.", "Неверный код. Попробуйте ещё раз."),
        ("Keyboard", "Клавиатура"),
        ("Lock Screen", "Заблокировать экран"),
        ("Message", "Сообщение"),
        ("Please enter the password for the remote device.", "Введите пароль удалённого устройства."),
        ("Record Session", "Записать сеанс"),
        ("Type a message...", "Введите сообщение..."),
        ("View Style", "Стиль отображения"),
        ("Waiting...", "Ожидание..."),
        ...
        ("Ticket reopened", "Заявка снова открыта"),
        ("Your ticket will be sent to {}", "Ваша заявка будет отправлена {}"),
        ("your support team", "вашей службе поддержки"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Это устройство не подключено к панели управления. Отправка заявок невозможна."),
        ("We'll use this address to send you updates about your ticket", "Мы будем использовать этот адрес для обновлений по вашей заявке"),
        ("You can also email {}", "Вы также можете написать на {}"),
        ("You can also call {}", "Вы также можете позвонить по номеру {}"),
