...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "ניתן לבטל זאת בכל עת בהגדרות > לוח בקרה."),
            ("Recent sessions will show here.", "שיחות אחרונות יוצגו כאן."),
        ("No favorites yet.", "אין מועדפים עדיין."),
        ("No devices discovered.", "לא נמצאו מכשירים."),
        ("Waiting for new connection ...", "ממתין לחיבור חדש ..."),
        ("Not Ready", "לא מוכן"),
        ("ID / Relay Server", "שרת מזהה / ריליי"),
        ("Generate New Temporary Password", "צור סיסמה זמנית חדשה"),
        ("Confirm Password", "אישור סיסמה"),
        ("Two-Factor Authentication Setup", "הגדרת אימות דו-שלבי"),
        ("API URL", "API URL"),
        ("This software is licensed under", "תוכנה זו מופצת תחת רישיון"),
        ("Source code is available", "קוד המקור זמין"),
        ("here", "כאן"),
        ...
        ("RANDOM PASSWORD", "סיסמה אקראית"),
        ("Attachments:", "קבצים מצורפים:"),
        ("Best image quality", "איכות תמונה מיטבית"),
        ("Connection Manager", "מנהל חיבורים"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "מקושר כעת:"),
        ("Do not close this window while the tunnel is active", "אין לסגור חלון זה כל עוד המנהרה פעילה"),
        ("Enter Password", "הזן סיסמה"),
        ("Enter a new invite code to re-link:", "הזן קוד הזמנה חדש כדי לקשר מחדש:"),
        ("Establishing connection to remote device", "יוצר חיבור למכשיר המרוחק"),
        ("File Already Exists", "הקובץ כבר קיים"),
        ("Input Blocked", "הקלט חסום"),
        ("Invalid code. Please try again.", "קוד שגוי. אנא נסה שוב."),
        ("Keyboard", "מקלדת"),
        ("Lock Screen", "נעל מסך"),
        ("Message", "הודעה"),
        ("Please enter the password for the remote device.", "אנא הזן את הסיסמה של המכשיר המרוחק."),
        ("Record Session", "הקלטת הפעלה"),
        ("Type a message...", "הקלד הודעה..."),
        ("View Style", "סגנון תצוגה"),
        ("Waiting...", "ממתין..."),
        ("Port Forwarding:", "העברת פורטים:"),
        ("Reconnecting", "מתחבר מחדש"),
        ("Reconnecting...", "מתחבר מחדש..."),
        ("Email is required", "נדרש אימייל"),
        ("Please enter a valid email address", "אנא הזן כתובת אימייל חוקית"),
        ("Ticket reopened", "הפנייה נפתחה מחדש"),
        ("Your ticket will be sent to {}", "הפנייה שלך תישלח אל {}"),
        ("your support team", "צוות התמיכה שלך"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "מכשיר זה אינו מחובר ללוח בקרה. לא ניתן לשלוח פניות."),
        ("We'll use this address to send you updates about your ticket", "נשתמש בכתובת זו לעדכונים על הפנייה שלך"),
        ("You can also email {}", "אפשר גם לשלוח אימייל אל {}"),
        ("You can also call {}", "אפשר גם להתקשר אל {}"),
