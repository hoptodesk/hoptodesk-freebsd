...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("The peer has exited from Privacy Mode.", "Użytkownik opuścił tryb prywatności."),
        ("Failed to turn off", "Nie udało się wyłączyć"),
        ("Turned off", "Wyłączony"),
        ("Language", "Język"),
        ("Keep HopToDesk background service", "Zachowaj usługę HopToDesk w tle"),
        ...
        ("Remote Control", "Zdalne urządzenie"),
        ("Copy ID", "Kopiuj ID"),
        ("Menu", "Menu"),
        ...
        ("Update Available", "Dostępne uaktualnienie"),
        ...
        ("Please enter a local port number", "Wprowadź numer portu lokalnego"),
        ("Please enter a remote port number", "Wprowadź numer portu zdalnego"),
        ("Please enter local and remote port numbers", "Wprowadź numery portów lokalnego i zdalnego"),
        ("Copy", "Kopiuj"),
        ("Proxy Settings", "Ustawienia proxy"),
        ("Add to my Dashboard", "Dodaj do mojego panelu"),
        ...
        ("Added to dashboard", "Dodano do panelu"),
        ("Request declined", "Prośba odrzucona"),
        ("Add remote device to my dashboard", "Dodaj zdalne urządzenie do mojego panelu"),
        ("Your IP", "Twoje IP"),
        ("Switch to ID", "Przełącz na ID"),
        ("Switch to local IP", "Przełącz na lokalne IP"),
        ("No local IP available - showing ID", "Brak dostępnego lokalnego IP - wyświetlam ID"),
        ("Copy your local IP to clipboard", "Skopiuj lokalne IP do schowka"),
        ("Your local IP address - share this for direct LAN connections", "Twój lokalny adres IP - udostępnij go dla bezpośrednich połączeń LAN"),
        ("Accept Dashboard Invite?", "Zaakceptować zaproszenie do panelu?"),
        ("Request sent, waiting for the remote user to confirm.", "Prośba wysłana, oczekiwanie na potwierdzenie zdalnego użytkownika."),
        ("Requesting invite code...", "Pobieranie kodu zaproszenia..."),
        ("The invite code is invalid or expired. Please try again later.", "Kod zaproszenia jest nieprawidłowy lub wygasł. Spróbuj ponownie później."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Zdalny użytkownik zaakceptował, ale rejestracja się nie powiodła. Może być offline lub nie mieć dostępu do panelu."),
        ("A previous request is still pending on the remote.", "Poprzednia prośba jest nadal w toku na zdalnym urządzeniu."),
        ("No response from the remote, request timed out.", "Brak odpowiedzi ze zdalnego urządzenia, upłynął limit czasu prośby."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ta zdalna platforma nie jest jeszcze obsługiwana dla rejestracji w panelu."),
        ("This device is already linked to your dashboard.", "To urządzenie jest już połączone z Twoim panelem."),
        ("Replace existing dashboard link?", "Zastąpić istniejące połączenie z panelem?"),
        ("This computer is currently linked to {} dashboard.", "Ten komputer jest obecnie połączony z panelem {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} zaprasza ten komputer do dołączenia do swojego panelu zamiast tego. Istniejące połączenie zostanie usunięte."),
        ("{} is inviting this computer to join their dashboard.", "{} zaprasza ten komputer do dołączenia do swojego panelu."),
        ("You can undo this any time in Settings > Dashboard.", "Możesz to cofnąć w dowolnym momencie w Ustawienia > Panel."),
            ("Recent sessions will show here.", "Ostatnie sesje pojawią się tutaj."),
        ("No favorites yet.", "Brak ulubionych."),
        ("No devices discovered.", "Nie wykryto urządzeń."),
        ("Waiting for new connection ...", "Oczekiwanie na nowe połączenie ..."),
        ("Not Ready", "Brak gotowości"),
        ("ID / Relay Server", "Serwer ID / pośredniczący"),
        ("Generate New Temporary Password", "Wygeneruj nowe hasło tymczasowe"),
        ("Confirm Password", "Potwierdź hasło"),
        ("Two-Factor Authentication Setup", "Konfiguracja uwierzytelniania dwuskładnikowego"),
        ("API URL", "API URL"),
        ("This software is licensed under", "To oprogramowanie jest objęte licencją"),
        ...
        ("RANDOM PASSWORD", "HASŁO LOSOWE"),
        ("Attachments:", "Załączniki:"),
        ("Best image quality", "Najlepsza jakość obrazu"),
        ("Connection Manager", "Menedżer połączeń"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Obecnie powiązane:"),
        ("Do not close this window while the tunnel is active", "Nie zamykaj tego okna, gdy tunel jest aktywny"),
        ("Enter Password", "Wprowadź hasło"),
        ("Enter a new invite code to re-link:", "Wprowadź nowy kod zaproszenia, aby powiązać ponownie:"),
        ("Establishing connection to remote device", "Nawiązywanie połączenia ze zdalnym urządzeniem"),
        ("File Already Exists", "Plik już istnieje"),
        ("Input Blocked", "Zablokowano peryferia"),
        ("Invalid code. Please try again.", "Nieprawidłowy kod. Spróbuj ponownie."),
        ("Keyboard", "Klawiatura"),
        ("Lock Screen", "Zablokuj ekran"),
        ("Message", "Wiadomość"),
        ("Please enter the password for the remote device.", "Wprowadź hasło zdalnego urządzenia."),
        ("Record Session", "Nagrywaj sesję"),
        ("Type a message...", "Napisz wiadomość..."),
        ("View Style", "Styl widoku"),
        ("Waiting...", "Oczekiwanie..."),
        ...
        ("Ticket reopened", "Zgłoszenie zostało ponownie otwarte"),
        ("Your ticket will be sent to {}", "Twoje zgłoszenie zostanie wysłane do {}"),
        ("your support team", "Twojego zespołu wsparcia"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "To urządzenie nie jest połączone z panelem. Nie można wysyłać zgłoszeń."),
        ("We'll use this address to send you updates about your ticket", "Użyjemy tego adresu do wysyłania aktualizacji zgłoszenia"),
        ("You can also email {}", "Możesz też napisać na {}"),
        ("You can also call {}", "Możesz też zadzwonić pod {}"),
