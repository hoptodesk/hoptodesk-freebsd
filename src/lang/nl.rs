...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Add to my Dashboard", "Toevoegen aan mijn dashboard"),
        ...
        ("Request declined", "Verzoek geweigerd"),
        ("Add remote device to my dashboard", "Extern apparaat toevoegen aan mijn dashboard"),
        ("Your IP", "Uw IP"),
        ("Switch to ID", "Schakel naar ID"),
        ("Switch to local IP", "Schakel naar lokaal IP"),
        ("No local IP available - showing ID", "Geen lokaal IP beschikbaar - ID wordt getoond"),
        ("Copy your local IP to clipboard", "Lokaal IP naar klembord kopiëren"),
        ("Your local IP address - share this for direct LAN connections", "Uw lokale IP-adres - deel dit voor directe LAN-verbindingen"),
        ("Accept Dashboard Invite?", "Dashboard-uitnodiging accepteren?"),
        ("Request sent, waiting for the remote user to confirm.", "Verzoek verzonden, wacht op bevestiging van de externe gebruiker."),
        ("Requesting invite code...", "Uitnodigingscode opvragen..."),
        ("The invite code is invalid or expired. Please try again later.", "De uitnodigingscode is ongeldig of verlopen. Probeer het later opnieuw."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "De externe gebruiker heeft geaccepteerd maar de registratie is mislukt. Mogelijk is hij offline of kan hij het dashboard niet bereiken."),
        ("A previous request is still pending on the remote.", "Er staat nog een eerder verzoek open op het externe apparaat."),
        ("No response from the remote, request timed out.", "Geen antwoord van het externe apparaat, het verzoek is verlopen."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Dit externe platform wordt nog niet ondersteund voor dashboard-registratie."),
        ("This device is already linked to your dashboard.", "Dit apparaat is al gekoppeld aan uw dashboard."),
        ("Replace existing dashboard link?", "Bestaande dashboard-koppeling vervangen?"),
        ("This computer is currently linked to {} dashboard.", "Deze computer is momenteel gekoppeld aan het dashboard van {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} nodigt deze computer uit om in plaats daarvan deel te nemen aan zijn dashboard. De bestaande koppeling wordt verwijderd."),
        ("{} is inviting this computer to join their dashboard.", "{} nodigt deze computer uit om deel te nemen aan zijn dashboard."),
        ("You can undo this any time in Settings > Dashboard.", "U kunt dit op elk moment ongedaan maken in Instellingen > Dashboard."),
            ("Recent sessions will show here.", "Recente sessies worden hier weergegeven."),
        ("No favorites yet.", "Nog geen favorieten."),
        ("No devices discovered.", "Geen apparaten ontdekt."),
        ("Waiting for new connection ...", "Wachten op nieuwe verbinding ..."),
        ("Not Ready", "Niet klaar"),
        ("ID / Relay Server", "ID / Relay Server"),
        ("Generate New Temporary Password", "Nieuw tijdelijk wachtwoord genereren"),
        ("Confirm Password", "Bevestig wachtwoord"),
        ("Two-Factor Authentication Setup", "Tweefactorauthenticatie instellen"),
        ("API URL", "API-URL"),
        ("This software is licensed under", "Deze software is gelicentieerd onder"),
        ("Source code is available", "De broncode is beschikbaar"),
        ("here", "hier"),
        ...
        ("RANDOM PASSWORD", "WILLEKEURIG WACHTWOORD"),
        ("Attachments:", "Bijlagen:"),
        ("Best image quality", "Beste beeldkwaliteit"),
        ("Connection Manager", "Verbindingsbeheer"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Momenteel gekoppeld:"),
        ("Do not close this window while the tunnel is active", "Sluit dit venster niet terwijl de tunnel actief is"),
        ("Enter Password", "Voer wachtwoord in"),
        ("Enter a new invite code to re-link:", "Voer een nieuwe uitnodigingscode in om opnieuw te koppelen:"),
        ("Establishing connection to remote device", "Verbinding maken met het externe apparaat"),
        ("File Already Exists", "Bestand bestaat al"),
        ("Input Blocked", "Invoer geblokkeerd"),
        ("Invalid code. Please try again.", "Ongeldige code. Probeer het opnieuw."),
        ("Keyboard", "Toetsenbord"),
        ("Lock Screen", "Scherm vergrendelen"),
        ("Message", "Bericht"),
        ("Please enter the password for the remote device.", "Voer het wachtwoord van het externe apparaat in."),
        ("Record Session", "Sessie opnemen"),
        ("Type a message...", "Typ een bericht..."),
        ("View Style", "Weergavestijl"),
        ("Waiting...", "Wachten..."),
        ("Port Forwarding:", "Poort doorsturen:"),
        ("Reconnecting", "Opnieuw verbinden"),
        ("Reconnecting...", "Opnieuw verbinden..."),
        ("Email is required", "E-mail is verplicht"),
        ("Please enter a valid email address", "Voer een geldig e-mailadres in"),
        ("Ticket reopened", "Ticket heropend"),
        ("Your ticket will be sent to {}", "Uw ticket wordt verzonden naar {}"),
        ("your support team", "uw supportteam"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Dit apparaat is niet verbonden met een dashboard. Tickets kunnen niet worden verzonden."),
        ("We'll use this address to send you updates about your ticket", "We gebruiken dit adres voor updates over uw ticket"),
        ("You can also email {}", "U kunt ook mailen naar {}"),
        ("You can also call {}", "U kunt ook bellen naar {}"),
