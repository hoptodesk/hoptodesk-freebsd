...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("empty_recent_tip", "As sessões recentes serão apresentadas aqui."),
        ...
        ("Please enter a local port number", "Introduza um número de porta local"),
        ("Please enter a remote port number", "Introduza um número de porta remota"),
        ("Please enter local and remote port numbers", "Introduza os números de porta local e remota"),
        ("Copy", "Copiar"),
        ...
        ("Your IP", "O seu IP"),
        ("Switch to ID", "Mudar para ID"),
        ("Switch to local IP", "Mudar para IP local"),
        ("No local IP available - showing ID", "Sem IP local disponível - a mostrar ID"),
        ("Copy your local IP to clipboard", "Copiar o seu IP local para a área de transferência"),
        ("Your local IP address - share this for direct LAN connections", "O seu endereço IP local - partilhe-o para ligações LAN diretas"),
        ("Accept Dashboard Invite?", "Aceitar convite do Painel?"),
        ("Request sent, waiting for the remote user to confirm.", "Pedido enviado, a aguardar confirmação do utilizador remoto."),
        ("Requesting invite code...", "A solicitar o código de convite..."),
        ...
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "O utilizador remoto aceitou mas o registo falhou. Pode estar offline ou incapaz de aceder ao painel."),
        ("A previous request is still pending on the remote.", "Há um pedido anterior ainda pendente no dispositivo remoto."),
        ("No response from the remote, request timed out.", "Sem resposta do dispositivo remoto, o pedido expirou."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Esta plataforma remota ainda não é suportada para registo no painel."),
        ("This device is already linked to your dashboard.", "Este dispositivo já está associado ao seu painel."),
        ("Replace existing dashboard link?", "Substituir a associação existente ao painel?"),
        ("This computer is currently linked to {} dashboard.", "Este computador está atualmente associado ao painel de {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} está a convidar este computador para se juntar ao seu painel. A associação existente será removida."),
        ("{} is inviting this computer to join their dashboard.", "{} está a convidar este computador para se juntar ao seu painel."),
        ("You can undo this any time in Settings > Dashboard.", "Pode anular isto a qualquer momento em Definições > Painel."),
            ("Recent sessions will show here.", "As sessões recentes serão mostradas aqui."),
        ("No favorites yet.", "Ainda não há favoritos."),
        ("No devices discovered.", "Nenhum dispositivo descoberto."),
        ("Waiting for new connection ...", "A aguardar nova ligação ..."),
        ...
        ("Connection Manager", "Gestor de ligações"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Atualmente associado:"),
        ...
        ("Enter a new invite code to re-link:", "Introduza um novo código de convite para associar novamente:"),
        ("Establishing connection to remote device", "A estabelecer ligação ao dispositivo remoto"),
        ...
        ("Message", "Mensagem"),
        ("Please enter the password for the remote device.", "Introduza a senha do dispositivo remoto."),
        ...
        ("Your ticket will be sent to {}", "O seu ticket será enviado para {}"),
        ("your support team", "a sua equipa de suporte"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Este dispositivo não está ligado a um painel. Não é possível enviar tickets."),
        ("We'll use this address to send you updates about your ticket", "Usaremos este endereço para atualizações sobre o seu ticket"),
        ("You can also email {}", "Também pode escrever para {}"),
        ("You can also call {}", "Também pode ligar para {}"),
