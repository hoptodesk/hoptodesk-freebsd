...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("All", "All"),
        ("Add to my Dashboard", "Add to my Dashboard"),
        ("Add remote device to my dashboard", "Add remote device to my dashboard"),
        ("Accept Dashboard Invite?", "Accept Dashboard Invite?"),
        ("{} is inviting this computer to join their dashboard.", "{} is inviting this computer to join their dashboard."),
        ("You can undo this any time in Settings > Dashboard.", "You can undo this any time in Settings > Dashboard."),
        ("Decline", "Decline"),
        ("Accept", "Accept"),
        ("this technician", "this technician"),
        ("Added to dashboard", "Added to dashboard"),
        ("Request declined", "Request declined"),
        ("Request sent, waiting for the remote user to confirm.", "Request sent, waiting for the remote user to confirm."),
        ("Requesting invite code...", "Requesting invite code..."),
        ("The invite code is invalid or expired. Please try again later.", "The invite code is invalid or expired. Please try again later."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard."),
        ("A previous request is still pending on the remote.", "A previous request is still pending on the remote."),
        ("No response from the remote, request timed out.", "No response from the remote, request timed out."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "This remote platform isn't supported for dashboard enrollment yet."),
        ("This device is already linked to your dashboard.", "This device is already linked to your dashboard."),
        ("Replace existing dashboard link?", "Replace existing dashboard link?"),
        ("This computer is currently linked to {} dashboard.", "This computer is currently linked to {} dashboard."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} is inviting this computer to join their dashboard instead. The existing link will be removed."),
        ("Your IP", "Your IP"),
        ("Switch to ID", "Switch to ID"),
        ("Switch to local IP", "Switch to local IP"),
        ("No local IP available - showing ID", "No local IP available - showing ID"),
        ("Copy your local IP to clipboard", "Copy your local IP to clipboard"),
        ("Your local IP address - share this for direct LAN connections", "Your local IP address - share this for direct LAN connections"),
        ("Email is required", "Email is required"),
        ("Please enter a valid email address", "Please enter a valid email address"),
        ("Ticket reopened", "Ticket reopened"),
        ("Your ticket will be sent to {}", "Your ticket will be sent to {}"),
        ("your support team", "your support team"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "This device is not connected to a dashboard. Tickets cannot be submitted."),
        ("We'll use this address to send you updates about your ticket", "We'll use this address to send you updates about your ticket"),
        ("You can also email {}", "You can also email {}"),
        ...
        ("Device ID must contain only numbers (0-9).", "Device ID must contain only numbers (0-9)."),
