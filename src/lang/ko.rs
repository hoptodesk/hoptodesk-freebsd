...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Please enter a local port number", "로컬 포트 번호를 입력하세요"),
        ...
        ("Added to dashboard", "대시보드에 추가됨"),
        ("Request declined", "요청이 거부되었습니다"),
        ("Add remote device to my dashboard", "원격 장치를 내 대시보드에 추가"),
        ("Your IP", "내 IP"),
        ("Switch to ID", "ID로 전환"),
        ("Switch to local IP", "로컬 IP로 전환"),
        ("No local IP available - showing ID", "사용 가능한 로컬 IP가 없습니다 - ID를 표시 중"),
        ("Copy your local IP to clipboard", "로컬 IP를 클립보드에 복사"),
        ("Your local IP address - share this for direct LAN connections", "내 로컬 IP 주소 - 직접 LAN 연결을 위해 공유하세요"),
        ("Accept Dashboard Invite?", "대시보드 초대를 수락하시겠습니까?"),
        ("Request sent, waiting for the remote user to confirm.", "요청이 전송되었습니다. 원격 사용자의 확인을 기다리는 중입니다."),
        ("Requesting invite code...", "초대 코드를 요청하는 중..."),
        ("The invite code is invalid or expired. Please try again later.", "초대 코드가 유효하지 않거나 만료되었습니다. 나중에 다시 시도해 주세요."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "원격 사용자가 수락했지만 등록에 실패했습니다. 오프라인이거나 대시보드에 연결할 수 없을 수 있습니다."),
        ("A previous request is still pending on the remote.", "원격에 이전 요청이 아직 대기 중입니다."),
        ("No response from the remote, request timed out.", "원격에서 응답이 없습니다. 요청 시간이 초과되었습니다."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "이 원격 플랫폼은 아직 대시보드 등록을 지원하지 않습니다."),
        ("This device is already linked to your dashboard.", "이 장치는 이미 대시보드에 연결되어 있습니다."),
        ("Replace existing dashboard link?", "기존 대시보드 연결을 교체하시겠습니까?"),
        ("This computer is currently linked to {} dashboard.", "이 컴퓨터는 현재 {}의 대시보드에 연결되어 있습니다."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "설정 > 대시보드에서 언제든지 취소할 수 있습니다."),
            ("Recent sessions will show here.", "최근 세션이 여기에 표시됩니다."),
        ("No favorites yet.", "즐겨찾기가 아직 없습니다."),
        ("No devices discovered.", "발견된 장치가 없습니다."),
        ("Waiting for new connection ...", "새 연결을 기다리는 중 ..."),
        ("Not Ready", "준비되지 않음"),
        ("ID / Relay Server", "ID / 릴레이 서버"),
        ("Generate New Temporary Password", "새 임시 비밀번호 생성"),
        ("Confirm Password", "비밀번호 확인"),
        ("Two-Factor Authentication Setup", "2단계 인증 설정"),
        ("API URL", "API URL"),
        ("This software is licensed under", "이 소프트웨어의 라이선스는"),
        ("Source code is available", "소스 코드 확인은"),
        ("here", "여기"),
        ("Invite Code", "초대 코드"),
        ("Length:", "길이:"),
        ("Link", "연결"),
        ("PERMANENT PASSWORD", "고정 비밀번호"),
        ("RANDOM PASSWORD", "랜덤 비밀번호"),
        ("Attachments:", "첨부파일:"),
        ("Best image quality", "최상의 이미지 품질"),
        ("Connection Manager", "연결 관리자"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "현재 연결됨:"),
        ("Do not close this window while the tunnel is active", "터널이 활성화된 동안 이 창을 닫지 마세요"),
        ("Enter Password", "비밀번호 입력"),
        ("Enter a new invite code to re-link:", "다시 연결하려면 새 초대 코드를 입력하세요:"),
        ("Establishing connection to remote device", "원격 장치에 연결하는 중"),
        ("File Already Exists", "파일이 이미 존재합니다"),
        ("Input Blocked", "입력 차단됨"),
        ("Invalid code. Please try again.", "잘못된 코드입니다. 다시 시도해 주세요."),
        ("Keyboard", "키보드"),
        ("Lock Screen", "화면 잠금"),
        ("Message", "메시지"),
        ("Please enter the password for the remote device.", "원격 장치의 비밀번호를 입력해 주세요."),
        ("Record Session", "세션 녹화"),
        ("Type a message...", "메시지를 입력하세요..."),
        ("View Style", "보기 스타일"),
        ("Waiting...", "대기 중..."),
        ("Port Forwarding:", "포트 포워딩:"),
        ("Reconnecting", "다시 연결 중"),
        ("Reconnecting...", "다시 연결 중입니다..."),
        ("Email is required", "이메일은 필수입니다"),
        ("Please enter a valid email address", "유효한 이메일 주소를 입력하세요"),
        ("Ticket reopened", "티켓이 다시 열렸습니다"),
        ("Your ticket will be sent to {}", "티켓은 {}(으)로 전송됩니다"),
        ("your support team", "지원팀"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "이 기기는 대시보드에 연결되어 있지 않습니다. 티켓을 제출할 수 없습니다."),
        ("We'll use this address to send you updates about your ticket", "이 주소로 티켓 업데이트를 보내드립니다"),
        ("You can also email {}", "{}(으)로 이메일을 보낼 수도 있습니다"),
        ("You can also call {}", "{}(으)로 전화할 수도 있습니다"),
