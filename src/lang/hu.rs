...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Add to my Dashboard", "Hozzáadás az irányítópultomhoz"),
        ...
        ("Added to dashboard", "Hozzáadva az irányítópulthoz"),
        ("Request declined", "Kérés elutasítva"),
        ("Add remote device to my dashboard", "Távoli eszköz hozzáadása az irányítópultomhoz"),
        ("Your IP", "Az Ön IP-je"),
        ("Switch to ID", "Váltás ID-re"),
        ("Switch to local IP", "Váltás helyi IP-re"),
        ("No local IP available - showing ID", "Nincs elérhető helyi IP - ID megjelenítése"),
        ("Copy your local IP to clipboard", "Helyi IP másolása a vágólapra"),
        ("Your local IP address - share this for direct LAN connections", "Az Ön helyi IP-címe - ossza meg közvetlen LAN-kapcsolatokhoz"),
        ("Accept Dashboard Invite?", "Elfogadja az irányítópult meghívót?"),
        ("Request sent, waiting for the remote user to confirm.", "Kérés elküldve, várakozás a távoli felhasználó megerősítésére."),
        ("Requesting invite code...", "Meghívókód kérése..."),
        ("The invite code is invalid or expired. Please try again later.", "A meghívókód érvénytelen vagy lejárt. Próbálja meg később."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "A távoli felhasználó elfogadta, de a regisztráció sikertelen volt. Lehet, hogy offline állapotban van vagy nem éri el az irányítópultot."),
        ("A previous request is still pending on the remote.", "A távoli eszközön még egy korábbi kérés vár feldolgozásra."),
        ("No response from the remote, request timed out.", "Nincs válasz a távoli eszközről, a kérés időtúllépést szenvedett."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Ez a távoli platform még nem támogatott az irányítópult regisztrációhoz."),
        ("This device is already linked to your dashboard.", "Ez az eszköz már össze van kötve az irányítópultjával."),
        ("Replace existing dashboard link?", "Lecseréli a meglévő irányítópult-összekötést?"),
        ("This computer is currently linked to {} dashboard.", "Ez a számítógép jelenleg {} irányítópultjához van kötve."),
        ...
        ("You can undo this any time in Settings > Dashboard.", "Ezt bármikor visszavonhatja a Beállítások > Irányítópult menüpontban."),
            ("Recent sessions will show here.", "A legutóbbi munkamenetek itt jelennek meg."),
        ("No favorites yet.", "Még nincsenek kedvencek."),
        ("No devices discovered.", "Nincs felfedezett eszköz."),
        ("Waiting for new connection ...", "Várakozás új kapcsolatra ..."),
        ("Not Ready", "Nem kész"),
        ("ID / Relay Server", "ID / Relay szerver"),
        ("Generate New Temporary Password", "Új ideiglenes jelszó generálása"),
        ("Confirm Password", "Jelszó megerősítése"),
        ("Two-Factor Authentication Setup", "Kétfaktoros hitelesítés beállítása"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Ennek a szoftvernek a licence"),
        ("Source code is available", "A forráskód elérhető"),
        ("here", "itt"),
        ...
        ("RANDOM PASSWORD", "VÉLETLENSZERŰ JELSZÓ"),
        ("Attachments:", "Mellékletek:"),
        ("Best image quality", "Legjobb képminőség"),
        ("Connection Manager", "Kapcsolatkezelő"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Jelenleg csatolva:"),
        ("Do not close this window while the tunnel is active", "Ne zárja be ezt az ablakot, amíg az alagút aktív"),
        ("Enter Password", "Adja meg a jelszót"),
        ("Enter a new invite code to re-link:", "Adjon meg egy új meghívókódot az újracsatoláshoz:"),
        ("Establishing connection to remote device", "Kapcsolat létesítése a távoli eszközzel"),
        ("File Already Exists", "A fájl már létezik"),
        ("Input Blocked", "Bevitel letiltva"),
        ("Invalid code. Please try again.", "Érvénytelen kód. Kérjük, próbálja újra."),
        ("Keyboard", "Billentyűzet"),
        ("Lock Screen", "Képernyő zárolása"),
        ("Message", "Üzenet"),
        ("Please enter the password for the remote device.", "Kérjük, adja meg a távoli eszköz jelszavát."),
        ("Record Session", "Munkamenet rögzítése"),
        ("Type a message...", "Írjon üzenetet..."),
        ("View Style", "Nézet stílusa"),
        ("Waiting...", "Várakozás..."),
        ...
        ("Ticket reopened", "A jegy újranyitva"),
        ("Your ticket will be sent to {}", "A jegye ide kerül: {}"),
        ("your support team", "az ügyfélszolgálatának"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Ez az eszköz nincs irányítópulthoz csatlakoztatva. Jegy nem küldhető be."),
        ("We'll use this address to send you updates about your ticket", "Ezt a címet használjuk a jegyével kapcsolatos értesítésekhez"),
        ("You can also email {}", "Írhat ide is: {}"),
        ("You can also call {}", "Hívhatja ezt a számot is: {}"),
