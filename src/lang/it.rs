...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("The peer has exited from Privacy Mode.", "Uscita dal dispostivo remoto"),
        ...
        ("Start Screen Share", "Avvia la condivisione dello schermo"),
        ("Stop Screen Share", "Interrompi condivisione schermo"),
        ...
        ("Elevated successfully.", "Elevazione dei diritti effettuata correttamente"),
        ("uppercase", "Maiuscola"),
        ("lowercase", "Minuscola"),
        ("digit", "Numero"),
        ...
        ("verify_hoptodesk_password_tip", "Conferma password HopToDesk"),
        ...
        ("selinux_tip", "In questo dispositivo è abilitato SELinux, che potrebbe impedire il corretto funzionamento di HopToDesk come lato controllato."),
        ...
        ("Privacy Mode started.", "Entra in modalità privacy"),
        ("Privacy Mode turned off.", "Esci dalla modalità privacy"),
        ...
        ("enable-2fa-desc-verify", "Inserisci il codice a 6 cifre generato dalla tua app di autenticazione:" ),
        ...
        ("2FA setup successfully.", "2FA impostato con successo."),
        ...
        ("allow-only-conn-window-open-tip", "Consenti connessione solo se la finestra HopToDesk è aperta"),
        ...
        ("floating_window_tip", "Contribuisce a mantenere il servizio HopToDesk."),
        ...
        ("enter-2fa-setup", "Configurazione dell\'autenticazione a due fattori" ),
        ("cancel-bot-confirm-tip", "Sei sicuro di voler annullare Telegram?"),
        ("About HopToDesk", "Info su HopToDesk"),
        ...
        ("Enable UDP hole punching", "Abilita perforazione UDP"),
        ("View Camera", "Visualizza fotocamera"),
        ...
        ("allow-insecure-tls-fallback-tip", "Per impostazione predefinita, HopToDesk verifica il certificato del server per i protocolli usando TLS.\nCon questa opzione abilitata, HopToDesk salterà il passaggio di verifica e procederà in caso di errore di verifica."),
        ("Disable UDP", "Disabilita UDP"),
        ("disable-udp-tip", "Controlla se usare solo TCP.\nQuando questa opzione è abilitata, HopToDesk non userà più UDP 21116, verrà invece usato TCP 21116."),
        ...
        ("Use HopToDesk Network", "Usa Rete HopToDesk"),
        ("Custom Network URL", "URL di rete personalizzato"),
        ...
        ("An update is available, do you want to update to the new version?", "È disponibile un aggiornamento, vuoi aggiornare alla nuova versione?"),
        ("Invite", "Invita"),
        ("Invite A Device", "Invita un dispositivo"),
        ("Input an ID to send a connection invitation for this device:", "Inserisci un ID per inviare un invito di connessione per questo dispositivo:"),
        ("Please enter a valid device ID.", "Inserisci un ID dispositivo valido."),
        ("Device ID must contain only numbers (0-9).", "L'ID del dispositivo deve contenere solo numeri (0-9)."),
        ("Peer ID", "ID contatto"),
        ("Device ID to invite", "ID del dispositivo da invitare"),
        ("Accept invite to connect to this computer?", "Accettare l'invito a connettersi a questo computer?"),
        ("Incoming Connections Off.", "Connessioni in ingresso disattivate"),
        ("Allow Incoming Connections", "Consenti connessioni in entrata"),
        ("Enable Incoming Connections", "Abilita connessioni in entrata"),
        ("Chat sessions will show here.", "Le sessioni di chat verranno visualizzate qui."),
        ("Connect to a device to start chatting.", "Connettiti a un dispositivo per iniziare a chattare."),
        ("No chats yet", "Nessuna chat ancora"),
        ("ios_screen_share_tip", "Tocca [Avvia la condivisione dello schermo] per iniziare a trasmettere il tuo schermo. L'ID del tuo dispositivo e la password appariranno una volta avviata la trasmissione."),
        ("This Device", "Questo dispositivo"),
        ("Remote Control", "Telecomando"),
        ("Copy ID", "Copia ID"),
        ("Menu", "Menu"),
        ("Hostname", "Nome host"),
        ("Enable Remote Printing", "Abilita stampa remota"),
        ("Enable unattended access to this device", "Abilita l'accesso non supervisionato a questo dispositivo"),
        ("Custom network settings URL", "URL impostazioni di rete personalizzate"),
        ("Update Available", ""),
        ("Don't show this again.", ""),
        ("WOL", ""),
        ("Your ID", "Il tuo ID"),
        ("Partner ID", "ID Partner"),
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "Imposta una password permanente per consentire l'accesso a questo dispositivo in qualsiasi momento, anche quando nessuno è presente."),
        ("View camera", "Visualizza fotocamera"),
        ("16-character invite code", "Codice invito di 16 caratteri"),
        ("Add File", "Aggiungi file"),
        ("Always use this printer", "Usa sempre questa stampante"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "Un altro dispositivo HopToDesk sulla stessa rete deve essere online per inoltrare il segnale di risveglio"),
        ("Appearance", "Aspetto"),
        ("Are you sure you want to switch sides", "Sei sicuro di voler invertire i lati"),
        ("Attachment", "Allegato"),
        ("Attachments", "Allegati"),
        ("Brief description of the issue", "Breve descrizione del problema"),
        ("Can not invite yourself.", "Non puoi invitare te stesso."),
        ("Change Display", "Cambia schermo"),
        ("Change password settings", "Modifica impostazioni password"),
        ("Click to load tickets", "Clicca per caricare i ticket"),
        ("Clipboard", "Appunti"),
        ("Confirm", "Conferma"),
        ("Connected to", "Connesso a"),
        ("Connection failed", "Connessione fallita"),
        ("Copy your device ID to clipboard so others can connect to you", "Copia il tuo ID dispositivo negli appunti per consentire ad altri di connettersi a te"),
        ("Current Wayland display server is not supported.", "Il server display Wayland corrente non è supportato."),
        ("Dashboard", "Dashboard"),
        ("Describe your issue in detail", "Descrivi il tuo problema in dettaglio"),
        ("Description", "Descrizione"),
        ("Description is required", "La descrizione è obbligatoria"),
        ("Different layout", "Layout diverso"),
        ("Edit", "Modifica"),
        ("Email", "Email"),
        ("Enable Permissions", "Abilita autorizzazioni"),
        ("Enable recording session", "Abilita registrazione sessione"),
        ("Enable remote restart", "Abilita riavvio remoto"),
        ("Enter Invite Code", "Inserisci codice invito"),
        ("Enter your invite code to link this device to a dashboard.", "Inserisci il codice invito per collegare questo dispositivo a una dashboard."),
        ("Failed to load conversation", "Impossibile caricare la conversazione"),
        ("Failed to load tickets", "Impossibile caricare i ticket"),
        ("Failed to submit ticket", "Impossibile inviare il ticket"),
        ("File Transfer", "Trasferimento file"),
        ("File size", "Dimensione file"),
        ("High", "Alta"),
        ("Initializing", "Inizializzazione"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "Codice invito non valido. Deve essere di 16 caratteri (lettere e numeri)."),
        ("Keyboard mode", "Modalità tastiera"),
        ("Keyboard/Mouse", "Tastiera/Mouse"),
        ("LAN Discovery", "Rilevamento LAN"),
        ("Length", "Lunghezza"),
        ("Linked", "Collegato"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Collegamento alla dashboard... Questo dispositivo apparirà nella dashboard a breve."),
        ("Loading...", "Caricamento..."),
        ("Login screen using Wayland is not supported.", "La schermata di accesso con Wayland non è supportata."),
        ("Low", "Bassa"),
        ("My Tickets", "I miei ticket"),
        ("New Ticket", "Nuovo ticket"),
        ("New reply received", "Nuova risposta ricevuta"),
        ("No", "No"),
        ("No messages", "Nessun messaggio"),
        ("No printers found on this computer.", "Nessuna stampante trovata su questo computer."),
        ("No tickets found", "Nessun ticket trovato"),
        ("OS Username", "Nome utente SO"),
        ("Open a file transfer session to send or receive files", "Apri una sessione di trasferimento file per inviare o ricevere file"),
        ("Open support tickets", "Apri ticket di supporto"),
        ("Password Settings", "Impostazioni password"),
        ("Password settings", "Impostazioni password"),
        ("Permanent Password", "Password permanente"),
        ("Priority", "Priorità"),
        ("Privacy Mode", "Modalità privacy"),
        ("Privacy Policy", "Informativa sulla privacy"),
        ("Random Password", "Password casuale"),
        ("Remote Access", "Accesso remoto"),
        ("Remote Print", "Stampa remota"),
        ("Remote Print Job", "Lavoro di stampa remota"),
        ("Remote Printing", "Stampa remota"),
        ("Remote Restart", "Riavvio remoto"),
        ("Requirements:", "Requisiti:"),
        ("Restart remote device", "Riavvia dispositivo remoto"),
        ("Same layout", "Stesso layout"),
        ("Save", "Salva"),
        ("Screenshot", "Screenshot"),
        ("Screenshot saved to clipboard", "Screenshot salvato negli appunti"),
        ("Select printer for remote print job", "Seleziona stampante per il lavoro di stampa remota"),
        ("Send a connection invitation to another device by entering its ID", "Invia un invito di connessione a un altro dispositivo inserendo il suo ID"),
        ("Set", "Imposta"),
        ("Start a remote desktop session with the partner device", "Avvia una sessione desktop remoto con il dispositivo partner"),
        ("Subject", "Oggetto"),
        ...
        ("Switch sides", "Inverti i lati"),
        ("The network adapter must have WoL enabled in OS settings", "L'adattatore di rete deve avere WoL abilitato nelle impostazioni del SO"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "Il segnale di risveglio viene inviato da un altro dispositivo HopToDesk online sulla stessa rete locale. Puoi attivarlo dalla rubrica di qualsiasi client HopToDesk o dalla dashboard se registrato."),
        ("This device is linked to a dashboard.", "Questo dispositivo è collegato a una dashboard."),
        ("This device must be connected via Ethernet (not WiFi)", "Questo dispositivo deve essere connesso tramite Ethernet (non WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Ticket inviato con successo!"),
        ("Tickets", "Ticket"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "I ticket possono essere creati solo se questo dispositivo è collegato a un utente della dashboard."),
        ("To change, enter a new invite code:", "Per cambiare, inserisci un nuovo codice invito:"),
        ("Tunnel", "Tunnel"),
        ("Two-Factor Authentication", "Autenticazione a due fattori"),
        ("Type your reply...", "Scrivi la tua risposta..."),
        ("Urgent", "Urgente"),
        ("View Security Code", "Visualizza codice di sicurezza"),
        ("Waiting for RDP client", "In attesa del client RDP"),
        ("Wake On LAN", "Wake On LAN"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "Wake On LAN consente di accendere questo dispositivo da remoto tramite un altro client HopToDesk o dalla dashboard."),
        ("Yes", "Sì"),
        ("You", "Tu"),
        ("You can find this code in your dashboard invite link.", "Puoi trovare questo codice nel link di invito della tua dashboard."),
        ("You have a new reply on one of your tickets", "Hai una nuova risposta su uno dei tuoi ticket"),
        ("Your email address", "Il tuo indirizzo email"),
        ("Your unique device ID - share this with others so they can connect to you", "Il tuo ID dispositivo univoco - condividilo con altri per consentire loro di connettersi a te"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "supera il limite di 5MB. Scegli un file più piccolo."),
        ("via", "tramite"),

        ("Device", "Dispositivo"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "WoL deve essere abilitato nelle impostazioni BIOS/UEFI del dispositivo"),
        ("Are you sure you want to delete", "Sei sicuro di voler eliminare"),
        ("Please enter a local port number", "Inserisci un numero di porta locale"),
        ...
        ("Added to dashboard", "Aggiunto alla dashboard"),
        ("Request declined", "Richiesta rifiutata"),
        ("Add remote device to my dashboard", "Aggiungi dispositivo remoto alla mia dashboard"),
        ("Your IP", "Il tuo IP"),
        ("Switch to ID", "Passa all'ID"),
        ("Switch to local IP", "Passa all'IP locale"),
        ("No local IP available - showing ID", "Nessun IP locale disponibile - viene mostrato l'ID"),
        ("Copy your local IP to clipboard", "Copia il tuo IP locale negli appunti"),
        ("Your local IP address - share this for direct LAN connections", "Il tuo indirizzo IP locale - condividilo per connessioni LAN dirette"),
        ("Accept Dashboard Invite?", "Accettare l'invito alla Dashboard?"),
        ("Request sent, waiting for the remote user to confirm.", "Richiesta inviata, in attesa di conferma dall'utente remoto."),
        ("Requesting invite code...", "Richiesta del codice di invito in corso..."),
        ("The invite code is invalid or expired. Please try again later.", "Il codice di invito non è valido o è scaduto. Riprova più tardi."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "L'utente remoto ha accettato ma la registrazione è fallita. Potrebbe essere offline o non riuscire a raggiungere la dashboard."),
        ("A previous request is still pending on the remote.", "Una richiesta precedente è ancora in attesa sul dispositivo remoto."),
        ("No response from the remote, request timed out.", "Nessuna risposta dal dispositivo remoto, la richiesta è scaduta."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Questa piattaforma remota non è ancora supportata per la registrazione alla dashboard."),
        ("This device is already linked to your dashboard.", "Questo dispositivo è già collegato alla tua dashboard."),
        ("Replace existing dashboard link?", "Sostituire il collegamento esistente della dashboard?"),
        ("This computer is currently linked to {} dashboard.", "Questo computer è attualmente collegato alla dashboard di {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} sta invitando questo computer a unirsi alla sua dashboard. Il collegamento esistente verrà rimosso."),
        ("{} is inviting this computer to join their dashboard.", "{} sta invitando questo computer a unirsi alla sua dashboard."),
        ("You can undo this any time in Settings > Dashboard.", "Puoi annullare in qualsiasi momento da Impostazioni > Dashboard."),
            ("Recent sessions will show here.", "Le sessioni recenti verranno mostrate qui."),
        ("No favorites yet.", "Ancora nessun preferito."),
        ("No devices discovered.", "Nessun dispositivo rilevato."),
        ("Waiting for new connection ...", "In attesa di una nuova connessione ..."),
        ("Not Ready", "Non pronto"),
        ("ID / Relay Server", "Server ID / Relay"),
        ("Generate New Temporary Password", "Genera nuova password temporanea"),
        ("Confirm Password", "Conferma password"),
        ("Two-Factor Authentication Setup", "Configurazione autenticazione a due fattori"),
        ("API URL", "URL API"),
        ("This software is licensed under", "Questo software è distribuito con licenza"),
        ...
        ("RANDOM PASSWORD", "PASSWORD CASUALE"),
        ("Attachments:", "Allegati:"),
        ("Best image quality", "Qualità immagine migliore"),
        ("Connection Manager", "Gestione connessioni"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Attualmente collegato:"),
        ("Do not close this window while the tunnel is active", "Non chiudere questa finestra mentre il tunnel è attivo"),
        ("Enter Password", "Inserisci la password"),
        ("Enter a new invite code to re-link:", "Inserisci un nuovo codice invito per ricollegare:"),
        ("Establishing connection to remote device", "Connessione al dispositivo remoto in corso"),
        ("File Already Exists", "Il file esiste già"),
        ("Input Blocked", "Input bloccato"),
        ("Invalid code. Please try again.", "Codice non valido. Riprova."),
        ("Keyboard", "Tastiera"),
        ("Lock Screen", "Blocca schermo"),
        ("Message", "Messaggio"),
        ("Please enter the password for the remote device.", "Inserisci la password del dispositivo remoto."),
        ...
        ("Ticket reopened", "Ticket riaperto"),
        ("Your ticket will be sent to {}", "Il tuo ticket sarà inviato a {}"),
        ("your support team", "il tuo team di supporto"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Questo dispositivo non è collegato a una dashboard. Impossibile inviare ticket."),
        ("We'll use this address to send you updates about your ticket", "Useremo questo indirizzo per gli aggiornamenti sul tuo ticket"),
        ("You can also email {}", "Puoi anche scrivere a {}"),
        ("You can also call {}", "Puoi anche chiamare il {}"),
