...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "Puedes deshacer esto en cualquier momento en Ajustes > Panel."),
            ("Recent sessions will show here.", "Las sesiones recientes se mostrarán aquí."),
        ("No favorites yet.", "Aún no hay favoritos."),
        ("No devices discovered.", "No se han descubierto dispositivos."),
        ("Waiting for new connection ...", "Esperando una nueva conexión ..."),
        ("Not Ready", "No listo"),
        ("ID / Relay Server", "Servidor ID / Relay"),
        ("Generate New Temporary Password", "Generar nueva contraseña temporal"),
        ("Confirm Password", "Confirmar contraseña"),
        ("Two-Factor Authentication Setup", "Configuración de autenticación de dos factores"),
        ("API URL", "URL de la API"),
        ("This software is licensed under", "Este software está licenciado bajo"),
        ...
        ("RANDOM PASSWORD", "CONTRASEÑA ALEATORIA"),
        ("Attachments:", "Adjuntos:"),
        ("Best image quality", "Mejor calidad de imagen"),
        ("Connection Manager", "Gestor de conexiones"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Actualmente vinculado:"),
        ("Do not close this window while the tunnel is active", "No cierre esta ventana mientras el túnel esté activo"),
        ("Enter Password", "Ingrese la contraseña"),
        ("Enter a new invite code to re-link:", "Ingrese un nuevo código de invitación para volver a vincular:"),
        ("Establishing connection to remote device", "Estableciendo conexión con el dispositivo remoto"),
        ("File Already Exists", "El archivo ya existe"),
        ("Input Blocked", "Entrada bloqueada"),
        ("Invalid code. Please try again.", "Código no válido. Por favor, inténtelo de nuevo."),
        ("Keyboard", "Teclado"),
        ("Lock Screen", "Bloquear pantalla"),
        ("Message", "Mensaje"),
        ("Please enter the password for the remote device.", "Por favor, ingrese la contraseña del dispositivo remoto."),
        ("Record Session", "Grabar sesión"),
        ("Type a message...", "Escriba un mensaje..."),
        ("View Style", "Estilo de vista"),
        ("Waiting...", "Esperando..."),
        ...
        ("Your ticket will be sent to {}", "Su ticket se enviará a {}"),
        ("your support team", "su equipo de soporte"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Este dispositivo no está conectado a un panel. No se pueden enviar tickets."),
        ("We'll use this address to send you updates about your ticket", "Usaremos esta dirección para enviarle actualizaciones sobre su ticket"),
        ("You can also email {}", "También puede escribir a {}"),
        ("You can also call {}", "También puede llamar al {}"),
