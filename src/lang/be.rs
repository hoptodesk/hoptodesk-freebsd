...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Падключэнне да сеткі HopToDesk..."),
        ("connecting_status_short", "Падключэнне..."),
        ("Enable Service", "Уключыць службу"),
        ("Start Service", "Пачаць сэрвіс"),
        ...
        ("not_ready_status_short", "Не падключана."),
        ...
        ("Import Server Config", "Імпарт канфігурацыі сервера"),
        ...
        ("Adaptive Bitrate", "Адаптыўная прапускная здольнасць"),
        ("ID Server", "Сервер ID"),
        ...
        ("Error", "Памылка"),
        ("Connection lost", "Скінута выдаленым вузлом"),
        ...
        ("Unable to connect to the remote partner.", "Немагчыма падключыцца да аддаленага партнёра."),
        ...
        ("install_tip", "Для найлепшага выканаўцы, поўная ўстаноўка."),
        ("Click to upgrade", "Абнавіць"),
        ("Click to download", "Спампаваць"),
        ("Click to update", "Абнавіць"),
        ("Configure", "Наладзіць"),
        ("config_acc", "Каб аддаленна кіраваць сваім працоўным сталом, вам неабходна дазволіць HopToDesk правы доступу."),
        ("config_screen", "Для аддаленага доступу да працоўнага сталу вам неабходна дазволіць HopToDesk правы здымку экрана."),
        ...
        ("New Update Available", "Даступнае новае абнаўленне"),
        ...
        ("android_input_permission_tip1", "Каб аддалёная прылада магла кіраваць вашай Android-прыладай з дапамогай мышы або націсканняў, неабходна дазволіць HopToDesk выкарыстоўваць паслугу \"Асаблівыя магчымасці\"."),
        ("android_input_permission_tip2", "Зайдзіце на адпаведную старонку сістэмных налад, знайдзіце і ўступіце ў \"Устаноўленыя паслугі\", уключыце паслугу \"HopToDesk Input\"."),
        ...
        ("Failed", "Не ўдалося"),
        ("Succeeded", "Выканана"),
        ("Someone turned on privacy mode, exiting.", "Хтосьці ўключыў рэжым прыватнасці, выхад"),
        ("Unsupported", "Не падтрымліваецца"),
        ("Peer denied", "Адмоўлена аддаленым вузлом"),
        ("Please install plugins", "Усталюйце плагіны"),
        ("The peer has exited from Privacy Mode.", "Аддалены вузел адключаны"),
        ("Failed to turn off", "Немагчыма адключыць"),
        ("Turned off", "Адключаны"),
        ("Language", "Мова"),
        ("Keep HopToDesk background service", "Захаваць фонавую службу HopToDesk"),
        ...
        ("Automatically record outgoing sessions", "Аўтаматычная запіс выходных сесій"),
        ("Change", "Змяніць"),
        ...
        ("Start Screen Share", "Пачаць абагульванне экрана"),
        ("Stop Screen Share", "Спыніць абмен экранам"),
        ...
        ("Show HopToDesk", "Паказаць HopToDesk"),
        ...
        ("config_input", "Каб кіраваць аддаленым працоўным сталом праз клавіятуру, неабходна дазволіць HopToDesk маніторынг уводу."),
        ("config_microphone", "Каб размаўляць з аддаленай старонкай, неабходна дазволіць HopToDesk запіс аўдыё."),
        ...
        ("still_click_uac_tip", "Дагэтуль патрэбна, каб аддалены карыстальнік націснуў \"OK\" ў акне UAC пры запуску HopToDesk."),
        ("Request Elevation", "Запыт на павышэнне"),
        ("wait_accept_uac_tip", "Пачакайце, пакуль аддалены карыстальнік пацвердзіць запыт UAC."),
        ("Elevated successfully.", "Павышэнне паспяхова выканана"),
        ...
        ("empty_recent_tip", "Апошнія сеансы будуць паказаны тут."),
        ("empty_favorite_tip", "Тут пакажуць любімыя аднагодкі."),
        ("empty_lan_tip", "Выяўленыя аналагі будуць паказаны тут."),
        ...
        ("verify_hoptodesk_password_tip", "Пацвердзіць пароль HopToDesk"),
        ...
        ("selinux_tip", "На вашай прыладзе ўключаны SELinux, што можа перашкаджаць правільнай працы HopToDesk на кіруючым баку."),
        ...
        ("Privacy Mode started.", "Уключыць рэжым канфідэнцыяльнасці"),
        ("Privacy Mode turned off.", "Адключыць рэжым канфідэнцыяльнасці"),
        ...
        ("enable-2fa-desc-verify", "Увядзіце 6-значны код, згенераваны вашай праграмай аўтэнтыфікацыі:"),
        ...
        ("2FA setup successfully.", "2FA паспяхова настроена."),
        ...
        ("allow-only-conn-window-open-tip", "Дазволіць толькі падключэнне пры адкрытым акне HopToDesk"),
        ...
        ("floating_window_tip", "Дапамагае падтрымліваць фонавую службу HopToDesk"),
        ...
        ("Volume down", "Памяншэнне гучнасці"),
        ("Power", "Магутнасць"),
        ("Telegram bot", "Тэлеграм-бот"),
        ("enable-bot-tip", "Уключыце бота"),
        ("enable-bot-desc", "Уключыць бота для дапамогі"),
        ("cancel-2fa-confirm-tip", "Скасаваць двухфакторную аўтэнтыфікацыю"),
        ("enter-2fa-setup", "Налада двухфакторнай аўтэнтыфікацыі"),
        ("cancel-bot-confirm-tip", "Скасаваць працу бота?"),
        ("About HopToDesk", "Пра HopToDesk"),
        ("Send clipboard keystrokes", "Адправіць націсканні з буфера абмену"),
        ("network_error_tip", "Памылка сеткі"),
        ("Unlock with PIN", "Разблакаваць з дапамогай PIN-кода"),
        ("Requires at least {} characters", "Патрабуецца мінімум {} сімвалаў"),
        ("Wrong PIN", "Няправільны PIN-код"),
        ("Set PIN", "Усталяваць PIN-код"),
        ("Enable trusted devices", "Уключыць давераныя прылады"),
        ("Manage trusted devices", "Кіраваць даверанымі прыладамі"),
        ("Platform", "Платформа"),
        ("Days remaining", "Засталося дзён"),
        ("enable-trusted-devices-tip", "Уключыце давераныя прылады для бяспекі"),
        ("Parent directory", "Бацькоўскі каталог"),
        ("Resume", "Працягнуць"),
        ("Invalid file name", "Неправільнае імя файла"),
        ("one-way-file-transfer-tip", "Аднабаковая перадача файлаў"),
        ("Authentication Required", "Патрабуецца аўтэнтыфікацыя"),
        ("Authenticate", "Аўтэнтыфікаваць"),
        ("Download", "Спампаваць"),
        ("Upload folder", "Загрузіць папку"),
        ("Upload files", "Загрузіць файлы"),
        ("Clipboard is synchronized", "Буфер абмену сінхранізаваны"),
        ("Update client clipboard", ""),
        ("Untagged", ""),
        ("Accessible devices", ""),
        ("d3d_render_tip", "Калі ўключана адлюстраванне D3D, экран аддаленага кіравання можа быць чорным на некаторых машынах."),
        ("Use D3D rendering", ""),
        ("Printer", ""),
        ("printer-os-requirement-tip", "Функцыя выходнага друку патрабуе Windows 10 або вышэй."),
        ("printer-requires-installed-{}-client-tip", "Для выкарыстання аддаленага друку на гэтым прыладзе павінен быць усталяваны {}."),
        ...
        ("Incoming Print Jobs", ""),
        ("Incoming Print Job", ""),
        ("use-the-default-printer-tip", "Выкарыстоўваць прынтар па змаўчанні"),
        ("use-the-selected-printer-tip", "Выкарыстоўваць выбраны прынтар"),
        ("auto-print-tip", "Друкаваць аўтаматычна з выкарыстаннем выбранага прынтара."),
        ("print-incoming-job-confirm-tip", "Вы атрымалі заданне друку ад аддаленай сістэмы. Хочаце выканаць яго на сваім баку?"),
        ("remote-printing-disallowed-tile-tip", "Аддалены друк забаронены"),
        ("remote-printing-disallowed-text-tip", "Налады дазволаў кіраванага боку забараняюць аддалены друк."),
        ("dont-show-again-tip", "Больш не паказваць"),
        ("Take screenshot", ""),
        ("Taking screenshot", ""),
        ("screenshot-action-tip", "Калі ласка, выберыце, як працягнуць са здымкам экрана."),
        ("Save as", ""),
        ("Copy to clipboard", ""),
        ("Enable remote printer", ""),
        ("Downloading {}", ""),
        ("{} Update", ""),
        ("{}-to-update-tip", "{} зараз зачыніцца і ўсталюе новую версію."),
        ("Auto update", ""),
        ("websocket_tip", "Парада па выкарыстанні WebSocket"),
        ...
        ("Enable IPv6 P2P connection", "Уключыць P2P-злучэнне IPv6"),
        ("Enable UDP hole punching", "Уключыць прабіванне дзірак UDP"),
        ("View Camera", "Прагляд камеры"),
        ("Enable Camera", ""),
        ("No cameras", ""),
        ("view_camera_unsupported_tip", "Аддаленае прылада не падтрымлівае прагляд камеры."),
        ("Remote Terminal", "Тэрмінал"),
        ("Enable terminal", ""),
        ("New tab", ""),
        ...
        ("Show my cursor", "Паказаць мой курсор"),
        ("Scale custom", ""),
        ("Custom scale slider", ""),
        ("Decrease", ""),
        ("Increase", ""),
        ...
        ("Enable Wake On LAN", "Уключыць Wake On LAN"),
        ("Enable 2FA", "Уключыць двухфактарную аўтэнтыфікацыю"),
        ("You will need to confirm the 2FA on the secondary device with you when trying to connect to this desktop.", "Вам трэба будзе пацвердзіць двухфактарную аўтэнтыфікацыю на дадатковым прыладзе пры падключэнні да гэтага працоўнага стала."),
        ("Choose Network", "Выберыце Сетка"),
        ("Enter your custom network settings URL:", "Увядзіце URL вашых уласных сеткавых налад:"),
        ("HopToDesk Network (Default)", "Сетка HopToDesk (па змаўчанні)"),
        ("Use HopToDesk Network", "Выкарыстоўвайце сетку HopToDesk"),
        ("Custom Network URL", "Карыстальніцкі URL сеткі"),
        ("Custom Network Settings", "Уласныя сеткавыя налады"),
        ("Custom Network Error", "Памылка ўласнай сеткі"),
        ("The custom network URL provided was not valid, please try again.", "Уведзены URL уласнай сеткі некарэктны, калі ласка, паспрабуйце яшчэ раз."),
        ("Your Security Code", "Ваш код бяспекі"),
        ("Security Code", "Код бяспекі"),
        ("Full Screen", "Поўны экран"),
        ("ID (Click to Copy)", "ID (Націсніце, каб скапіяваць)"),
        ("Password (Click to Copy)", "Пароль (Націсніце, каб скапіяваць)"),
        ("Unattended Access", "Аўтаномны доступ"),
        ("An update is available, do you want to update to the new version?", "Даступнае абнаўленне, вы хочаце абнавіць да новай версіі?"),
        ("Invite", "Запрасіць"),
        ("Invite A Device", "Запрасіць прыладу"),
        ("Input an ID to send a connection invitation for this device:", "Увядзіце ID, каб адправіць запрашэнне на злучэнне для гэтага прылады:"),
        ("Please enter a valid device ID.", "Калі ласка, увядзіце сапраўдны ID прылады."),
        ("Device ID must contain only numbers (0-9).", "ID прылады павінен змяшчаць толькі лічбы (0-9)."),
        ("Peer ID", "ID Кантакта"),
        ("Device ID to invite", "ID прылады для запрашэння"),
        ("Accept invite to connect to this computer?", "Прыняць запрашэнне на падлучэнне да гэтага кампутара?"),
        ("Incoming Connections Off.", "Уваходныя злучэнні адключаны"),
        ("Allow Incoming Connections", "Дазволіць уваходныя злучэнні"),
        ("Enable Incoming Connections", "Дазволіць уваходныя злучэнні"),
        ("Chat sessions will show here.", "Сесіі чата будуць адлюстроўвацца тут."),
        ("Connect to a device to start chatting.", "Падключыцеся да прылады, каб пачаць чат."),
        ("No chats yet", "Няма чатаў яшчэ"),
        ("ios_screen_share_tip", "Націсніце [Пачаць трансляцыю экрана], каб пачаць трансляцыю вашага экрана. Ідэнтыфікатар вашай прылады і пароль з'явяцца пасля пачатку трансляцыі."),
        ("This Device", "Гэта прылада"),
        ("Remote Control", "Пульт дыстанцыйнага кіравання"),
        ("Copy ID", "Капія ID"),
        ("Menu", "Меню"),
        ("Hostname", "Імя хоста"),
        ("Enable Remote Printing", "Уключыць аддаленае друкаванне"),
        ("Enable unattended access to this device", "Уключыць аддалены доступ да гэтага прылады"),
        ("Custom network settings URL", "URL карыстальніцкіх налад сеткі"),
        ("Update Available", ""),
        ("Don't show this again.", ""),
        ("WOL", ""),
        ("Your ID", "Ваш ідэнтыфікатар"),
        ("Partner ID", "Ідэнтыфікатар партнёра"),
        ("Set a permanent password to allow access to this device at any time, even when no one is present.", "Усталюйце пастаянны пароль, каб дазволіць доступ да гэтага прылады ў любы час, нават калі нікога няма."),
        ("View camera", "Прагляд камеры"),
        ("16-character invite code", "16-сімвальны код запрашэння"),
        ("Add File", "Дадаць файл"),
        ("Always use this printer", "Заўсёды выкарыстоўваць гэты прынтар"),
        ("Another HopToDesk device on the same network must be online to relay the wake signal", "Іншая прылада HopToDesk у той жа сетцы павінна быць анлайн для перадачы сігналу абуджэння"),
        ("Appearance", "Знешні выгляд"),
        ("Are you sure you want to switch sides", "Вы ўпэўнены, што хочаце памяняцца бакамі"),
        ("Attachment", "Укладанне"),
        ("Attachments", "Укладанні"),
        ("Brief description of the issue", "Кароткае апісанне праблемы"),
        ("Can not invite yourself.", "Нельга запрасіць самога сябе."),
        ("Change Display", "Змяніць дысплей"),
        ("Change password settings", "Змяніць налады пароля"),
        ("Click to load tickets", "Націсніце, каб загрузіць заяўкі"),
        ("Clipboard", "Буфер абмену"),
        ("Confirm", "Пацвердзіць"),
        ("Connected to", "Падключана да"),
        ("Connection failed", "Падключэнне не ўдалося"),
        ("Copy your device ID to clipboard so others can connect to you", "Скапіруйце ID прылады ў буфер абмену, каб іншыя маглі падключыцца да вас"),
        ("Current Wayland display server is not supported.", "Бягучы сервер дысплея Wayland не падтрымліваецца."),
        ("Dashboard", "Панэль кіравання"),
        ("Describe your issue in detail", "Апішыце сваю праблему падрабязна"),
        ("Description", "Апісанне"),
        ("Description is required", "Апісанне абавязковае"),
        ("Different layout", "Іншая раскладка"),
        ("Edit", "Рэдагаваць"),
        ("Email", "Электронная пошта"),
        ("Enable Permissions", "Уключыць дазволы"),
        ("Enable recording session", "Уключыць запіс сеансу"),
        ("Enable remote restart", "Уключыць аддаленую перазагрузку"),
        ("Enter Invite Code", "Увядзіце код запрашэння"),
        ("Enter your invite code to link this device to a dashboard.", "Увядзіце код запрашэння, каб звязаць гэту прыладу з панэллю кіравання."),
        ("Failed to load conversation", "Не ўдалося загрузіць размову"),
        ("Failed to load tickets", "Не ўдалося загрузіць заяўкі"),
        ("Failed to submit ticket", "Не ўдалося адправіць заяўку"),
        ("File Transfer", "Перадача файлаў"),
        ("File size", "Памер файла"),
        ("High", "Высокі"),
        ("Initializing", "Ініцыялізацыя"),
        ("Invalid invite code. Must be 16 characters (letters and numbers).", "Няправільны код запрашэння. Павінен быць 16 сімвалаў (літары і лічбы)."),
        ("Keyboard mode", "Рэжым клавіятуры"),
        ("Keyboard/Mouse", "Клавіятура/Мыш"),
        ("LAN Discovery", "Выяўленне LAN"),
        ("Length", "Даўжыня"),
        ("Linked", "Звязана"),
        ("Linking to dashboard... This device will appear in the dashboard shortly.", "Звязванне з панэллю кіравання... Гэта прылада хутка з'явіцца на панэлі."),
        ("Loading...", "Загрузка..."),
        ("Login screen using Wayland is not supported.", "Экран уваходу праз Wayland не падтрымліваецца."),
        ("Low", "Нізкі"),
        ("My Tickets", "Мае заяўкі"),
        ("New Ticket", "Новая заяўка"),
        ("New reply received", "Атрыманы новы адказ"),
        ("No", "Не"),
        ("No messages", "Няма паведамленняў"),
        ("No printers found on this computer.", "На гэтым камп'ютары не знойдзена прынтараў."),
        ("No tickets found", "Заяўкі не знойдзены"),
        ("OS Username", "Імя карыстальніка АС"),
        ("Open a file transfer session to send or receive files", "Адкрыйце сеанс перадачы файлаў для адпраўкі або атрымання файлаў"),
        ("Open support tickets", "Адкрыць заяўкі падтрымкі"),
        ("Password Settings", "Налады пароля"),
        ("Password settings", "Налады пароля"),
        ("Permanent Password", "Пастаянны пароль"),
        ("Priority", "Прыярытэт"),
        ("Privacy Mode", "Рэжым прыватнасці"),
        ("Privacy Policy", "Палітыка прыватнасці"),
        ("Random Password", "Выпадковы пароль"),
        ("Remote Access", "Аддалены доступ"),
        ("Remote Print", "Аддалены друк"),
        ("Remote Print Job", "Заданне аддаленага друку"),
        ("Remote Printing", "Аддалены друк"),
        ("Remote Restart", "Аддаленая перазагрузка"),
        ("Requirements:", "Патрабаванні:"),
        ("Restart remote device", "Перазагрузіць аддаленую прыладу"),
        ("Same layout", "Тая ж раскладка"),
        ("Save", "Захаваць"),
        ("Screenshot", "Здымак экрана"),
        ("Screenshot saved to clipboard", "Здымак экрана захаваны ў буфер абмену"),
        ("Select printer for remote print job", "Выберыце прынтар для задання аддаленага друку"),
        ("Send a connection invitation to another device by entering its ID", "Адпраўце запрашэнне на падключэнне да іншай прылады, увёўшы яе ID"),
        ("Set", "Усталяваць"),
        ("Start a remote desktop session with the partner device", "Пачніце сеанс аддаленага працоўнага стала з прыладай-партнёрам"),
        ("Subject", "Тэма"),
        ("Subject is required", "Тэма абавязковая"),
        ("Submit Ticket", "Адправіць заяўку"),
        ("Success", "Поспех"),
        ("Support", "Падтрымка"),
        ("Switch Display", "Пераключыць дысплей"),
        ("Switch sides", "Памяняцца бакамі"),
        ("The network adapter must have WoL enabled in OS settings", "Сеткавы адаптар павінен мець уключаны WoL у наладах АС"),
        ("The wake signal is sent by another online HopToDesk device on the same local network. You can trigger it from the address book in any HopToDesk client, or from the dashboard if enrolled.", "Сігнал абуджэння адпраўляецца іншай анлайн-прыладай HopToDesk у той жа лакальнай сетцы. Вы можаце актываваць яго з адраснай кнігі ў любым кліенце HopToDesk або з панэлі кіравання, калі вы зарэгістраваны."),
        ("This device is linked to a dashboard.", "Гэта прылада звязана з панэллю кіравання."),
        ("This device must be connected via Ethernet (not WiFi)", "Гэта прылада павінна быць падключана праз Ethernet (не WiFi)"),
        ("Ticket submitted but attachment upload failed:", ""),
        ("Ticket submitted successfully!", "Заяўка паспяхова адпраўлена!"),
        ("Tickets", "Заяўкі"),
        ("Tickets can only be created if this device is linked to a dashboard user.", "Заяўкі можна ствараць толькі калі гэта прылада звязана з карыстальнікам панэлі кіравання."),
        ("To change, enter a new invite code:", "Каб змяніць, увядзіце новы код запрашэння:"),
        ("Tunnel", "Тунэль"),
        ("Two-Factor Authentication", "Двухфактарная аўтэнтыфікацыя"),
        ("Type your reply...", "Увядзіце свой адказ..."),
        ("Urgent", "Тэрмінова"),
        ("View Security Code", "Паглядзець код бяспекі"),
        ("Waiting for RDP client", "Чаканне кліента RDP"),
        ("Wake On LAN", "Wake On LAN"),
        ("Wake On LAN lets you power on this device remotely from another HopToDesk client or the dashboard.", "Wake On LAN дазваляе аддалена ўключыць гэту прыладу з іншага кліента HopToDesk або панэлі кіравання."),
        ("Yes", "Так"),
        ("You", "Вы"),
        ("You can find this code in your dashboard invite link.", "Вы можаце знайсці гэты код у спасылцы запрашэння панэлі кіравання."),
        ("You have a new reply on one of your tickets", "У вас ёсць новы адказ на адну з вашых заявак"),
        ("Your email address", "Ваш адрас электроннай пошты"),
        ("Your unique device ID - share this with others so they can connect to you", "Ваш унікальны ID прылады - падзяліцеся ім, каб іншыя маглі падключыцца да вас"),
        ("doc_fix_wayland", ""),
        ("doc_mac_permission", ""),
        ("exceeds 5MB limit. Please choose a smaller file.", "перавышае ліміт 5MB. Калі ласка, выберыце меншы файл."),
        ("via", "праз"),


		
        ("Device", "Прылада"),
        ("WoL must be enabled in the device's BIOS/UEFI settings", "WoL павінен быць уключаны ў наладах BIOS/UEFI прылады"),
        ("Are you sure you want to delete", "Вы ўпэўнены, што хочаце выдаліць"),
        ("Please enter a local port number", "Калі ласка, увядзіце нумар лакальнага порта"),
        ("Please enter a remote port number", "Калі ласка, увядзіце нумар аддаленага порта"),
        ("Please enter local and remote port numbers", "Калі ласка, увядзіце нумары лакальнага і аддаленага партоў"),
        ("Copy", "Капіяваць"),
        ("Proxy Settings", "Налады проксі"),
        ("Add to my Dashboard", "Дадаць у маю панэль"),
        ...
        ("Added to dashboard", "Дададзена ў панэль"),
        ("Request declined", "Запыт адхілены"),
        ("Add remote device to my dashboard", "Дадаць аддаленую прыладу ў маю панэль"),
        ("Your IP", "Ваш IP"),
        ("Switch to ID", "Пераключыцца на ID"),
        ("Switch to local IP", "Пераключыцца на лакальны IP"),
        ("No local IP available - showing ID", "Лакальны IP недаступны — паказваецца ID"),
        ("Copy your local IP to clipboard", "Скапіяваць лакальны IP у буфер абмену"),
        ("Your local IP address - share this for direct LAN connections", "Ваш лакальны IP-адрас — падзяліцеся ім для прамых LAN-злучэнняў"),
        ("Accept Dashboard Invite?", "Прыняць запрашэнне ў панэль?"),
        ("Request sent, waiting for the remote user to confirm.", "Запыт адпраўлены, чакаецца пацверджанне аддаленага карыстальніка."),
        ("Requesting invite code...", "Запыт кода запрашэння..."),
        ("The invite code is invalid or expired. Please try again later.", "Код запрашэння несапраўдны або скончыўся. Калі ласка, паспрабуйце пазней."),
        ("The remote accepted but enrollment failed. They may be offline or unable to reach the dashboard.", "Аддалены карыстальнік пагадзіўся, але рэгістрацыя не атрымалася. Магчыма, ён не ў сетцы або не можа дабрацца да панэлі."),
        ("A previous request is still pending on the remote.", "На аддаленай прыладзе ўсё яшчэ чакаецца папярэдні запыт."),
        ("No response from the remote, request timed out.", "Няма адказу ад аддаленай прылады, час чакання скончыўся."),
        ("This remote platform isn't supported for dashboard enrollment yet.", "Гэтая аддаленая платформа пакуль не падтрымліваецца для рэгістрацыі ў панэлі."),
        ("This device is already linked to your dashboard.", "Гэтая прылада ўжо прывязаная да вашай панэлі."),
        ("Replace existing dashboard link?", "Замяніць існуючую прывязку панэлі?"),
        ("This computer is currently linked to {} dashboard.", "Гэты камп'ютар зараз прывязаны да панэлі {}."),
        ("{} is inviting this computer to join their dashboard instead. The existing link will be removed.", "{} запрашае гэты камп'ютар далучыцца да сваёй панэлі. Існуючая прывязка будзе выдалена."),
        ("{} is inviting this computer to join their dashboard.", "{} запрашае гэты камп'ютар далучыцца да сваёй панэлі."),
        ("You can undo this any time in Settings > Dashboard.", "Вы можаце адмяніць гэта ў любы час у Налады > Панэль."),
            ("Recent sessions will show here.", "Тут будуць паказвацца апошнія сеансы."),
        ("No favorites yet.", "Пакуль няма абраных."),
        ("No devices discovered.", "Прылады не выяўлены."),
        ("Waiting for new connection ...", "Чаканне новага падключэння ..."),
        ("Not Ready", "Не гатова"),
        ("ID / Relay Server", "ID / Рэтранслятар"),
        ("Generate New Temporary Password", "Згенераваць новы часовы пароль"),
        ("Confirm Password", "Пацвердзіце пароль"),
        ("Two-Factor Authentication Setup", "Налада двухфактарнай аўтэнтыфікацыі"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Гэта праграмнае забеспячэнне распаўсюджваецца па ліцэнзіі"),
        ("Source code is available", "Зыходны код даступны"),
        ("here", "тут"),
        ...
        ("RANDOM PASSWORD", "ВЫПАДКОВЫ ПАРОЛЬ"),
        ("Attachments:", "Укладанні:"),
        ("Best image quality", "Найлепшая якасць выявы"),
        ("Connection Manager", "Менеджар падключэнняў"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Цяпер звязана:"),
        ("Do not close this window while the tunnel is active", "Не зачыняйце гэта акно, пакуль тунэль актыўны"),
        ("Enter Password", "Увядзіце пароль"),
        ("Enter a new invite code to re-link:", "Увядзіце новы код запрашэння, каб звязаць паўторна:"),
        ("Establishing connection to remote device", "Усталяванне злучэння з аддаленай прыладай"),
        ("File Already Exists", "Файл ужо існуе"),
        ("Input Blocked", "Увод заблакаваны"),
        ("Invalid code. Please try again.", "Няправільны код. Паспрабуйце яшчэ раз."),
        ("Keyboard", "Клавіятура"),
        ("Lock Screen", "Заблакаваць экран"),
        ("Message", "Паведамленне"),
        ("Please enter the password for the remote device.", "Калі ласка, увядзіце пароль аддаленай прылады."),
        ("Record Session", "Запісаць сеанс"),
        ("Type a message...", "Увядзіце паведамленне..."),
        ("View Style", "Стыль адлюстравання"),
        ("Waiting...", "Чаканне..."),
        ("Port Forwarding:", "Перанакіраванне портаў:"),
        ("Reconnecting", "Перападключэнне"),
        ("Reconnecting...", "Перападключэнне..."),
        ("Email is required", "Электронная пошта абавязковая"),
        ("Please enter a valid email address", "Калі ласка, увядзіце сапраўдны адрас электроннай пошты"),
        ("Ticket reopened", "Заяўка зноў адкрыта"),
        ("Your ticket will be sent to {}", "Ваша заяўка будзе адпраўлена {}"),
        ("your support team", "вашай службе падтрымкі"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Гэта прылада не падключана да панэлі кіравання. Заяўкі нельга адправіць."),
        ("We'll use this address to send you updates about your ticket", "Мы выкарыстаем гэты адрас для абнаўленняў па вашай заяўцы"),
        ("You can also email {}", "Вы таксама можаце напісаць на {}"),
        ("You can also call {}", "Вы таксама можаце патэлефанаваць {}"),
        ("Ticket #{} submitted", "Ticket #{} submitted"),
        ("File is too large (max 5 MB)", "File is too large (max 5 MB)"),
        ("Remove from Address Book", "Remove from Address Book"),
        ("Your address book is empty.", "Your address book is empty."),
        ("Remove this device from the address book?", "Remove this device from the address book?"),
        ("Alias (optional)", "Alias (optional)"),
        ("Tags, comma separated (optional)", "Tags, comma separated (optional)"),
        ("Device ID", "Device ID"),
    ].iter().cloned().collect();
}
