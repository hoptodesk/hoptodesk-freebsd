...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("You can undo this any time in Settings > Dashboard.", "Edozein momentutan desegin dezakezu Ezarpenak > Panela atalean."),
            ("Recent sessions will show here.", "Azken saioak hemen agertuko dira."),
        ("No favorites yet.", "Oraindik ez dago gogokorik."),
        ("No devices discovered.", "Ez da gailurik aurkitu."),
        ("Waiting for new connection ...", "Konexio berri baten zain ..."),
        ("Not Ready", "Ez dago prest"),
        ("ID / Relay Server", "ID / Relay zerbitzaria"),
        ("Generate New Temporary Password", "Sortu aldi baterako pasahitz berria"),
        ("Confirm Password", "Berretsi pasahitza"),
        ("Two-Factor Authentication Setup", "Bi faktoreko autentifikazioaren konfigurazioa"),
        ("API URL", "API URL"),
        ("This software is licensed under", "Software hau lizentzia honen pean dago"),
        ("Source code is available", "Iturburu-kodea eskuragarri dago"),
        ("here", "hemen"),
        ("Invite Code", "Gonbidapen kodea"),
        ("Length:", "Luzera:"),
        ("Link", "Lotu"),
        ("PERMANENT PASSWORD", "BETIRAKO PASAHITZA"),
        ("RANDOM PASSWORD", "AUSAZKO PASAHITZA"),
        ("Attachments:", "Eranskinak:"),
        ("Best image quality", "Irudi-kalitate onena"),
        ("Connection Manager", "Konexio-kudeatzailea"),
        ("Ctrl + Alt + Del", "Ctrl + Alt + Del"),
        ("Currently linked:", "Unean lotuta:"),
        ("Do not close this window while the tunnel is active", "Ez itxi leiho hau tunela aktibo dagoen bitartean"),
        ("Enter Password", "Sartu pasahitza"),
        ("Enter a new invite code to re-link:", "Sartu gonbidapen kode berri bat berriro lotzeko:"),
        ("Establishing connection to remote device", "Urruneko gailuarekin konexioa ezartzen"),
        ("File Already Exists", "Fitxategia badago lehendik"),
        ("Input Blocked", "Sarrera blokeatuta"),
        ("Invalid code. Please try again.", "Kode baliogabea. Saiatu berriro mesedez."),
        ("Keyboard", "Teklatua"),
        ("Lock Screen", "Blokeatu pantaila"),
        ("Message", "Mezua"),
        ("Please enter the password for the remote device.", "Mesedez, sartu urruneko gailuaren pasahitza."),
        ("Record Session", "Grabatu saioa"),
        ("Type a message...", "Idatzi mezu bat..."),
        ("View Style", "Ikuspen estiloa"),
        ("Waiting...", "Zain..."),
        ("Port Forwarding:", "Ataka birbideratzea:"),
        ("Reconnecting", "Berriro konektatzen"),
        ("Reconnecting...", "Berriro konektatzen..."),
        ("Email is required", "Posta elektronikoa beharrezkoa da"),
        ("Please enter a valid email address", "Mesedez, sartu baliozko helbide elektroniko bat"),
        ("Ticket reopened", "Txartela berriro ireki da"),
        ("Your ticket will be sent to {}", "Zure txartela {} helbidera bidaliko da"),
        ("your support team", "zure laguntza-taldea"),
        ("This device is not connected to a dashboard. Tickets cannot be submitted.", "Gailu hau ez dago panel batera konektatuta. Ezin da txartelik bidali."),
        ("We'll use this address to send you updates about your ticket", "Helbide hau zure txartelaren eguneraketak bidaltzeko erabiliko dugu"),
        ("You can also email {}", "{} helbidera ere idatz dezakezu"),
        ("You can also call {}", "{} zenbakira ere dei dezakezu"),
