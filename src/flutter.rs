...
/// FFI for hoptodesk core's main entry.
...
pub fn session_add(
    ...
    //session.lc.write().unwrap().initialize(id.to_owned(), conn_type, switch_uuid, force_relay, adapter_luid, shared_password, tokenexp.to_string());
